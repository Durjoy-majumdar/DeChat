...
/* renamed from: bb3.a */
public class C92218a extends SpannableString {

    /* renamed from: d */
    public Object[] f263938d = new Object[20];

    /* renamed from: e */
    public int[] f263939e = new int[60];

    /* renamed from: f */
    public int f263940f;

    public C92218a(CharSequence charSequence) {
    ...
    public int getSpanEnd(Object obj) {
        int i = this.f263940f;
        Object[] objArr = this.f263938d;
        int[] iArr = this.f263939e;
    ...
    public <T> T[] getSpans(int i, int i2, Class<T> cls) {
        int i3 = this.f263940f;
        T[] tArr = this.f263938d;
        int[] iArr = this.f263939e;
        T[] tArr2 = null;
        T t = null;
        int i4 = 0;
    ...
    public void setSpan(Object obj, int i, int i2, int i3) {
        ...
        if (i5 >= objArr.length) {
            ...
            System.arraycopy(this.f263939e, 0, iArr, 0, this.f263940f * 3);
            this.f263938d = objArr2;
            this.f263939e = iArr;
        }
        Object[] objArr3 = this.f263938d;
        int i7 = this.f263940f;
        objArr3[i7] = obj;
        int[] iArr2 = this.f263939e;
        iArr2[(i7 * 3) + 0] = i;
        iArr2[(i7 * 3) + 1] = i2;
        iArr2[(i7 * 3) + 2] = i3;
        this.f263940f = i7 + 1;
