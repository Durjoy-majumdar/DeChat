...
/* renamed from: cb3.j */
public class C92399j implements View.OnClickListener {

    /* renamed from: d */
    public final /* synthetic */ C92400k f264409d;

    public C92399j(C92400k kVar) {
        this.f264409d = kVar;
    }
    ...
    public void onClick(View view) {
        ...
        arrayList.clear();
        C117292a.m165356b("com/tencent/mm/plugin/wenote/model/nativenote/multiselect/NoteSelectManager$15", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, array);
        Log.m105919d("NoteSelectManager", "onClick() called with: %s", this.f264409d.f264446w);
        ...
        C91983a aVar = this.f264409d.f264445v;
        if (aVar != null) {
            ((NoteEditorUI) aVar).mo134924S7();
        }
        C91983a aVar2 = this.f264409d.f264445v;
        C92221d dVar = aVar2 != null ? ((NoteEditorUI) aVar2).f283238X0 : null;
        if (dVar != null) {
            dVar.mo126188H();
        }
        C117292a.m165361g(this, "com/tencent/mm/plugin/wenote/model/nativenote/multiselect/NoteSelectManager$15", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V");
    }
}
