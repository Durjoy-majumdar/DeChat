...
public interface V8Context {
    ...
    V8Array executeArrayScript(String str, String str2, int i, ExecuteDetails executeDetails);

    V8Array executeArrayScript(String str, String str2, int i, String str3, String str4, int i2, ExecuteDetails executeDetails);
    ...
    boolean executeBooleanScript(String str, String str2, int i, ExecuteDetails executeDetails);

    boolean executeBooleanScript(String str, String str2, int i, String str3, String str4, int i2, ExecuteDetails executeDetails);
    ...
    double executeDoubleScript(String str, String str2, int i, ExecuteDetails executeDetails);

    double executeDoubleScript(String str, String str2, int i, String str3, String str4, int i2, ExecuteDetails executeDetails);

    Object executeFileScript(V8ScriptFileDescriptor v8ScriptFileDescriptor, String str, int i, String str2, String str3, int i2, ExecuteDetails executeDetails);
    ...
    int executeIntegerScript(String str, String str2, int i, ExecuteDetails executeDetails);

    int executeIntegerScript(String str, String str2, int i, String str3, String str4, int i2, ExecuteDetails executeDetails);
    ...
    V8Object executeObjectScript(String str, String str2, int i, ExecuteDetails executeDetails);

    V8Object executeObjectScript(String str, String str2, int i, String str3, String str4, int i2, ExecuteDetails executeDetails);

    Object executeScript(String str, ExecuteDetails executeDetails);

    Object executeScript(String str, String str2, int i, ExecuteDetails executeDetails);

    Object executeScript(String str, String str2, int i, String str3, String str4, int i2, ExecuteDetails executeDetails);
    ...
    String executeStringScript(String str, String str2, int i, ExecuteDetails executeDetails);

    String executeStringScript(String str, String str2, int i, String str3, String str4, int i2, ExecuteDetails executeDetails);

    void executeVoidFunction(String str, V8Array v8Array);

    void executeVoidScript(String str, ExecuteDetails executeDetails);

    void executeVoidScript(String str, String str2, int i, ExecuteDetails executeDetails);

    void executeVoidScript(String str, String str2, int i, String str3, String str4, int i2, ExecuteDetails executeDetails);
