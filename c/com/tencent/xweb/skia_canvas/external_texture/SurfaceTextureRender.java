...
public class SurfaceTextureRender {
    ...
    public SurfaceTextureRender(SurfaceTexture surfaceTexture2) {
        this.surfaceTexture = surfaceTexture2;
    }

    private void initEGLSurface() {
        EGLSurface eglCreateWindowSurface = this.egl.eglCreateWindowSurface(this.eglDisplay, this.eglConfig, this.surfaceTexture, (int[]) null);
        ...
        if (eglCreateWindowSurface == null || eglCreateWindowSurface == EGL10.EGL_NO_SURFACE) {
            ...
            this.mHeight = iArr[0];
            Objects.toString(this.surfaceTexture);
        } else {
