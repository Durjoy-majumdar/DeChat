...
public final class LocalBroadcastManager {
    ...
    public static LocalBroadcastManager getInstance(Context context) {
        ...
        synchronized (mLock) {
            if (mInstance == null) {
                mInstance = new LocalBroadcastManager(XWalkEnvironment.convertContextToApplication(context));
            }
    ...
    public void executePendingBroadcasts() {
        /*
            r10 = this;
        L_0x0000:
            java.util.HashMap<android.content.BroadcastReceiver, java.util.ArrayList<com.tencent.xweb.util.LocalBroadcastManager$ReceiverRecord>> r0 = r10.mReceivers
            monitor-enter(r0)
            java.util.ArrayList<com.tencent.xweb.util.LocalBroadcastManager$BroadcastRecord> r1 = r10.mPendingBroadcasts     // Catch:{ all -> 0x0044 }
            int r1 = r1.size()     // Catch:{ all -> 0x0044 }
            if (r1 > 0) goto L_0x000d
            monitor-exit(r0)     // Catch:{ all -> 0x0044 }
            return
        L_0x000d:
            com.tencent.xweb.util.LocalBroadcastManager$BroadcastRecord[] r2 = new com.tencent.xweb.util.LocalBroadcastManager.BroadcastRecord[r1]     // Catch:{ all -> 0x0044 }
            java.util.ArrayList<com.tencent.xweb.util.LocalBroadcastManager$BroadcastRecord> r3 = r10.mPendingBroadcasts     // Catch:{ all -> 0x0044 }
        ...
        L_0x001c:
            if (r3 >= r1) goto L_0x0000
            r4 = r2[r3]
            java.util.ArrayList<com.tencent.xweb.util.LocalBroadcastManager$ReceiverRecord> r5 = r4.receivers
            int r5 = r5.size()
            r6 = 0
        L_0x0027:
            if (r6 >= r5) goto L_0x0041
            java.util.ArrayList<com.tencent.xweb.util.LocalBroadcastManager$ReceiverRecord> r7 = r4.receivers
            java.lang.Object r7 = r7.get(r6)
            com.tencent.xweb.util.LocalBroadcastManager$ReceiverRecord r7 = (com.tencent.xweb.util.LocalBroadcastManager.ReceiverRecord) r7
            boolean r8 = r7.dead
        ...
        L_0x0044:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.xweb.util.LocalBroadcastManager.executePendingBroadcasts():void");
    }
    ...
    public boolean sendBroadcast(android.content.Intent r23) {
        /*
            ...
            r1 = r22
            r0 = r23
            java.util.HashMap<android.content.BroadcastReceiver, java.util.ArrayList<com.tencent.xweb.util.LocalBroadcastManager$ReceiverRecord>> r2 = r1.mReceivers
            monitor-enter(r2)
            java.lang.String r10 = r23.getAction()     // Catch:{ all -> 0x00dc }
            android.content.Context r3 = r1.mAppContext     // Catch:{ all -> 0x00dc }
        ...
        L_0x0034:
            java.util.HashMap<java.lang.String, java.util.ArrayList<com.tencent.xweb.util.LocalBroadcastManager$ReceiverRecord>> r3 = r1.mActions     // Catch:{ all -> 0x00dc }
        ...
        L_0x004b:
            ...
            r5 = r3
            com.tencent.xweb.util.LocalBroadcastManager$ReceiverRecord r5 = (com.tencent.xweb.util.LocalBroadcastManager.ReceiverRecord) r5     // Catch:{ all -> 0x00dc }
            if (r16 == 0) goto L_0x005f
            android.content.IntentFilter r3 = r5.filter     // Catch:{ all -> 0x00dc }
            java.util.Objects.toString(r3)     // Catch:{ all -> 0x00dc }
        L_0x005f:
            boolean r3 = r5.broadcasting     // Catch:{ all -> 0x00dc }
        ...
        L_0x0098:
            ...
            r15.broadcasting = r11     // Catch:{ all -> 0x00dc }
            goto L_0x009f
        L_0x009e:
            r7 = r10
        L_0x009f:
        ...
        L_0x00ae:
            ...
            com.tencent.xweb.util.LocalBroadcastManager$ReceiverRecord r4 = (com.tencent.xweb.util.LocalBroadcastManager.ReceiverRecord) r4     // Catch:{ all -> 0x00dc }
            r5 = 0
            r4.broadcasting = r5     // Catch:{ all -> 0x00dc }
            int r3 = r3 + 1
            goto L_0x00ae
        L_0x00c0:
            java.util.ArrayList<com.tencent.xweb.util.LocalBroadcastManager$BroadcastRecord> r3 = r1.mPendingBroadcasts     // Catch:{ all -> 0x00dc }
            com.tencent.xweb.util.LocalBroadcastManager$BroadcastRecord r4 = new com.tencent.xweb.util.LocalBroadcastManager$BroadcastRecord     // Catch:{ all -> 0x00dc }
            r4.<init>(r0, r10)     // Catch:{ all -> 0x00dc }
            r3.add(r4)     // Catch:{ all -> 0x00dc }
            android.os.Handler r0 = r1.mHandler     // Catch:{ all -> 0x00dc }
        ...
        L_0x00dc:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.xweb.util.LocalBroadcastManager.sendBroadcast(android.content.Intent):boolean");
    }
