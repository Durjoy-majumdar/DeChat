...
public class WebResourceResponse {
    private boolean mBCreateFromComplexConstruct;
    ...
    public WebResourceResponse(String str, String str2, InputStream inputStream) {
        ...
        this.mBCreateFromComplexConstruct = false;
        this.mMimeType = str;
        this.mEncoding = str2;
        setData(inputStream);
        this.mBCreateFromComplexConstruct = false;
    ...
    public boolean isCreateFromComplexConstruct() {
        return this.mBCreateFromComplexConstruct;
    }
    ...
    public WebResourceResponse(String str, String str2, int i, String str3, Map<String, String> map, InputStream inputStream) {
        ...
        this.mBCreateFromComplexConstruct = true;
    }
}
