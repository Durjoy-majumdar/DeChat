...
public class LruCache<K, V> {
    ...
    public void trimToSize(int r6) {
        ...
        L_0x0000:
            monitor-enter(r5)
            int r0 = r5.size     // Catch:{ all -> 0x0087 }
            if (r0 < 0) goto L_0x0068
            java.util.LinkedHashMap<K, V> r0 = r5.map     // Catch:{ all -> 0x0087 }
        ...
        L_0x0045:
            ...
            java.util.LinkedHashMap<K, V> r3 = r5.map     // Catch:{ all -> 0x0087 }
            r3.remove(r2)     // Catch:{ all -> 0x0087 }
            int r3 = r5.size     // Catch:{ all -> 0x0087 }
            int r4 = r5.safeSizeOf(r2, r0)     // Catch:{ all -> 0x0087 }
            int r3 = r3 - r4
            r5.size = r3     // Catch:{ all -> 0x0087 }
            int r3 = r5.evictionCount     // Catch:{ all -> 0x0087 }
            r4 = 1
            int r3 = r3 + r4
            r5.evictionCount = r3     // Catch:{ all -> 0x0087 }
            monitor-exit(r5)     // Catch:{ all -> 0x0087 }
