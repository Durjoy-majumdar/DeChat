...
public class TPDownloadParamData {
    ...
    public void setCacheCopyFirst(boolean z) {
        this.isCacheCopyFirst = z;
    }
    ...
    public void setHeadersList(List<Map<String, String>> list) {
    ...
    public void setNeedFlowControl(boolean z) {
        this.isNeedFlowControl = z;
    }
    ...
    public void setPcdnChargeId(String str) {
