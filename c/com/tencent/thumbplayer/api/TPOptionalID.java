...
public class TPOptionalID {
    ...
    public static final int f349337xa7b03e7e = 146;
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_BOOL_ENABLE_NEW_DATA_SOURCE_SWITCH_STRATEGY", type = 3, value = 134)
    public static final int OPTION_ID_BEFORE_BOOL_ENABLE_NEW_DATA_SOURCE_SWITCH_STRATEGY = 147;
    ...
    public static final int f349338xc9bdf6cd = 143;
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_BOOL_ENABLE_SET_OUTPUT_SURFACE_API", type = 3, value = 205)
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_BOOL_SEEK_WITH_CANCELING_PENDING_SEEKS", type = 3, value = 160)
    public static final int OPTION_ID_BEFORE_BOOL_SEEK_WITH_CANCELING_PENDING_SEEKS = 160;
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_BOOL_VIDEO_ENABLE_MEDIA_CODEC_RELEASE_OUTPUT_BUFFER_WITH_TIMESTAMP", type = 3, value = 220)

    /* renamed from: OPTION_ID_BEFORE_BOOL_VIDEO_ENABLE_MEDIA_CODEC_RELEASE_OUTPUT_BUFFER_WITH_TIMESTAMP */
    public static final int f349339x98affc23 = 221;
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_INT_AUDIO_STREAM_TYPE", type = 4, value = 304)
    public static final int OPTION_ID_BEFORE_INT_AUDIO_STREAM_TYPE = 350;
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_INT_ENABLE_RENDERER_SHARPEN", type = 4, value = 451)
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_LONG_FFMPEG_TCP_RECV_BUFFER_SIZE", type = 1, value = 136)
    public static final int OPTION_ID_BEFORE_LONG_FFMPEG_TCP_RECV_BUFFER_SIZE = 304;
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_LONG_MIN_LEFT_PACKET_QUEUE_TOTAL_DURATION_MS_FOR_SWITCH_DATA_SOURCE", type = 1, value = 135)

    /* renamed from: OPTION_ID_BEFORE_LONG_MIN_LEFT_PACKET_QUEUE_TOTAL_DURATION_MS_FOR_SWITCH_DATA_SOURCE */
    public static final int f349340xf38850bb = 148;
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_QUEUE_STRING_HLS_DECRYPTION_PEM", type = 6, value = 455)
    public static final int OPTION_ID_BEFORE_QUEUE_STRING_HLS_DECRYPTION_PEM = 453;
    ...
    @TPNativeKeyMap.MapInitConfig(keyName = "OPTION_ID_BEFORE_STRING_SHARPEN_SHADER_PATH", type = 2, value = 452)
