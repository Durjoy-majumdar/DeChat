...
public interface ITPPlayer {
    ...
    void enableTPAssetResourceLoader(ITPAssetResourceLoader iTPAssetResourceLoader);
    ...
    void setTPSurface(TPSurface tPSurface);
