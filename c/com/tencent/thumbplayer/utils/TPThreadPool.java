...
public class TPThreadPool {
    ...
    private static final String PRE_THREAD_NAME = "TP-HandlerThread";
    private static final String SHARE_THREAD_NAME = "TP-ShareThreadPool";
    private static final String TAG = "TPPlayer[TPThreadPool]";
    ...
    private static void initMainThreadHandler() {
        /*
            ...
            return
        L_0x0005:
            java.lang.Class<com.tencent.thumbplayer.utils.TPThreadPool> r0 = com.tencent.thumbplayer.utils.TPThreadPool.class
            monitor-enter(r0)
            android.os.Handler r1 = sMainThreadHandler     // Catch:{ all -> 0x0028 }
            if (r1 == 0) goto L_0x000e
            monitor-exit(r0)     // Catch:{ all -> 0x0028 }
            return
        L_0x000e:
            android.os.Looper r1 = android.os.Looper.getMainLooper()     // Catch:{ all -> 0x0028 }
            if (r1 == 0) goto L_0x001c
            android.os.Handler r2 = new android.os.Handler     // Catch:{ all -> 0x0028 }
            r2.<init>(r1)     // Catch:{ all -> 0x0028 }
            sMainThreadHandler = r2     // Catch:{ all -> 0x0028 }
            goto L_0x0026
        L_0x001c:
            r1 = 0
            sMainThreadHandler = r1     // Catch:{ all -> 0x0028 }
            java.lang.String r1 = "TPPlayer[TPThreadPool]"
            java.lang.String r2 = "cannot get thread looper"
            com.tencent.thumbplayer.utils.TPLogUtil.m21894e((java.lang.String) r1, (java.lang.String) r2)     // Catch:{ all -> 0x0028 }
        L_0x0026:
            monitor-exit(r0)     // Catch:{ all -> 0x0028 }
            return
        L_0x0028:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.thumbplayer.utils.TPThreadPool.initMainThreadHandler():void");
    }
    ...
    public ScheduledExecutorService obtainScheduledExecutorService() {
        if (sScheduler == null) {
            synchronized (TPThreadPool.class) {
                if (sScheduler == null) {
                    sScheduler = Executors.newScheduledThreadPool(4);
                }
            }
        }
        return sScheduler;
    ...
    public HandlerThread obtainShareThread() {
        ...
        synchronized (TPThreadPool.class) {
            sShareThreadCount++;
            TPLogUtil.m21897i(TAG, "handlerThread obtainShareThread mShareThreadCount:" + sShareThreadCount);
    ...
    public ExecutorService obtainThreadExecutor() {
        if (sCustomExecutor == null) {
            synchronized (TPThreadPool.class) {
                if (sCustomExecutor == null) {
                    sCustomExecutor = TPThreadPoolExecutor.newCustomThreadExecutor(4, 20);
                }
            }
        }
    ...
    public void recycle(HandlerThread handlerThread, Handler handler) {
        if (handlerThread != null) {
            ...
            if (handlerThread.equals(sHandlerThread)) {
                synchronized (TPThreadPool.class) {
                    sShareThreadCount--;
                    TPLogUtil.m21897i(TAG, "handlerThread recycle mShareThreadCount:" + sShareThreadCount);
                }
                return;
            }
            handlerThread.quit();
