...
public class TPThreadPoolExecutor {
    ...
    private static final String TAG = "TPPlayer[TPThreadPoolExecutor]";
    ...
    public static class CustomRejectedExecutionHandler implements RejectedExecutionHandler {
        ...
        public void rejectedExecution(Runnable runnable, ThreadPoolExecutor threadPoolExecutor) {
            try {
                ...
                TPLogUtil.m21897i(TPThreadPoolExecutor.TAG, "rejectedExecution put task to queue");
            } catch (InterruptedException e) {
                TPLogUtil.m21894e(TPThreadPoolExecutor.TAG, "rejectedExecution has exception:" + e.toString());
            }
        }
    }
