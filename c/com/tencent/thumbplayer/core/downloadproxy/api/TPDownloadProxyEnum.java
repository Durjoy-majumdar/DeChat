...
public class TPDownloadProxyEnum {
    ...
    public static final String DLPARAM_CACHE_COPY_FIRST = "dl_param_cache_copy_first";
    ...
    public static final String DLPARAM_NEED_FLOW_CONTROL = "dl_param_need_flow_control";
    ...
    public static final String DLPARAM_PCDN_CHARGE_ID = "dl_param_pcdn_charge_id";
    ...
    public static final String DLPARAM_PREPARE_HTTP_START_TIME = "dl_param_prepare_http_start_time";
    ...
    public static final String DLPARAM_SCENE_ID = "dl_param_scene_id";
    ...
    public static final int DLTYPE_DASH = 19;
    ...
    public static final String USER_SERVICE_CONFIG = "service_config";
