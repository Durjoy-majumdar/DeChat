...
public final class TPMediaCodecProfileLevel {
    ...
    static {
        ...
        hashMap.put(512, Integer.valueOf(Downloads.SPLIT_RANGE_SIZE_NET));
        ...
        hashMap2.put(Integer.valueOf(HEVCMainTierLevel62), 35651584);
    ...
    public static int getAVCMaxLumaSample(int i) {
        ...
        return hashMap.containsKey(Integer.valueOf(i)) ? hashMap.get(Integer.valueOf(i)).intValue() : hashMap.get(256).intValue();
    }

    public static int getHEVCMaxLumaSample(int i) {
        HashMap<Integer, Integer> hashMap = hevcLumaSampleMap;
        return hashMap.containsKey(Integer.valueOf(i)) ? hashMap.get(Integer.valueOf(i)).intValue() : hashMap.get(64).intValue();
    }

    public static int getVP8MaxLumaSample(int i) {
        HashMap<Integer, Integer> hashMap = vp8LumaSampleMap;
        return hashMap.containsKey(Integer.valueOf(i)) ? hashMap.get(Integer.valueOf(i)).intValue() : hashMap.get(2).intValue();
    }

    public static int getVP9MaxLumaSample(int i) {
        HashMap<Integer, Integer> hashMap = vp9LumaSampleMap;
        return hashMap.containsKey(Integer.valueOf(i)) ? hashMap.get(Integer.valueOf(i)).intValue() : hashMap.get(16).intValue();
    }
}
