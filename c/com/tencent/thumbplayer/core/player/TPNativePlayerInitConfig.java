...
public class TPNativePlayerInitConfig {
    ...
    /* renamed from: BOOL_VIDEO_ENABLE_MEDIA_CODEC_RELEASE_OUTPUT_BUFFER_WITH_TIMESTAMP */
    public static final int f56998xbf65edfd = 220;
    ...
    /* renamed from: LONG_MIN_LEFT_PACKET_QUEUE_TOTAL_DURATION_MS_FOR_SWITCH_DATA_SOURCE */
    public static final int f56999xa3909a21 = 135;
    ...
    public void addQueueInt(int i, int i2) {
        Vector vector = this.mQueueIntMap.get(Integer.valueOf(i));
        if (vector == null) {
            vector = new Vector();
    ...
    public void addQueueString(int i, String str) {
        Vector vector = this.mQueueStringMap.get(Integer.valueOf(i));
        if (vector == null) {
            vector = new Vector();
