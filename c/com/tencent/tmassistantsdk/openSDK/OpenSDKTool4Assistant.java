...
public class OpenSDKTool4Assistant {
    ...
    public static String decryptUri(String str) {
        return new String(ProtocolPackage.decrypt(Base64.decode(str, 0), "ji*9^&43U0X-~./(".getBytes()));
    }

    public static String encryptUri(String str) {
        return Base64.encodeToString(ProtocolPackage.encrypt(str.getBytes(), "ji*9^&43U0X-~./(".getBytes()), 0);
    }
