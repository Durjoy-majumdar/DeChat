...
abstract class CharsetRecog_mbcs extends CharsetRecognizer {
    ...
    public static abstract class CharsetRecog_euc extends CharsetRecog_mbcs {
        ...
        public static class CharsetRecog_euc_jp extends CharsetRecog_euc {
            public static int[] commonChars = {41377, 41378, 41379, 41382, 41404, 41418, 41419, 41430, 41431, 42146, 42148, 42150, 42152, 42154, 42155, 42156, 42157, 42159, 42161, 42163, 42165, 42167, 42169, 42171, 42173, 42175, 42176, 42177, 42179, 42180, 42182, 42183, 42184, 42185, 42186, 42187, 42190, 42191, 42192, 42206, 42207, 42209, 42210, 42212, 42216, 42217, 42218, 42219, 42220, 42223, 42226, 42227, 42402, 42403, 42404, 42406, 42407, 42410, 42413, 42415, 42416, 42419, 42421, 42423, 42424, 42425, 42431, 42435, 42438, 42439, 42440, 42441, 42443, 42448, 42453, 42454, 42455, 42462, 42464, 42465, 42469, 42473, 42474, 42475, 42476, 42477, 42483, 47273, 47572, 47854, 48072, 48880, 49079, 50410, 50940, 51133, 51896, 51955, 52188, 52689};
    ...
    public static class CharsetRecog_gb_18030 extends CharsetRecog_mbcs {
        public static int[] commonChars = {41377, 41378, 41379, 41380, 41392, 41393, 41457, 41459, 41889, 41900, 41914, 45480, 45496, 45502, 45755, 46025, 46070, 46323, 46525, 46532, 46563, 46767, 46804, 46816, 47010, 47016, 47037, 47062, 47069, 47284, 47327, 47350, 47531, 47561, 47576, 47610, 47613, 47821, 48039, 48086, 48097, 48122, 48316, 48347, 48382, 48588, 48845, 48861, 49076, 49094, 49097, 49332, 49389, 49611, 49883, 50119, 50396, 50410, 50636, 50935, 51192, 51371, 51403, 51413, 51431, 51663, 51706, 51889, 51893, 51911, 51920, 51926, 51957, 51965, 52460, 52728, 52906, 52932, 52946, 52965, 53173, 53186, 53206, 53442, 53445, 53456, 53460, 53671, 53930, 53938, 53941, 53947, 53972, 54211, 54224, 54269, 54466, 54490, 54754, 54992};
    ...
    public int match(CharsetDetector charsetDetector, int[] iArr) {
        ...
        while (nextChar(iteratedchar, charsetDetector)) {
            ...
            if (iteratedchar.error) {
                ...
                long j = ((long) iteratedchar.charValue) & Util.MAX_32BIT_VALUE;
                if (j > 255) {
                    i++;
        ...
        return Math.min((int) ((Math.log((double) (i4 + 1)) * (90.0d / Math.log((double) (((float) i) / 4.0f)))) + 10.0d), 100);
    }
