...
public final class WXMediaMessage {
    ...
    public static class Builder {
        ...
        public static WXMediaMessage fromBundle(Bundle bundle) {
            ...
            if (pathOldToNew != null && pathOldToNew.length() > 0) {
                try {
                    ...
                    Log.m99044e(WXMediaMessage.TAG, "get media object from bundle failed: unknown ident " + pathOldToNew + ", ex = " + e.getMessage());
                }
            }
            return wXMediaMessage;
        }
        ...
        private static String pathNewToOld(String str) {
            ...
            Log.m99044e(WXMediaMessage.TAG, "pathNewToOld fail, newPath is null");
            return str;
        }

        private static String pathOldToNew(String str) {
            Log.m99045i(WXMediaMessage.TAG, "pathOldToNew, oldPath = " + str);
            if (str == null || str.length() == 0) {
                Log.m99044e(WXMediaMessage.TAG, "pathOldToNew fail, oldPath is null");
                return str;
            }
            int lastIndexOf = str.lastIndexOf(46);
            if (lastIndexOf == -1) {
                Log.m99044e(WXMediaMessage.TAG, "pathOldToNew fail, invalid pos, oldPath = " + str);
                return str;
            }
    ...
    public boolean checkArgs() {
        ...
        } else if (getType() == 76 && C81058b.m99052b(this.title)) {
            str = "checkArgs fail, Type = Music Video, but title == null";
        } else if (!C81058b.m99051a(getType()) || ((bArr3 = this.thumbData) != null && bArr3.length <= 131072)) {
            boolean z = true;
            if (!(getType() == 101) || ((bArr2 = this.thumbData) != null && bArr2.length <= 262144)) {
                if (!C81058b.m99051a(getType())) {
                    if (!(getType() == 101)) {
                        z = false;
                    }
                }
                if (z || (bArr = this.thumbData) == null || bArr.length <= 65536) {
    ...
    public void setThumbImage(Bitmap bitmap) {
        try {
            ...
            Log.m99044e(TAG, "setThumbImage exception:" + e.getMessage());
        }
    }
}
