...
public final class CallbackCaller extends Provider {
    ...
    public static final Runnable clearTask = CallbackCaller$clearTask$1.INSTANCE;
    /* access modifiers changed from: private */
    ...
    static {
        ...
        callbackCaller.addRootIdMapper$plugin_autoaccessibility_release(C1045781.INSTANCE);
    }
    ...
    public void dealNodeInfo(View view, AccessibilityNodeInfo accessibilityNodeInfo) {
        ...
        getConfig(view, new CallbackCaller$dealNodeInfo$1(view, accessibilityNodeInfo));
    }
