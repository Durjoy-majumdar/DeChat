...
public final class ClickConductionProvider$dealOnViewInflateAsync$1 extends C87413o implements C32226l<MMBaseAccessibilityConfig, Boolean> {
    public final /* synthetic */ View $view;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ClickConductionProvider$dealOnViewInflateAsync$1(View view) {
        super(1);
        this.$view = view;
    }
    ...
    public final Boolean invoke(MMBaseAccessibilityConfig mMBaseAccessibilityConfig) {
        ...
        if (!mMBaseAccessibilityConfig.getClickViewRootTargetMap$plugin_autoaccessibility_release().containsKey(Integer.valueOf(this.$view.getId()))) {
            return Boolean.FALSE;
        }
        ClickConductionProvider.INSTANCE.logMsg(ClickConductionProvider.TAG, this.$view, "set Clickable true");
