...
public final class AccProviderFactory$dispatchViewInflate$1 extends C87413o implements C32224a<C13598b0> {
    public final /* synthetic */ View $view;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AccProviderFactory$dispatchViewInflate$1(View view) {
        super(0);
        this.$view = view;
    }
    ...
    public final void invoke() {
        ...
        for (Provider provider : access$getProviders$p) {
            if ((provider.getAuthority() & 2) == 2) {
                provider.dealOnViewInflateAsync(view);
            }
            provider.preFindRoot$plugin_autoaccessibility_release(view);
        }
    }
}
