...
/* renamed from: com.tencent.mm.ui.chatting.viewitems.y0 */
public class C74309y0 extends C74023i {

    /* renamed from: v */
    public C67391b f218287v;
    ...
    public View mo26231E(LayoutInflater layoutInflater, View view) {
        ...
        C6807n4 n4Var = new C6807n4(layoutInflater, C0966R.C0971layout.f6906rv);
        C74294x0 x0Var = new C74294x0();
        x0Var.mo103283a(n4Var, true);
        n4Var.setTag(x0Var);
        return n4Var;
    }
    ...
    public boolean mo26233X(MenuItem menuItem, C67391b bVar, C72963f4 f4Var) {
        ...
        if (itemId == 103) {
            ...
            C67391b bVar2 = bVar;
            C117292a.m165358d(bVar2, aVar2.mo10232b(), "com/tencent/mm/ui/chatting/viewitems/ChattingItemAppMsgCouponCard$ChattingItemAppMsgCouponCardFrom", "onContextItemSelected", "(Landroid/view/MenuItem;Lcom/tencent/mm/ui/chatting/context/ChattingContext;Lcom/tencent/mm/storage/MsgInfo;)Z", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
            bVar.mo91556Q((Intent) aVar2.mo10231a(0));
            C117292a.m165359e(bVar2, "com/tencent/mm/ui/chatting/viewitems/ChattingItemAppMsgCouponCard$ChattingItemAppMsgCouponCardFrom", "onContextItemSelected", "(Landroid/view/MenuItem;Lcom/tencent/mm/ui/chatting/context/ChattingContext;Lcom/tencent/mm/storage/MsgInfo;)Z", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
            return false;
        }
        return false;
    }
    ...
    public boolean mo26235Z(C76874e0 e0Var, View view, ContextMenu.ContextMenuInfo contextMenuInfo, C72963f4 f4Var) {
        ...
        if (f4Var.getContent() == null || (u = C68070l.C68072b.m80422u(C75604z3.m90840l(this.f218287v.mo91583x(), f4Var.getContent(), f4Var.mo108769t2()), (String) null)) == null) {
            return true;
        }
        int i = u.f195582i;
        if (i == 16) {
            ...
            if (i2 == 5 || i2 == 6 || i2 == 2) {
                ...
                int i3 = b;
                e0Var2.mo107136c(i3, 100, 0, this.f218287v.mo91572m().getString(C0966R.string.b_1), C0966R.raw.icons_filled_delete);
                e0Var2.mo107136c(i3, 122, 0, this.f218287v.mo91565f().getString(C0966R.string.b_5), C0966R.raw.icons_filled_multiple_choice);
                return false;
            }
        } else if (i == 34) {
            e0Var.clear();
            e0Var.mo107136c(b, 100, 0, this.f218287v.mo91572m().getString(C0966R.string.b_1), C0966R.raw.icons_filled_delete);
            return false;
        }
        return true;
    }
