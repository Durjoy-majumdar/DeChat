...
/* renamed from: com.tencent.mm.ui.chatting.viewitems.j1 */
public class C57767j1 {

    /* renamed from: a */
    public static C100075f f165327a;

    /* renamed from: com.tencent.mm.ui.chatting.viewitems.j1$a */
    public static class C57768a extends C74023i.C74026c {

        /* renamed from: b */
        public TextView f165328b;

        /* renamed from: c */
        public ImageView f165329c;

        /* renamed from: d */
        public TextView f165330d;

        /* renamed from: e */
        public ImageView f165331e;

        /* renamed from: f */
        public TextView f165332f;

        /* renamed from: a */
        public C57768a mo82216a(View view, boolean z) {
            super.create(view);
            this.f165328b = (TextView) view.findViewById(C0966R.C0970id.b6m);
            this.f165329c = (ImageView) view.findViewById(C0966R.C0970id.b6o);
            this.f165330d = (TextView) view.findViewById(C0966R.C0970id.b6n);
            this.userTV = (TextView) view.findViewById(C0966R.C0970id.b9_);
            this.f165332f = (TextView) view.findViewById(C0966R.C0970id.b6d);
            ...
            if (z) {
                ...
                this.f165331e = (ImageView) view.findViewById(C0966R.C0970id.b8x);
            }
            return this;
        }
    }

    /* renamed from: com.tencent.mm.ui.chatting.viewitems.j1$b */
    public static class C57769b extends C74023i {

        /* renamed from: v */
        public C67391b f165333v;
        ...
        public View mo26231E(LayoutInflater layoutInflater, View view) {
            ...
            C57768a aVar = new C57768a();
            aVar.mo82216a(n4Var, false);
            n4Var.setTag(aVar);
            return n4Var;
        }
        ...
        public boolean mo26233X(MenuItem menuItem, C67391b bVar, C72963f4 f4Var) {
            ...
            C57767j1.m66663b(bVar.mo91565f(), f4Var);
            return true;
        }
        ...
        public boolean mo26235Z(C76874e0 e0Var, View view, ContextMenu.ContextMenuInfo contextMenuInfo, C72963f4 f4Var) {
            ...
            if (f4Var != null) {
                ...
                if (!z) {
                    e0Var.mo107136c(b, 111, 0, this.f165333v.mo91572m().getString(C0966R.string.i48), C0966R.raw.icons_filled_share);
                }
            }
            return true;
        }
        ...
        public boolean mo26236a0(View view, C67391b bVar, C72963f4 f4Var) {
            ...
            C64730tk1 a = C57767j1.m66662a(content != null ? C68070l.C68072b.m80422u(content, f4Var.mo108775z2()) : null);
            if (a == null) {
                return false;
            }
            C57767j1.m66664c(bVar.mo91565f(), f4Var, a);
            return false;
        }
        ...
        public void mo26237f(C74023i.C74026c cVar, C67391b bVar, C72963f4 f4Var, String str) {
            String str2;
            this.f165333v = bVar;
            C57768a aVar = (C57768a) cVar;
            String content = f4Var.getContent();
            C68070l.C68072b u = content != null ? C68070l.C68072b.m80422u(content, f4Var.mo108775z2()) : null;
            if (u != null) {
                C64730tk1 a = C57767j1.m66662a(u);
                if (!(a == null || a.f185609j == null)) {
                    if (a.f185604e == 7) {
                        str2 = ((C76243a5) C86312j.m106911c(C76243a5.class)).Vo0(a.f185609j);
                        String charSequence = MMApplicationContext.getContext().getText(C0966R.string.d2h).toString();
                        if (!TextUtils.isEmpty(a.f185609j.f182285i)) {
                            charSequence = a.f185609j.f182285i;
                        }
                        aVar.f165332f.setText(charSequence);
                    } else {
                        str2 = a.f185603d;
                    }
                    aVar.f165328b.setText(((C76979h) C86312j.m106911c(C76979h.class)).mo107057T1(bVar.mo91565f(), str2));
                    if (Util.isNullOrNil(a.f185605f)) {
                        aVar.f165329c.setVisibility(4);
                    } else {
                        aVar.f165329c.setVisibility(0);
                        C99101e eVar = C99101e.f290570a;
                        C99101e.f290571b.mo85957c(a.f185605f, aVar.f165329c, C57767j1.f165327a);
                    }
                    aVar.f165330d.setText(a.f185606g);
                }
                ...
                if (view != null) {
                    ...
                    aVar.clickArea.setTag(new C74243t8(f4Var, this.f165333v.mo91583x(), aVar, (String) null));
                }
            }
        }
        ...
        public boolean mo26238k0(int i, boolean z) {
            if (!z) {
                return i == 1023475761 || i == 1023541297;
            }
            return false;
        }
    }

    /* renamed from: com.tencent.mm.ui.chatting.viewitems.j1$c */
    public static class C57770c extends C74023i implements C73774p2 {

        /* renamed from: v */
        public C67391b f165334v;
        ...
        public boolean mo26235Z(C76874e0 e0Var, View view, ContextMenu.ContextMenuInfo contextMenuInfo, C72963f4 f4Var) {
            ...
            boolean z = !((C60200t1) C86312j.m106911c(C60200t1.class)).mo76873sF();
            if (f4Var != null && !z) {
                e0Var.mo107136c(b, 111, 0, this.f165334v.mo91572m().getString(C0966R.string.i48), C0966R.raw.icons_filled_share);
                C88144b.m109788f("favorite");
                if ((f4Var.getStatus() == 2 || f4Var.f230728K == 1) && mo103083Q(f4Var, this.f165334v) && mo103081O(f4Var.mo108768t()) && !this.f165334v.mo91580u()) {
            ...
            if (u != null) {
                ...
                if (!(a == null || a.f185609j == null)) {
                    if (a.f185604e == 7) {
                        str2 = ((C76243a5) C86312j.m106911c(C76243a5.class)).Vo0(a.f185609j);
                        String charSequence = MMApplicationContext.getContext().getText(C0966R.string.d2h).toString();
                        if (!Util.isNullOrNil(a.f185609j.f182285i)) {
                            charSequence = a.f185609j.f182285i;
                        }
                        aVar.f165332f.setText(charSequence);
                    } else {
                ...
                if (view != null) {
                    ...
                    aVar.clickArea.setTag(new C74243t8(f4Var, this.f165334v.mo91583x(), aVar, (String) null));
                }
            }
            if (C74023i.m87878T()) {
                mo103093i0(aVar, false, true);
                if (f4Var.getStatus() != 2 || !mo103080N((C79368l) bVar.f193278b.mo102812a(cls), f4Var.getMsgId())) {
                    ImageView imageView = aVar.f165331e;
                    if (imageView != null) {
                        imageView.setVisibility(8);
                    }
                } else {
                    ImageView imageView2 = aVar.f165331e;
                    if (imageView2 != null) {
                        imageView2.setVisibility(0);
                    }
                }
            } else {
                ImageView imageView3 = aVar.f165331e;
                if (imageView3 != null) {
    ...
    static {
        ...
        aVar.f293176b = true;
        aVar.f293175a = true;
        f165327a = aVar.mo139398a();
    }

    /* renamed from: a */
    public static C64730tk1 m66662a(C68070l.C68072b bVar) {
    ...
    /* renamed from: b */
    public static void m66663b(Activity activity, C72963f4 f4Var) {
        C68070l.C68072b u;
        if (!Util.isNullOrNil(f4Var.getContent()) && (u = C68070l.C68072b.m80422u(f4Var.getContent(), (String) null)) != null) {
            ...
            C117292a.m165358d(activity, aVar.mo10232b(), "com/tencent/mm/ui/chatting/viewitems/ChattingItemAppMsgFinderActivity", "retransmit", "(Landroid/app/Activity;Lcom/tencent/mm/storage/MsgInfo;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
            activity.startActivity((Intent) aVar.mo10231a(0));
            C117292a.m165359e(activity, "com/tencent/mm/ui/chatting/viewitems/ChattingItemAppMsgFinderActivity", "retransmit", "(Landroid/app/Activity;Lcom/tencent/mm/storage/MsgInfo;)V", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
        }
    }

    /* renamed from: c */
    public static void m66664c(Context context, C72963f4 f4Var, C64730tk1 tk12) {
        C64258bf0 bf02;
