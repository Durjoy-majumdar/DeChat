...
/* renamed from: com.tencent.mm.ui.chatting.viewitems.ChattingItemAppMsgMegaVideo$$c */
public class ChattingItemAppMsgMegaVideo$$c extends C74023i {

    /* renamed from: v */
    public C67391b f165258v;

    /* renamed from: com.tencent.mm.ui.chatting.viewitems.ChattingItemAppMsgMegaVideo$$c$a */
    public class C57736a extends C23555k.C23562d {

        /* renamed from: a */
        public final /* synthetic */ C67391b f165259a;

        /* renamed from: b */
        public final /* synthetic */ C60181l f165260b;

        public C57736a(ChattingItemAppMsgMegaVideo$$c chattingItemAppMsgMegaVideo$$c, C67391b bVar, C60181l lVar) {
            this.f165259a = bVar;
            this.f165260b = lVar;
        }
        ...
        public void mo53b(View view, long j, long j2, boolean z) {
            if (z) {
                C49712hj1 dj = ((C60165e4) C86312j.m106911c(C60165e4.class)).mo85166dj(this.f165259a.mo91565f());
                long P = C61926c.m72671P(this.f165260b.f171715b.f183241d);
                C64378fw2 fw22 = this.f165260b.f171715b;
    ...
    public View mo26231E(LayoutInflater layoutInflater, View view) {
        if (view == null || view.getTag() == null) {
            ...
            chattingItemAppMsgMegaVideo$$b.mo82203a(view, false);
    ...
    public boolean mo26235Z(C76874e0 e0Var, View view, ContextMenu.ContextMenuInfo contextMenuInfo, C72963f4 f4Var) {
        ...
        if (f4Var != null) {
            ...
            if (!z) {
                e0Var.mo107136c(b, 111, 0, this.f165258v.mo91572m().getString(C0966R.string.i48), C0966R.raw.icons_filled_share);
            }
        }
        return true;
    }
    ...
    public boolean mo26236a0(View view, C67391b bVar, C72963f4 f4Var) {
        ...
        ChattingItemAppMsgMegaVideo.m66557c(view, bVar, lVar, intent, false, C72996z1.m85820U5(f4Var.mo108768t()));
        return false;
    }
    ...
    public void mo26237f(C74023i.C74026c cVar, C67391b bVar, C72963f4 f4Var, String str) {
        ...
        if (u != null) {
            ...
            if (lVar != null) {
                C23564m.m28138h(chattingItemAppMsgMegaVideo$$b.convertView, new C57736a(this, bVar2, lVar));
                ((C11990s0) C39818r.f106831a.mo62446e(cls3).mo62447c(cls2)).mo11872i2().mo85957c(((C62368t0) C86312j.m106911c(C62368t0.class)).mo87412UE(lVar.f171715b.f183244g, C27696y.THUMB_IMAGE), chattingItemAppMsgMegaVideo$$b.f165246b, ((C11990s0) C39818r.f106831a.mo62446e(cls3).mo62447c(cls2)).mo11867O2(C11978e0.C11979a.AVATAR_WITHOUT_DEFAULT));
                ...
                if (!linkedList.isEmpty()) {
                    if (!Util.isNullOrNil(linkedList.get(0).f183043h)) {
                        ((C60200t1) C86312j.m106911c(cls3)).mo76741Cm(linkedList.get(0).f183043h, chattingItemAppMsgMegaVideo$$b.f165248d, aVar);
                    } else {
                        ((C60200t1) C86312j.m106911c(cls3)).mo76741Cm(linkedList.get(0).f183040e, chattingItemAppMsgMegaVideo$$b.f165248d, aVar);
                    }
                ...
                if (((C75651n) C86312j.m106911c(C75651n.class)).ld0() == 1) {
                    ...
                    C117292a.m165359e(view4, "com/tencent/mm/ui/chatting/viewitems/ChattingItemAppMsgMegaVideo$ChattingItemAppMsgMegaVideoFrom", "filling", "(Lcom/tencent/mm/ui/chatting/viewitems/ChattingItem$BaseViewHolder;Lcom/tencent/mm/ui/chatting/context/ChattingContext;Lcom/tencent/mm/storage/MsgInfo;Ljava/lang/String;)V", "android/view/View_EXEC_", "setVisibility", "(I)V");
            ...
            chattingItemAppMsgMegaVideo$$b.clickArea.setOnTouchListener(((C79368l) bVar2.f193278b.mo102812a(C79368l.class)).mo108189Z4());
            chattingItemAppMsgMegaVideo$$b.clickArea.setTag(new C74243t8(f4Var, this.f165258v.mo91583x(), chattingItemAppMsgMegaVideo$$b, (String) null));
        }
    }
