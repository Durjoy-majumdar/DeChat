...
/* renamed from: com.tencent.mm.ui.chatting.viewitems.m3 */
public class C74114m3 extends C74023i implements C73774p2 {

    /* renamed from: v */
    public C67391b f217534v;
    ...
    public View mo26231E(LayoutInflater layoutInflater, View view) {
        ...
        C6807n4 n4Var = new C6807n4(layoutInflater, C0966R.C0971layout.f6953t8);
    ...
    public boolean mo26233X(MenuItem menuItem, C67391b bVar, C72963f4 f4Var) {
        ...
        if (itemId == 102) {
            String str = C68070l.C68072b.m80422u(f4Var.getContent(), (String) null).f195570f;
            ...
            C117292a.m165359e(bVar2, "com/tencent/mm/ui/chatting/viewitems/ChattingItemAppMsgText$ChattingItemAppMsgTextTo", "onContextItemSelected", "(Landroid/view/MenuItem;Lcom/tencent/mm/ui/chatting/context/ChattingContext;Lcom/tencent/mm/storage/MsgInfo;)Z", "Undefined", "startActivity", "(Landroid/content/Intent;)V");
            return false;
        }
    }
    ...
    public boolean mo26235Z(C76874e0 e0Var, View view, ContextMenu.ContextMenuInfo contextMenuInfo, C72963f4 f4Var) {
        ...
        if (!C75569c4.m90687t(f4Var)) {
            e0Var.mo107136c(b, 102, 0, this.f217534v.mo91572m().getString(C0966R.string.b9x), C0966R.raw.icons_filled_copy);
            e0Var.mo107136c(b, 111, 0, this.f217534v.mo91572m().getString(C0966R.string.i48), C0966R.raw.icons_filled_share);
        }
        C88144b.m109788f("favorite");
        e0Var.mo107136c(b, 116, 0, this.f217534v.mo91572m().getString(C0966R.string.f361137hk2), C0966R.raw.icons_filled_favorites);
        if (!f4Var.mo100967F3() && ((f4Var.getStatus() == 2 || f4Var.f230728K == 1) && mo103083Q(f4Var, this.f217534v) && mo103081O(f4Var.mo108768t()))) {
            e0Var.mo107136c(b, 123, 0, view.getContext().getString(C0966R.string.b_d), C0966R.raw.icons_filled_previous);
        }
        if (!this.f217534v.mo91584y()) {
            e0Var.mo107136c(b, 100, 0, this.f217534v.mo91572m().getString(C0966R.string.b_1), C0966R.raw.icons_filled_delete);
        }
        return true;
    }
    ...
    public void mo26237f(C74023i.C74026c cVar, C67391b bVar, C72963f4 f4Var, String str) {
        ...
        if (u != null && u.f195582i == 1) {
            ...
            if (f4Var.getStatus() == 2 || f4Var.getStatus() == 5) {
                mo103093i0(k3Var, false, true);
            } else {
                mo103093i0(k3Var, true, true);
            }
            mo103087e0(k3Var, f4Var, bVar.mo91573n(), bVar.mo91583x(), bVar, this);
        }
