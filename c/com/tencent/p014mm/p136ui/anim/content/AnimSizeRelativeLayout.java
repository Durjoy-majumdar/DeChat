...
public final class AnimSizeRelativeLayout extends RelativeLayout {
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        this.f214692d.mo91532d(z, i, i2, i3, i4);
    }

    public void onMeasure(int i, int i2) {
        C13604l<Integer, Integer> f = this.f214692d.mo91534f(i, i2);
        if (f != null) {
        ...
        super.onMeasure(i, i2);
        C13604l<Integer, Integer> e = this.f214692d.mo91533e(i, i2);
        if (e != null) {
