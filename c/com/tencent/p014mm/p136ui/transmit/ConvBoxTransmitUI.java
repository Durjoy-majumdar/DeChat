...
public class ConvBoxTransmitUI extends SelectConversationUI {
    ...
    /* renamed from: com.tencent.mm.ui.transmit.ConvBoxTransmitUI$a */
    public static class C74870a extends C74526m1 implements MStorageEx.IOnStorageChange {

        /* renamed from: n */
        public Cursor f220123n;

        public C74870a(MMBaseSelectContactUI mMBaseSelectContactUI, List<String> list, boolean z, boolean z2, boolean z3) {
        ...
        public int getCount() {
            Cursor cursor = this.f220123n;
            if (cursor != null) {
                return cursor.getCount();
            }
            Log.m105920e("MicroMsg.ConvBoxTransmitUI.ConvBoxTransmitAdapter", "getCount: dataCursor == null ");
            return 0;
        }

        /* renamed from: h */
        public C75922b mo7850h(int i) {
            if (!this.f220123n.moveToPosition(i)) {
                return null;
            }
            Class cls = C75700k0.class;
            C75946n nVar = new C75946n(i);
            C72976h2 h2Var = new C72976h2();
            h2Var.convertFrom(this.f220123n);
            C86709a0.m107528h();
        ...
        public void mo7851i() {
            mo103564g();
            Log.m105924i("MicroMsg.ConvBoxTransmitUI.ConvBoxTransmitAdapter", "finish!");
            Cursor cursor = this.f220123n;
            if (cursor != null) {
                cursor.close();
                this.f220123n = null;
        ...
        /* renamed from: r */
        public void mo7853r() {
            Log.m105924i("MicroMsg.ConvBoxTransmitUI.ConvBoxTransmitAdapter", "resetData");
            Cursor cursor = this.f220123n;
            if (cursor != null) {
                cursor.close();
                this.f220123n = null;
            }
            this.f220123n = ((C44660i2) C97625j3.m125812b().mo105908w()).mo69738I(5, this.f219096j, "conversationboxservice", -1);
        }
    }
    ...
    public C74526m1 mo64513L7() {
        return new C74870a(this, (List<String>) null, this.f220199r1, this.f220170U0, this.f220169U);
    }
    ...
    public String mo64516Q7() {
        return getString(C0966R.string.bvb);
    }
