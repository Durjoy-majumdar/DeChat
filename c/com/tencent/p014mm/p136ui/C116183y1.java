...
/* renamed from: com.tencent.mm.ui.y1 */
public class C116183y1 extends MMActivityController implements C112467b.C112469b {

    /* renamed from: s0 */
    public MMFragment f348688s0 = null;

    /* renamed from: t0 */
    public ActionBar f348689t0;

    /* renamed from: u0 */
    public C112467b f348690u0;

    /* renamed from: B */
    public ActionBar mo177037B() {
        if (this.f348689t0 == null) {
            this.f348689t0 = C76004e.m91288N(this.f348690u0.mo164182e());
        }
        return this.f348689t0;
    }

    /* renamed from: G0 */
    public void mo177047G0() {
        C112467b bVar = this.f348690u0;
        if (!bVar.f336743o) {
            bVar.f336743o = true;
    ...
    public boolean mo177019N() {
        MMFragment mMFragment = this.f348688s0;
        if (mMFragment != null) {
            return mMFragment.isActionbarMenuUseOriginalSys();
        }
        return false;
    }
    ...
    public boolean onCreatePanelMenu(int i, Menu menu) {
        this.f348688s0.onCreateOptionsMenu(menu, this.f348690u0.mo164183f());
        return true;
    }
    ...
    public String mo177030r() {
        return this.f348688s0.getClass().getName();
    }
