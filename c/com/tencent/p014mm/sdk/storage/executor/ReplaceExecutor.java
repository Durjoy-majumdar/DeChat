...
public final class ReplaceExecutor {
    ...
    @Metadata(mo182093d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo182094d2 = {"Lcom/tencent/mm/sdk/storage/executor/ReplaceExecutor$Companion;", "", "()V", "TAG", "", "wechat-sdk_release"}, mo182095k = 1, mo182096mv = {1, 7, 1}, mo182098xi = 48)
    /* renamed from: com.tencent.mm.sdk.storage.executor.ReplaceExecutor$Companion */
    ...
    public ReplaceExecutor(IAutoDBItem iAutoDBItem, StorageObserverEvent<? extends IAutoDBItem> storageObserverEvent, StorageObserverOwner<?> storageObserverOwner, String str) {
    ...
    public final long execute(ISQLiteDatabase iSQLiteDatabase) {
        ...
        if (iSQLiteDatabase == null || convertTo == null || obj == null) {
            ...
            Log.m105924i(str, "replace table:" + this.item.getTableName() + " fail primaryKey:" + dBInfo.primaryKey + " value:" + obj);
            return -1;
        }
        long replace = iSQLiteDatabase.replace(this.item.getTableName(), dBInfo.primaryKey, convertTo);
        int i = (replace > 0 ? 1 : (replace == 0 ? 0 : -1));
        if (i > 0) {
        ...
        if (i > 0) {
            ...
            if (!z) {
                Log.m105924i(this.logTag, "replace table:" + this.item.getTableName() + " success primaryKey:" + dBInfo.primaryKey + " value:" + obj);
            }
        }
        if (i <= 0) {
            ...
            Log.m105920e(str, "replace effectRow:" + replace + " table:" + this.item.getTableName() + " fail primaryKey:" + dBInfo.primaryKey + " value:" + obj);
        }
        return replace;
    }
    ...
    public /* synthetic */ ReplaceExecutor(IAutoDBItem iAutoDBItem, StorageObserverEvent storageObserverEvent, StorageObserverOwner storageObserverOwner, String str, int i, C8480h hVar) {
