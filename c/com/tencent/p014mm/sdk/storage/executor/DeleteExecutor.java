...
public final class DeleteExecutor {
    ...
    @Metadata(mo182093d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo182094d2 = {"Lcom/tencent/mm/sdk/storage/executor/DeleteExecutor$Companion;", "", "()V", "TAG", "", "wechat-sdk_release"}, mo182095k = 1, mo182096mv = {1, 7, 1}, mo182098xi = 48)
    /* renamed from: com.tencent.mm.sdk.storage.executor.DeleteExecutor$Companion */
    ...
    public DeleteExecutor(IAutoDBItem iAutoDBItem, StorageObserverEvent<? extends IAutoDBItem> storageObserverEvent, StorageObserverOwner<?> storageObserverOwner, String str) {
    ...
    public final int execute(ISQLiteDatabase iSQLiteDatabase) {
        ...
        Object primaryKeyValue = this.item.getPrimaryKeyValue();
        String str = TAG;
        if (iSQLiteDatabase == null || primaryKeyValue == null) {
            String str2 = this.logTag;
            if (str2 != null) {
                str = str2;
            }
            Log.m105924i(str, "delete table:" + this.item.getTableName() + " fail primaryKey:" + dBInfo.primaryKey + " value:" + primaryKeyValue);
            return -1;
        }
        String tableName = this.item.getTableName();
        boolean z = true;
        int delete = iSQLiteDatabase.delete(tableName, dBInfo.primaryKey + " = ?", new String[]{primaryKeyValue.toString()});
        if (delete > 0) {
        ...
        if (delete > 0) {
            ...
            if (!z) {
                ...
                Log.m105924i(str4, "delete table:" + this.item.getTableName() + " success primaryKey:" + dBInfo.primaryKey + " value:" + primaryKeyValue);
            }
        }
        if (delete <= 0) {
            ...
            Log.m105920e(str, "delete effectRow:" + delete + " table:" + this.item.getTableName() + " fail primaryKey:" + dBInfo.primaryKey + " value:" + primaryKeyValue);
        }
        return delete;
    }
    ...
    public /* synthetic */ DeleteExecutor(IAutoDBItem iAutoDBItem, StorageObserverEvent storageObserverEvent, StorageObserverOwner storageObserverOwner, String str, int i, C8480h hVar) {
