...
/* renamed from: com.tencent.mm.sdk.systemservicecache.NetworkCache$initCache$1$1$1$onReceive$1 */
public final class NetworkCache$initCache$1$1$1$onReceive$1 implements Runnable {
    public final /* synthetic */ Context $ctx;

    public NetworkCache$initCache$1$1$1$onReceive$1(Context context) {
        this.$ctx = context;
    }
    ...
    public final void run() {
        ...
        if (NetworkCache.activeNetworkInfo != null) {
            ...
            Log.m105924i("NetWorkCache", "initCache onReceive, networkType = " + NetworkCache.networkType + ", iosNetworkType = " + NetworkCache.iosNetworkType);
        }
    }
}
