...
public final class UIStateCenter<State extends BaseState> {
    ...
    /* access modifiers changed from: private */
    public final UIStateCenter$observerOwner$1 observerOwner;
    /* access modifiers changed from: private */
    public final RootProcessor<State> rootProcessor;

    @Metadata(mo182093d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, mo182094d2 = {"Lcom/tencent/mm/sdk/statecenter/UIStateCenter$Companion;", "", "()V", "SCOPE_NAME", "", "wechat-sdk_release"}, mo182095k = 1, mo182096mv = {1, 7, 1}, mo182098xi = 48)
    /* renamed from: com.tencent.mm.sdk.statecenter.UIStateCenter$Companion */
    ...
    public UIStateCenter(State state, C0125s sVar, String str, LifecycleScope lifecycleScope2) {
        ...
        this.observerOwner = new UIStateCenter$observerOwner$1(this);
    }
    ...
    public final void dispatch(IStateAction iStateAction) {
        ...
        LifecycleScope.launchDefault$default(this.lifecycleScope, (C53934p0) null, new UIStateCenter$dispatch$1(this, iStateAction, (C15601d<? super UIStateCenter$dispatch$1>) null), 1, (Object) null);
    }
    ...
    public final void observe(C0125s sVar, C32226l<? super State, C13598b0> lVar) {
        ...
        this.observerOwner.observe(sVar, MvvmObserverOwner.MainThread, new UIStateCenter$sam$com_tencent_mm_sdk_observer_IMvvmObserver$0(lVar));
    }

    public final void process(C0125s sVar, C32226l<? super State, C13598b0> lVar) {
        C87412m.m108594g(sVar, "owner");
        C87412m.m108594g(lVar, "processor");
        this.rootProcessor.addProcessor(sVar, new UIStateCenter$sam$com_tencent_mm_sdk_statecenter_IProcessor$0(lVar));
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ UIStateCenter(BaseState baseState, C0125s sVar, String str, LifecycleScope lifecycleScope2, int i, C8480h hVar) {
