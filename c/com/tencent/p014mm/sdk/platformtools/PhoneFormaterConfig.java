...
import com.tencent.tmassistantsdk.util.QUASetting;
import com.tencent.xweb.WCWebUpdater;
import com.tenpay.android.wechat.PayuSecureEncrypt;
import java.util.LinkedList;
import java.util.List;

/* renamed from: com.tencent.mm.sdk.platformtools.PhoneFormaterConfig */
class PhoneFormaterConfig {
    public List<Country> contryList = new LinkedList();

    /* renamed from: com.tencent.mm.sdk.platformtools.PhoneFormaterConfig$Country */
    public static class Country {
        public String countrycode;
        public List<Format> formatList = new LinkedList();
        public String isocode;
        public int maxlen = 20;
        public int minlen = 10;
    }

    /* renamed from: com.tencent.mm.sdk.platformtools.PhoneFormaterConfig$Format */
    ...
    public PhoneFormaterConfig() {
        ...
        format6.leading = WCWebUpdater.XWEB_UPDATER_START_CHECK_TYPE_CONFIG_ONLY;
        ...
        country13.isocode = QUASetting.UN_DEFINED;
        ...
        format35.leading = WCWebUpdater.XWEB_UPDATER_START_CHECK_TYPE_NOTIFY_ONLY_INSTALL_EMBED_PLUGIN;
        ...
        format151.leading = WCWebUpdater.XWEB_UPDATER_START_CHECK_TYPE_CONFIG_ONLY;
        ...
        String str5 = "7";
        format194.leading = str5;
        format194.pattern = "$1 $2";
        String str6 = "(\\d{4})(\\d{4})";
        format194.formatregex = str6;
        ...
        format210.leading = WCWebUpdater.XWEB_UPDATER_START_CHECK_TYPE_NOTIFY_ONLY_INSTALL_EMBED_PLUGIN;
        ...
        country75.isocode = C0949kl.f2238h;
        ...
        format235.leading = WCWebUpdater.XWEB_UPDATER_START_CHECK_TYPE_CONFIG_ONLY;
        ...
        format260.leading = WCWebUpdater.XWEB_UPDATER_START_CHECK_TYPE_NOTIFY_ONLY_INSTALL_EMBED_PLUGIN;
        ...
        format282.leading = WCWebUpdater.XWEB_UPDATER_START_CHECK_TYPE_CONFIG_ONLY;
        ...
        format346.leading = WCWebUpdater.XWEB_UPDATER_START_CHECK_TYPE_NOTIFY_ONLY_INSTALL_EMBED_PLUGIN;
        ...
        format375.leading = WCWebUpdater.XWEB_UPDATER_START_CHECK_TYPE_NOTIFY_ONLY_INSTALL_EMBED_PLUGIN;
        ...
        format382.leading = WCWebUpdater.XWEB_UPDATER_START_CHECK_TYPE_CONFIG_ONLY;
        ...
        format422.leading = WCWebUpdater.XWEB_UPDATER_START_CHECK_TYPE_NOTIFY_ONLY_INSTALL_EMBED_PLUGIN;
        format422.pattern = "$1 $2";
        format422.formatregex = "(6\\d)(\\d{6,8})";
        country131.formatList.add(format422);
        Format format423 = new Format();
        String str14 = str;
        format423.leading = str14;
        ...
        country135.isocode = C0949kl.f2247q;
        country135.countrycode = "377";
        country135.minlen = 8;
        country135.maxlen = 9;
        Format format429 = new Format();
        format429.leading = str14;
        ...
        format430.leading = WCWebUpdater.XWEB_UPDATER_START_CHECK_TYPE_EMBEDINSTALL;
        format430.pattern = "$1 $2 $3";
        format430.formatregex = "(\\d{2})(\\d{3})(\\d{3})";
        country135.formatList.add(format430);
        Format format431 = new Format();
        format431.leading = WCWebUpdater.XWEB_UPDATER_START_CHECK_TYPE_NOTIFY_ONLY_INSTALL_EMBED_PLUGIN;
        ...
        format448.pattern = str10;
        format448.formatregex = "(\\d{3})(\\d{4})";
        country142.formatList.add(format448);
        Format format449 = new Format();
        format449.leading = WCWebUpdater.XWEB_UPDATER_START_CHECK_TYPE_NOTIFY_ONLY_INSTALL_EMBED_PLUGIN;
        format449.pattern = str10;
        String str17 = str11;
        format449.formatregex = str17;
        ...
        format451.leading = "";
        format451.pattern = str10;
        format451.formatregex = "(\\d{3})(\\d{4})";
        country144.formatList.add(format451);
        Format format452 = new Format();
        format452.leading = "";
        format452.pattern = str12;
        String str18 = "(\\d{3})(\\d{3})(\\d{4})";
        format452.formatregex = str18;
        ...
        String str21 = "(\\d{2})(\\d{2})(\\d{2})(\\d{2})";
        format527.formatregex = str21;
        String str22 = str10;
