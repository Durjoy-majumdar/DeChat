...
/* renamed from: com.tencent.mm.plugin.finder.gallery.FinderGallerySnsCoverConfig */
public final class FinderGallerySnsCoverConfig extends FinderGalleryDefaultConfig {

    /* renamed from: c */
    public BaseFinderFeed f159158c;

    /* renamed from: d */
    public int f159159d;

    /* renamed from: e */
    public FinderObject f159160e;

    /* renamed from: com.tencent.mm.plugin.finder.gallery.FinderGallerySnsCoverConfig$a */
    public static final class C3124a extends RecyclerView.C0129l {
        /* renamed from: g */
    ...
    public FinderGallerySnsCoverConfig(C66791a aVar) {
        super(aVar);
    ...
    public C9500j mo77476a(int i) {
        return !mo77487l() ? new FinderGallerySnsCoverConfig$buildItemCoverts$1() : new FinderGalleryDefaultConfig$buildItemCoverts$1(this);
    }
    ...
    public RecyclerView.C0129l mo77479d(int i) {
        return !mo77487l() ? new C3124a() : new C16146d();
    }
    ...
    public void mo77484i(MMActivity mMActivity, int i, int i2, Intent intent, C66792b.C66794b bVar) {
        ...
        if (intent != null) {
            this.f159159d = intent.getIntExtra("TAB_TYPE", 0);
        }
        ...
        if (byteArrayExtra != null) {
            ...
            this.f159160e = finderObject;
        }
        int ordinal = bVar.ordinal();
        if (ordinal != 0) {
            if (ordinal == 1) {
                mo77489m(i, i2, mMActivity, true);
            }
        } else if (!mo77489m(i, i2, mMActivity, false) && i == 20000 && i2 == -1) {
    ...
    public void mo77485j(MMActivity mMActivity, int i, BaseFinderFeed baseFinderFeed, List<? extends BaseFinderFeed> list, C89349b bVar, boolean z) {
        ...
        this.f159158c = baseFinderFeed;
        Intent intent = new Intent();
        this.f159159d = i;
        intent.putExtra("SELECT_OBJECT", baseFinderFeed.mo3513o().getFeedObject().toByteArray());
        ((C66708h) C86312j.m106911c(C66708h.class)).mo90744pe(mMActivity, intent, 10003);
    }

    /* renamed from: m */
    public final boolean mo77489m(int i, int i2, MMActivity mMActivity, boolean z) {
        BaseFinderFeed baseFinderFeed = this.f159158c;
        FinderObject finderObject = this.f159160e;
        if (finderObject == null) {
            finderObject = baseFinderFeed != null ? baseFinderFeed.mo3513o().getFeedObject() : null;
        }
        if (i == 10003 && i2 == -1 && finderObject != null) {
            Intent intent = new Intent();
            intent.putExtra("SELECT_OBJECT", finderObject.toByteArray());
            intent.putExtra("SELECT_TAB_TYPE", this.f159159d);
            mMActivity.setResult(-1, intent);
            mMActivity.finish();
            if (!z) {
