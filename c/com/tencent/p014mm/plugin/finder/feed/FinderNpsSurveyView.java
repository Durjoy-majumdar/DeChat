...
@Metadata(mo182092bv = {}, mo182093d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u001e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u001b\b\u0016\u0012\u0006\u0010\f\u001a\u00020\u000b\u0012\b\u0010\u000e\u001a\u0004\u0018\u00010\r¢\u0006\u0004\b\u000f\u0010\u0010B#\b\u0016\u0012\u0006\u0010\f\u001a\u00020\u000b\u0012\b\u0010\u000e\u001a\u0004\u0018\u00010\r\u0012\u0006\u0010\u0012\u001a\u00020\u0011¢\u0006\u0004\b\u000f\u0010\u0013J\u0016\u0010\u0006\u001a\u00020\u00052\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u0002H\u0007J\u0014\u0010\n\u001a\u00020\u00052\f\u0010\t\u001a\b\u0012\u0004\u0012\u00020\b0\u0007¨\u0006\u0014"}, mo182094d2 = {"Lcom/tencent/mm/plugin/finder/feed/FinderNpsSurveyView;", "Landroid/widget/FrameLayout;", "", "Lcom/tencent/mm/plugin/finder/feed/model/g0;", "list", "Lrx3/b0;", "setAnswerList", "Ljq3/l$b;", "Ljq3/o;", "listener", "setItemClickListener", "Landroid/content/Context;", "context", "Landroid/util/AttributeSet;", "attrs", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "", "defStyleAttr", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "plugin-finder_release"}, mo182095k = 1, mo182096mv = {1, 7, 1})
/* renamed from: com.tencent.mm.plugin.finder.feed.FinderNpsSurveyView */
public final class FinderNpsSurveyView extends FrameLayout {

    /* renamed from: d */
    public WxRecyclerView f13126d;

    /* renamed from: e */
    public ArrayList<C2783g0> f13127e = new ArrayList<>();

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FinderNpsSurveyView(Context context, AttributeSet attributeSet) {
        ...
        this.f13126d = wxRecyclerView;
        if (wxRecyclerView != null) {
            wxRecyclerView.setLayoutManager(new FlowLayoutManager());
        }
        WxRecyclerAdapter wxRecyclerAdapter = new WxRecyclerAdapter(new FinderNpsSurveyView$buildItemCoverts$1(), this.f13127e, false);
        WxRecyclerView wxRecyclerView2 = this.f13126d;
        if (wxRecyclerView2 != null) {
            wxRecyclerView2.setAdapter(wxRecyclerAdapter);
        }
    }

    public final void setAnswerList(Collection<C2783g0> collection) {
        RecyclerView.C16613e adapter;
        C87412m.m108594g(collection, "list");
        this.f13127e.clear();
        this.f13127e.addAll(collection);
        WxRecyclerView wxRecyclerView = this.f13126d;
    ...
    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FinderNpsSurveyView(Context context, AttributeSet attributeSet, int i) {
