...
/* renamed from: com.tencent.mm.plugin.finder.presenter.contract.FinderMsgContract$MsgViewCallback$checkMegaVideoDetail$1 */
final class FinderMsgContract$MsgViewCallback$checkMegaVideoDetail$1<_Ret, _Var> implements C87581a {

    /* renamed from: a */
    public final /* synthetic */ FinderMsgContract.MsgViewCallback f160407a;

    /* renamed from: b */
    public final /* synthetic */ C66276va f160408b;

    public FinderMsgContract$MsgViewCallback$checkMegaVideoDetail$1(FinderMsgContract.MsgViewCallback msgViewCallback, C66276va vaVar) {
        this.f160407a = msgViewCallback;
        this.f160408b = vaVar;
    }
    ...
    public Object call(Object obj) {
        ...
        if (cVar == null) {
            String str = this.f160407a.f160387d;
            Log.m105924i(str, "result == null id " + this.f160408b.field_id + " content " + Util.secPrint(this.f160408b.field_content));
        } else if (cVar.f256793a == 0 && cVar.f256794b == 0) {
            String str2 = this.f160407a.f160387d;
            StringBuilder sb = new StringBuilder();
            sb.append("get mega video detail success, id = ");
            C60798d2 d2Var = this.f160407a.f160400t;
            C49712hj1 hj12 = null;
            ...
            int i = this.f160407a.f160389f.f160376d;
            w3Var.getClass();
            boolean z = true;
            if (i != 1) {
                z = false;
            ...
            if (!(pv22 == null || (xv22 = pv22.f140025y) == null)) {
                ...
                FinderMsgContract.MsgViewCallback msgViewCallback = this.f160407a;
                C66276va vaVar = this.f160408b;
                C50882pv2 pv23 = ac12.f130427d;
                String str3 = (pv23 == null || (xv23 = pv23.f140025y) == null) ? null : xv23.f144994e;
                int i3 = msgViewCallback.f160389f.f160376d;
                ...
                msgViewCallback.f160398r = x1Var;
                x1Var.mo9225i().mo123062e(new FinderMsgContract$MsgViewCallback$checkMegaVideoDetail$1$1$1(msgViewCallback, vaVar));
            }
        } else {
            FinderMsgContract.MsgViewCallback.m64245y(this.f160407a, cVar.f256794b);
        }
