...
/* renamed from: com.tencent.mm.plugin.setting.ui.setting.c2 */
public class C19180c2 implements Runnable {

    /* renamed from: d */
    public final /* synthetic */ SettingsChattingUI f53984d;

    /* renamed from: com.tencent.mm.plugin.setting.ui.setting.c2$a */
    public class C19181a implements C97629n2.C97630a {
        public C19181a() {
        }
        ...
        public void mo24602b(boolean z) {
            ProgressDialog progressDialog = C19180c2.this.f53984d.f205712e;
            if (progressDialog != null) {
                progressDialog.dismiss();
                C19180c2.this.f53984d.f205712e = null;
            }
            new ResetBadgeCountEvent().publish();
        }
    }

    /* renamed from: com.tencent.mm.plugin.setting.ui.setting.c2$b */
    public class C19182b implements z3$$g {
        public C19182b() {
        }

        /* renamed from: b */
        public boolean mo24603b() {
            return C19180c2.this.f53984d.f205713f;
        }
    ...
    public C19180c2(SettingsChattingUI settingsChattingUI) {
        this.f53984d = settingsChattingUI;
    }
    ...
    public void run() {
        ...
        if (arrayList.size() > 0) {
            ...
            for (int i2 = 0; i2 < arrayList.size(); i2++) {
                Log.m105925i("MicroMsg.SettingsChattingUI", "doResetChatHistory >> delete history: %s", arrayList.get(i2));
        ...
        if (WeChatEnvironment.hasDebugger() || ((C32735h) C86312j.m106911c(C32735h.class)).mo58776F5("clicfg_sync_delete_message", "0").equals("1")) {
            ...
            CancellationSignal cancellationSignal = this.f53984d.f205714g;
            long c = C31543z5.m39453c();
            ((C119157j) C119157j.f356862d).mo183875f(new z3$$a(aVar, c, cancellationSignal));
        } else {
            ThreadPool.post(new C31447a4(C31543z5.m39453c(), new C19182b()), "deleteAllMsg");
        }
