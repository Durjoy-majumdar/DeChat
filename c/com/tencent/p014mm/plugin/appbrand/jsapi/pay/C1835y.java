...
/* renamed from: com.tencent.mm.plugin.appbrand.jsapi.pay.y */
public class C1835y extends C82268c<C88267e> {
        ...
        try {
            ...
            if (!(optString == null || appId == null || optString.isEmpty())) {
                if (!appId.isEmpty()) {
                    ...
                    AppBrandJsApiPayService.INSTANCE.startPayComponent(o0, eVar.getRuntime().mo121253n1(), "entrustAuthorization", hashMap, new C1834x(this, eVar, i));
                    return;
                }
            }
            eVar.mo109647a(i, mo115112m("fail", new C1830v(this)));
        } catch (Exception e) {
            Log.m105920e("MicroMsg.JsApiRequestEntrustAuthorization", e.getMessage());
            eVar.mo109647a(i, mo115112m("fail", new C1832w(this)));
        }
    }
}
