...
/* renamed from: com.tencent.mm.plugin.appbrand.jsapi.share.s */
public class C82989s extends C82268c<C81925i2> {
    ...
    public void mo1505u(C82381f fVar, JSONObject jSONObject, int i) {
        ...
        if (l0 != null) {
            ...
            J0.f244320d.mo120962i("enable_share_dynamic", Boolean.valueOf(optBoolean));
            i2Var.mo109647a(i, mo115109j("ok"));
            Log.m105925i("MicroMsg.JsApiUpdateShareMenuDynamic", "update share menu dynamic(%s)", Boolean.valueOf(optBoolean));
            return;
        }
