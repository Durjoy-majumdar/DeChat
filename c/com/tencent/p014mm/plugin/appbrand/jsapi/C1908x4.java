...
/* renamed from: com.tencent.mm.plugin.appbrand.jsapi.x4 */
public class C1908x4 extends C82268c<C82554k> {
    public static final int CTRL_INDEX = 619;
    public static final String NAME = "openWCPayLQTDepositPlanAdd";

    /* renamed from: g */
    public final int f11762g = C87687a.m109085a(this);
    ...
    public void mo1505u(C82381f fVar, JSONObject jSONObject, int i) {
        ...
        if (R == null) {
            ...
            Log.m105920e("MicroMsg.JsApiOpenWCPayLQTDepositPlanAdd", "mmActivity is null, invoke fail!");
            return;
        }
        C89916g.m112446a(R).mo124232f(new C1888w4(this, R, kVar, i));
        AppBrandSysConfigWC e = C81682d.m100225e(kVar.getAppId());
        if (e == null) {
            kVar.mo109647a(i, mo115109j("fail"));
            Log.m105920e("MicroMsg.JsApiOpenWCPayLQTDepositPlanAdd", "sysConfig is null, invoke fail!");
            return;
        }
        AppBrandRuntimeWC b = C81682d.m100222b(kVar.getAppId());
        if (b == null) {
            kVar.mo109647a(i, mo115109j("fail"));
            Log.m105920e("MicroMsg.JsApiOpenWCPayLQTDepositPlanAdd", "runtime is null, invoke fail!");
            return;
        }
        Log.m105918d("MicroMsg.JsApiOpenWCPayLQTDepositPlanAdd", "do openWCPayLQTDepositPlan");
        ...
        if (TextUtils.isEmpty(optString)) {
            C88144b.m109795m(R, "wallet", ".ui.WalletJsApiAdapterUI", new Intent().putExtras(bundle), this.f11762g);
        } else if ("LQTFixedDepositAddPlan".equals(optString)) {
            ((C76324c) C86312j.m106911c(C76324c.class)).startLqtFixedDepositMakePlanUseCase(R, bundle);
            kVar.mo109647a(i, mo115109j("ok"));
        } else {
            kVar.mo109647a(i, mo115109j("fail:auth denied"));
            Log.m105920e("MicroMsg.JsApiOpenWCPayLQTDepositPlanAdd", "routURL auth failed!");
        }
    }
}
