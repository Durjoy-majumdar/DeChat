...
@Metadata(mo182092bv = {}, mo182093d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0003\b\u0007\u0018\u00002\u00020\u00012\u00020\u0002B\u001d\b\u0016\u0012\b\u0010\f\u001a\u0004\u0018\u00010\u000b\u0012\b\u0010\u000e\u001a\u0004\u0018\u00010\r¢\u0006\u0004\b\u000f\u0010\u0010B#\b\u0016\u0012\b\u0010\f\u001a\u0004\u0018\u00010\u000b\u0012\u0006\u0010\u000e\u001a\u00020\r\u0012\u0006\u0010\u0012\u001a\u00020\u0011¢\u0006\u0004\b\u000f\u0010\u0013R\u0014\u0010\u0006\u001a\u00020\u00038VX\u0004¢\u0006\u0006\u001a\u0004\b\u0004\u0010\u0005R\u0014\u0010\n\u001a\u00020\u00078VX\u0004¢\u0006\u0006\u001a\u0004\b\b\u0010\t¨\u0006\u0014"}, mo182094d2 = {"Lcom/tencent/mm/plugin/repairer/ui/demo/refresh/view/DemoHeader;", "Landroid/widget/LinearLayout;", "Loq3/d;", "Landroid/view/View;", "getView", "()Landroid/view/View;", "view", "Lrq3/c;", "getSpinnerStyle", "()Lrq3/c;", "spinnerStyle", "Landroid/content/Context;", "context", "Landroid/util/AttributeSet;", "attrs", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;)V", "", "defStyleAttr", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "ui-repairer_release"}, mo182095k = 1, mo182096mv = {1, 7, 1})
/* renamed from: com.tencent.mm.plugin.repairer.ui.demo.refresh.view.DemoHeader */
public final class DemoHeader extends LinearLayout implements C11723d {

    /* renamed from: d */
    public TextView f164032d;

    /* renamed from: e */
    public WeImageView f164033e;

    /* renamed from: f */
    public MMProcessBar f164034f;
    ...
    public void mo35206a(C110058f fVar, C22243b bVar, C22243b bVar2) {
        ...
        if (ordinal == 3 || ordinal == 5) {
            TextView textView = this.f164032d;
            if (textView != null) {
                textView.setText("下拉开始刷新");
                WeImageView weImageView = this.f164033e;
                if (weImageView != null) {
                    weImageView.setVisibility(0);
                    MMProcessBar mMProcessBar = this.f164034f;
                    if (mMProcessBar != null) {
                        mMProcessBar.setVisibility(8);
                        WeImageView weImageView2 = this.f164033e;
            ...
            TextView textView2 = this.f164032d;
            if (textView2 != null) {
                textView2.setText("正在刷新");
                MMProcessBar mMProcessBar2 = this.f164034f;
                if (mMProcessBar2 != null) {
                    mMProcessBar2.setVisibility(0);
                    WeImageView weImageView3 = this.f164033e;
            ...
            TextView textView3 = this.f164032d;
            if (textView3 != null) {
                textView3.setText("释放立即刷新");
                WeImageView weImageView4 = this.f164033e;
