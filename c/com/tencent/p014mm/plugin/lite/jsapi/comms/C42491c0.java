...
@Metadata(mo182092bv = {}, mo182093d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003¨\u0006\u0004"}, mo182094d2 = {"Lcom/tencent/mm/plugin/lite/jsapi/comms/c0;", "Lcom/tencent/mm/plugin/lite/api/c;", "<init>", "()V", "luggage-lite-app_release"}, mo182095k = 1, mo182096mv = {1, 7, 1})
/* renamed from: com.tencent.mm.plugin.lite.jsapi.comms.c0 */
public final class C42491c0 extends C4770c {

    /* renamed from: com.tencent.mm.plugin.lite.jsapi.comms.c0$a */
    public static final class C42492a implements C45699g {

        /* renamed from: a */
        public final /* synthetic */ C42491c0 f115025a;

        public C42492a(C42491c0 c0Var) {
            this.f115025a = c0Var;
        }
        ...
        public void mo66581b(int i, String str, C52278zk2 zk22) {
            ...
            Log.m105925i("LiteAppJsApiWebTransfer", "webTransfer errMsg: %s, response: %s", objArr);
            if (zk22 != null) {
                ...
                if (zk22.f146051d == 0) {
                    this.f115025a.f19815f.mo5691c(hashMap);
                } else {
                    this.f115025a.f19815f.mo5689a("webTransfer: fail");
                }
            } else {
                this.f115025a.f19815f.mo5689a("webTransfer: fail");
            }
    ...
    public void mo5693a(String str, JSONObject jSONObject, boolean z) {
        Log.m105918d("LiteAppJsApiWebTransfer", "Invoke webTransfer");
        if (jSONObject == null) {
        ...
        if (authUrl != null) {
            ...
            if (!(authUrl.length() == 0)) {
                ...
                transferRequestInfo.f109024d = 2;
                ...
                try {
                    ...
                    Log.printErrStackTrace("LiteAppJsApiWebTransfer", e, "parseTransferRequestInfo exception", new Object[0]);
                }
                ((C45698f) C86709a0.m107533q(C45698f.class)).mo71195RT(transferRequestInfo, new C42492a(this));
                return;
            }
        }
