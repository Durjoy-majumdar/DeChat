...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.actionbar_setting_white_icon */
public class actionbar_setting_white_icon extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        path.cubicTo(2.515075f, 19.485638f, 2.4406712f, 18.881248f, 2.7239738f, 18.409077f);
        instancePath.lineTo(4.0433826f, 16.210062f);
        path.cubicTo(3.7810543f, 15.715314f, 3.5635202f, 15.193173f, 3.3961856f, 14.649046f);
        ...
        path2.cubicTo(4.5143623f, 2.515075f, 5.118752f, 2.4406712f, 5.5909233f, 2.7239738f);
        instancePath.lineTo(7.789938f, 4.0433826f);
        path2.cubicTo(8.284686f, 3.7810543f, 8.806827f, 3.5635202f, 9.350954f, 3.3961856f);
        instancePath.lineTo(9.972761f, 0.90895724f);
        path2.cubicTo(10.106311f, 0.37475684f, 10.58629f, 0.0f, 11.136931f, 0.0f);
        instancePath.lineTo(12.863069f, 0.0f);
        path2.cubicTo(13.41371f, 0.0f, 13.893689f, 0.37475684f, 14.027239f, 0.90895724f);
        instancePath.lineTo(14.649046f, 3.3961856f);
        path2.cubicTo(15.193173f, 3.5635202f, 15.715314f, 3.7810543f, 16.210062f, 4.0433826f);
        instancePath.close();
        ...
        path3.cubicTo(13.988225f, 15.6f, 15.6f, 13.988225f, 15.6f, 12.0f);
        path3.cubicTo(15.6f, 10.011775f, 13.988225f, 8.4f, 12.0f, 8.4f);
        path3.cubicTo(10.011775f, 8.4f, 8.4f, 10.011775f, 8.4f, 12.0f);
        path3.cubicTo(8.4f, 13.988225f, 10.011775f, 15.6f, 12.0f, 15.6f);
        instancePath2.close();
        instancePath2.moveTo(12.0f, 17.04f);
        Path path4 = instancePath2;
        path4.cubicTo(9.216485f, 17.04f, 6.96f, 14.783515f, 6.96f, 12.0f);
        path4.cubicTo(6.96f, 9.216485f, 9.216485f, 6.96f, 12.0f, 6.96f);
        path4.cubicTo(14.783515f, 6.96f, 17.04f, 9.216485f, 17.04f, 12.0f);
        path4.cubicTo(17.04f, 14.783515f, 14.783515f, 17.04f, 12.0f, 17.04f);
        instancePath2.close();
