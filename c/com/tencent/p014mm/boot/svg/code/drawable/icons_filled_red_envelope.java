...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.icons_filled_red_envelope */
public class icons_filled_red_envelope extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        path.cubicTo(43.923f, 6.0f, 51.177f, 7.44f, 56.769f, 9.828f);
        path.cubicTo(57.585f, 10.1765f, 57.512928f, 10.151709f, 57.401466f, 10.1076f);
        instancePath2.lineTo(57.361877f, 10.091806f);
        Path path2 = instancePath2;
        path2.cubicTo(57.329823f, 10.078938f, 57.303f, 10.068f, 57.303f, 10.068f);
        path2.cubicTo(58.73436f, 10.78224f, 59.903065f, 12.610694f, 59.99427f, 14.223605f);
        ...
        path3.cubicTo(12.0f, 12.762f, 13.179f, 10.812f, 14.682f, 10.074f);
        path3.cubicTo(14.682f, 10.074f, 14.640351f, 10.091149f, 14.599076f, 10.10782f);
        ...
        path4.cubicTo(14.679822f, 10.066015f, 14.86513f, 9.9858265f, 15.213f, 9.837f);
        path4.cubicTo(20.808f, 7.443f, 28.068f, 6.0f, 36.0f, 6.0f);
        instancePath2.close();
        ...
        path5.cubicTo(44.453617f, 51.28014f, 40.40461f, 47.90353f, 37.748447f, 45.28473f);
        path5.cubicTo(37.076607f, 44.622337f, 36.507095f, 44.060837f, 35.99994f, 43.56081f);
        ...
        path6.cubicTo(17.7f, 32.63255f, 20.675318f, 29.7f, 24.332f, 29.7f);
        path6.cubicTo(26.055511f, 29.7f, 27.68117f, 30.356148f, 28.933542f, 31.538319f);
        instancePath2.lineTo(28.933542f, 31.538319f);
        instancePath2.lineTo(35.99987f, 38.505253f);
        Path path7 = instancePath2;
        path7.cubicTo(37.482452f, 37.043465f, 39.167496f, 35.382084f, 42.91675f, 31.685492f);
        path7.cubicTo(44.15682f, 30.425135f, 45.857647f, 29.7f, 47.66873f, 29.7f);
        path7.cubicTo(51.325356f, 29.7f, 54.3f, 32.632496f, 54.3f, 36.262592f);
        path7.cubicTo(54.3f, 37.32751f, 54.044193f, 38.33236f, 53.59038f, 39.220783f);
        instancePath2.lineTo(56.399f, 39.22f);
        instancePath2.lineTo(56.4f, 14.424f);
        path7.cubicTo(56.386364f, 14.134909f, 56.045456f, 13.560694f, 55.771713f, 13.3414755f);
        ...
        path8.cubicTo(22.65197f, 33.3f, 21.3f, 34.632534f, 21.3f, 36.262592f);
        path8.cubicTo(21.3f, 37.831722f, 22.55065f, 39.12451f, 24.1412f, 39.220867f);
        instancePath2.lineTo(31.59818f, 39.2208f);
        Path path9 = instancePath2;
        path9.cubicTo(30.392702f, 38.032185f, 28.828863f, 36.490204f, 26.434551f, 34.129356f);
        path9.cubicTo(25.873756f, 33.600266f, 25.129824f, 33.3f, 24.332f, 33.3f);
        instancePath2.close();
        ...
        path10.cubicTo(49.39077f, 39.12811f, 50.60669f, 37.926277f, 50.694874f, 36.436214f);
        instancePath2.lineTo(50.7f, 36.262592f);
        path10.cubicTo(50.7f, 34.63231f, 49.34854f, 33.3f, 47.66873f, 33.3f);
        instancePath2.close();
