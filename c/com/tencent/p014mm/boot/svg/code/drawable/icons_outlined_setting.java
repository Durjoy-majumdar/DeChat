...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.icons_outlined_setting */
public class icons_outlined_setting extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        path.cubicTo(53.720028f, 29.3022f, 53.265213f, 28.206543f, 52.71098f, 27.161264f);
        ...
        path.cubicTo(43.793457f, 18.734787f, 42.6978f, 18.279972f, 41.564423f, 17.931427f);
        ...
        path2.cubicTo(12.287687f, 54.714096f, 12.101678f, 53.20312f, 12.809935f, 52.022694f);
        instancePath.lineTo(16.108458f, 46.525154f);
        path2.cubicTo(15.452636f, 45.288284f, 14.9088f, 43.982933f, 14.490464f, 42.622616f);
        ...
        path3.cubicTo(17.285906f, 12.287687f, 18.79688f, 12.101678f, 19.977308f, 12.809935f);
        instancePath.lineTo(25.474846f, 16.108458f);
        path3.cubicTo(26.711716f, 15.452636f, 28.017067f, 14.9088f, 29.377384f, 14.490464f);
        instancePath.lineTo(30.931902f, 8.272393f);
        path3.cubicTo(31.265778f, 6.936892f, 32.465725f, 6.0f, 33.84233f, 6.0f);
        instancePath.lineTo(38.15767f, 6.0f);
        path3.cubicTo(39.534275f, 6.0f, 40.734222f, 6.936892f, 41.0681f, 8.272393f);
        instancePath.lineTo(42.622616f, 14.490464f);
        path3.cubicTo(43.982933f, 14.9088f, 45.288284f, 15.452636f, 46.525154f, 16.108458f);
        instancePath.close();
        instancePath.moveTo(36.0f, 44.4f);
        path3.cubicTo(40.63919f, 44.4f, 44.4f, 40.63919f, 44.4f, 36.0f);
        path3.cubicTo(44.4f, 31.360807f, 40.63919f, 27.6f, 36.0f, 27.6f);
        path3.cubicTo(31.360807f, 27.6f, 27.6f, 31.360807f, 27.6f, 36.0f);
        path3.cubicTo(27.6f, 40.63919f, 31.360807f, 44.4f, 36.0f, 44.4f);
        instancePath.close();
        instancePath.moveTo(36.0f, 48.0f);
        path3.cubicTo(29.372583f, 48.0f, 24.0f, 42.62742f, 24.0f, 36.0f);
        path3.cubicTo(24.0f, 29.372583f, 29.372583f, 24.0f, 36.0f, 24.0f);
        path3.cubicTo(42.62742f, 24.0f, 48.0f, 29.372583f, 48.0f, 36.0f);
