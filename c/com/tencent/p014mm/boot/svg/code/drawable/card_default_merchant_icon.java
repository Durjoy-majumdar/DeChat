...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.card_default_merchant_icon */
public class card_default_merchant_icon extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        path2.cubicTo(2.5478566f, 12.704954f, 4.371993f, 14.5f, 6.6153846f, 14.5f);
        path2.cubicTo(7.9268394f, 14.5f, 9.134812f, 13.882993f, 9.907946f, 12.853959f);
        instancePath3.lineTo(10.307693f, 12.321898f);
        instancePath3.lineTo(10.707439f, 12.853959f);
        Path path3 = instancePath3;
        path3.cubicTo(11.480572f, 13.882993f, 12.688545f, 14.5f, 14.0f, 14.5f);
        path3.cubicTo(15.311455f, 14.5f, 16.519428f, 13.882993f, 17.29256f, 12.853959f);
        instancePath3.lineTo(17.692308f, 12.321898f);
        instancePath3.lineTo(18.092054f, 12.853959f);
        Path path4 = instancePath3;
        path4.cubicTo(18.865187f, 13.882993f, 20.07316f, 14.5f, 21.384615f, 14.5f);
        path4.cubicTo(23.628008f, 14.5f, 25.452143f, 12.704954f, 25.499073f, 10.472813f);
        instancePath3.close();
