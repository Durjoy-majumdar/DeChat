...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.file_float_ball_icon_numbers */
public class file_float_ball_icon_numbers extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        float[] matrixFloatArray = C24542c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, 14.0f, 0.0f, 1.0f, 16.0f, 0.0f, 0.0f, 1.0f);
        ...
        path.cubicTo(3.7761424f, 12.0f, 4.0f, 12.223858f, 4.0f, 12.5f);
        instancePath2.lineTo(4.0f, 14.5f);
        path.cubicTo(4.0f, 14.776142f, 3.7761424f, 15.0f, 3.5f, 15.0f);
        instancePath2.lineTo(0.5f, 15.0f);
        path.cubicTo(0.22385761f, 15.0f, 0.0f, 14.776142f, 0.0f, 14.5f);
        ...
        path2.cubicTo(14.776142f, -5.072653E-17f, 15.0f, 0.22385763f, 15.0f, 0.5f);
        instancePath4.lineTo(15.0f, 14.5f);
        path2.cubicTo(15.0f, 14.776142f, 14.776142f, 15.0f, 14.5f, 15.0f);
        instancePath4.lineTo(11.5f, 15.0f);
        path2.cubicTo(11.223858f, 15.0f, 11.0f, 14.776142f, 11.0f, 14.5f);
        ...
        path3.cubicTo(20.276142f, 4.5f, 20.5f, 4.7238574f, 20.5f, 5.0f);
        instancePath6.lineTo(20.5f, 14.5f);
        path3.cubicTo(20.5f, 14.776142f, 20.276142f, 15.0f, 20.0f, 15.0f);
