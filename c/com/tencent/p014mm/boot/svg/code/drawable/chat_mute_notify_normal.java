...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.chat_mute_notify_normal */
public class chat_mute_notify_normal extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        if (i2 == 2) {
            ...
            path.cubicTo(27.0f, 10.33902f, 25.656855f, 9.0f, 24.0f, 9.0f);
            path.cubicTo(22.346518f, 9.0f, 21.0f, 10.343891f, 21.0f, 12.001665f);
            ...
            path2.cubicTo(8.099805f, 25.982077f, 8.268347f, 24.991888f, 8.528398f, 24.039469f);
            instancePath.lineTo(31.48893f, 47.0f);
            instancePath.lineTo(31.48893f, 47.0f);
            instancePath.close();
            instancePath.moveTo(29.0f, 49.0f);
            path2.cubicTo(29.0f, 51.761425f, 26.761423f, 54.0f, 24.0f, 54.0f);
            path2.cubicTo(21.238577f, 54.0f, 19.0f, 51.761425f, 19.0f, 49.0f);
