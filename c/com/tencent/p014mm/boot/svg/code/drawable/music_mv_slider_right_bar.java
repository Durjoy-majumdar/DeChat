...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.music_mv_slider_right_bar */
public class music_mv_slider_right_bar extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        canvas.save();
        float[] matrixFloatArray = C24542c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -301.0f, 0.0f, 1.0f, -680.0f, 0.0f, 0.0f, 1.0f);
        ...
        canvas.concat(instanceMatrix);
        canvas.save();
        float[] matrixFloatArray3 = C24542c.setMatrixFloatArray(matrixFloatArray2, 1.0f, 0.0f, 270.0f, 0.0f, 1.0f, 32.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
