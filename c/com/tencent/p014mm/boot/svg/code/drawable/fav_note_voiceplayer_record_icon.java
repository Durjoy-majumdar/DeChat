...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.fav_note_voiceplayer_record_icon */
public class fav_note_voiceplayer_record_icon extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        if (i2 == 2) {
            ...
            path.cubicTo(17.1f, 47.938183f, 25.56182f, 56.4f, 36.0f, 56.4f);
            path.cubicTo(46.438183f, 56.4f, 54.9f, 47.938183f, 54.9f, 37.5f);
            instancePath.lineTo(54.9f, 33.0f);
            instancePath.lineTo(58.5f, 33.0f);
            instancePath.lineTo(58.5f, 37.5f);
            Path path2 = instancePath;
            path2.cubicTo(58.5f, 49.320515f, 49.384804f, 59.012062f, 37.8f, 59.92905f);
            instancePath.close();
            instancePath.moveTo(22.5f, 19.5f);
            path2.cubicTo(22.5f, 12.044156f, 28.544155f, 6.0f, 36.0f, 6.0f);
            path2.cubicTo(43.455845f, 6.0f, 49.5f, 12.044156f, 49.5f, 19.5f);
