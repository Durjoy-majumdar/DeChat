...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.finder_ad_feedback_no_interesting */
public class finder_ad_feedback_no_interesting extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        if (i2 == 2) {
            ...
            canvas.save();
            float[] matrixFloatArray = C24542c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -197.0f, 0.0f, 1.0f, -242.0f, 0.0f, 0.0f, 1.0f);
            ...
            canvas.concat(instanceMatrix);
            canvas.save();
            float[] matrixFloatArray3 = C24542c.setMatrixFloatArray(matrixFloatArray2, 1.0f, 0.0f, 118.0f, 0.0f, 1.0f, 85.5f, 0.0f, 0.0f, 1.0f);
            instanceMatrix.reset();
            instanceMatrix.setValues(matrixFloatArray3);
            canvas.concat(instanceMatrix);
            canvas.save();
            float[] matrixFloatArray4 = C24542c.setMatrixFloatArray(matrixFloatArray3, 1.0f, 0.0f, 12.0f, 0.0f, 1.0f, 8.0f, 0.0f, 0.0f, 1.0f);
            instanceMatrix.reset();
            instanceMatrix.setValues(matrixFloatArray4);
            canvas.concat(instanceMatrix);
            canvas.save();
            float[] matrixFloatArray5 = C24542c.setMatrixFloatArray(matrixFloatArray4, 1.0f, 0.0f, 2.0f, 0.0f, 1.0f, 2.0f, 0.0f, 0.0f, 1.0f);
            instanceMatrix.reset();
            ...
            path.cubicTo(6.3596025f, 3.837565f, 8.1776495f, 4.1350493f, 9.412989f, 5.3703885f);
            path.cubicTo(9.565328f, 5.5227275f, 9.761746f, 5.712194f, 10.002245f, 5.938788f);
            path.cubicTo(10.242743f, 5.712194f, 10.439161f, 5.5227275f, 10.5915f, 5.3703885f);
            path.cubicTo(12.218685f, 3.7432039f, 14.856873f, 3.7432039f, 16.484056f, 5.3703885f);
            path.cubicTo(18.096106f, 6.982437f, 18.111101f, 9.586767f, 16.529043f, 11.217276f);
            ...
            path2.cubicTo(9.069329f, 6.4337497f, 8.866103f, 6.2377157f, 8.705882f, 6.077495f);
            path2.cubicTo(7.8722334f, 5.243847f, 6.6894197f, 4.9721713f, 5.6281943f, 5.262469f);
            instancePath.lineTo(13.348f, 12.983f);
            instancePath.lineTo(15.811353f, 10.520913f);
            Path path3 = instancePath;
            path3.cubicTo(17.014784f, 9.280626f, 17.000736f, 7.301281f, 15.77695f, 6.077495f);
            path3.cubicTo(14.54029f, 4.840835f, 12.535267f, 4.840835f, 11.298611f, 6.077495f);
            instancePath.close();
