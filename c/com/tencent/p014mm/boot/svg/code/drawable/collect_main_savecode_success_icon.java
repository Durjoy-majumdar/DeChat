...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.collect_main_savecode_success_icon */
public class collect_main_savecode_success_icon extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        if (!(i2 == 0 || i2 == 1)) {
            ...
            if (i2 == 2) {
                ...
                float[] matrixFloatArray = C24542c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -593.0f, 0.0f, 1.0f, -303.0f, 0.0f, 0.0f, 1.0f);
                instanceMatrix.reset();
                instanceMatrix.setValues(matrixFloatArray);
                canvas.concat(instanceMatrix);
                canvas.save();
                float[] matrixFloatArray2 = C24542c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 593.0f, 0.0f, 1.0f, 303.0f, 0.0f, 0.0f, 1.0f);
                instanceMatrix.reset();
