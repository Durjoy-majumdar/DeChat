...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.emoticonstore_manager_icon */
public class emoticonstore_manager_icon extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        path.cubicTo(12.287687f, 54.714096f, 12.101678f, 53.20312f, 12.809935f, 52.022694f);
        instancePath.lineTo(16.108458f, 46.525154f);
        path.cubicTo(15.452636f, 45.288284f, 14.9088f, 43.982933f, 14.490464f, 42.622616f);
        ...
        path2.cubicTo(17.285906f, 12.287687f, 18.79688f, 12.101678f, 19.977308f, 12.809935f);
        instancePath.lineTo(25.474846f, 16.108458f);
        path2.cubicTo(26.711716f, 15.452636f, 28.017067f, 14.9088f, 29.377384f, 14.490464f);
        instancePath.lineTo(30.931902f, 8.272393f);
        path2.cubicTo(31.265778f, 6.936892f, 32.465725f, 6.0f, 33.84233f, 6.0f);
        instancePath.lineTo(38.15767f, 6.0f);
        path2.cubicTo(39.534275f, 6.0f, 40.734222f, 6.936892f, 41.0681f, 8.272393f);
        instancePath.lineTo(42.622616f, 14.490464f);
        path2.cubicTo(43.982933f, 14.9088f, 45.288284f, 15.452636f, 46.525154f, 16.108458f);
        instancePath.close();
        ...
        path3.cubicTo(40.970562f, 45.0f, 45.0f, 40.970562f, 45.0f, 36.0f);
        path3.cubicTo(45.0f, 31.029438f, 40.970562f, 27.0f, 36.0f, 27.0f);
        path3.cubicTo(31.029438f, 27.0f, 27.0f, 31.029438f, 27.0f, 36.0f);
        path3.cubicTo(27.0f, 40.970562f, 31.029438f, 45.0f, 36.0f, 45.0f);
        instancePath2.close();
        instancePath2.moveTo(36.0f, 48.6f);
        Path path4 = instancePath2;
        path4.cubicTo(29.041212f, 48.6f, 23.4f, 42.958786f, 23.4f, 36.0f);
        path4.cubicTo(23.4f, 29.041212f, 29.041212f, 23.4f, 36.0f, 23.4f);
        path4.cubicTo(42.958786f, 23.4f, 48.6f, 29.041212f, 48.6f, 36.0f);
        path4.cubicTo(48.6f, 42.958786f, 42.958786f, 48.6f, 36.0f, 48.6f);
        instancePath2.close();
