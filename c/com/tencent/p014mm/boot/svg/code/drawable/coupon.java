...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.coupon */
public class coupon extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        path.cubicTo(28.594185f, 13.5f, 27.454546f, 14.619288f, 27.454546f, 16.0f);
        path.cubicTo(27.454546f, 17.325483f, 28.504837f, 18.410038f, 29.832636f, 18.494682f);
        ...
        path2.cubicTo(2.5969536f, 26.0f, 2.0f, 25.403046f, 2.0f, 24.666666f);
        instancePath.lineTo(2.0f, 18.5f);
        path2.cubicTo(3.4058158f, 18.5f, 4.5454545f, 17.380713f, 4.5454545f, 16.0f);
        path2.cubicTo(4.5454545f, 14.619288f, 3.4058158f, 13.5f, 2.0f, 13.5f);
        instancePath.lineTo(2.0f, 7.3333335f);
        path2.cubicTo(2.0f, 6.596954f, 2.5969536f, 6.0f, 3.3333333f, 6.0f);
