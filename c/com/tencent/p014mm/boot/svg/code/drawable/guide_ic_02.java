...
public class guide_ic_02 extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        float[] matrixFloatArray = C24542c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -183.0f, 0.0f, 1.0f, -610.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        instanceMatrix.setValues(matrixFloatArray);
        canvas.concat(instanceMatrix);
        canvas.save();
        float[] matrixFloatArray2 = C24542c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 183.0f, 0.0f, 1.0f, 610.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        ...
        path.cubicTo(34.59884f, 4.0f, 43.272083f, 12.244465f, 43.95649f, 22.670158f);
        path.cubicTo(43.443813f, 22.379799f, 42.86966f, 22.179312f, 42.25281f, 22.092056f);
        path.cubicTo(41.997177f, 22.055843f, 41.74153f, 22.020393f, 41.48588f, 21.985703f);
        path.cubicTo(40.48668f, 13.214191f, 33.03911f, 6.4f, 24.0f, 6.4f);
        path.cubicTo(14.960892f, 6.4f, 7.513323f, 13.214191f, 6.5139894f, 21.985878f);
        path.cubicTo(6.2583847f, 22.020416f, 6.002588f, 22.05589f, 5.746797f, 22.092123f);
        path.cubicTo(5.130222f, 22.17934f, 4.556295f, 22.379732f, 4.043912f, 22.669521f);
        path.cubicTo(4.72814f, 12.244254f, 13.401296f, 4.0f, 24.0f, 4.0f);
        instancePath2.close();
        ...
        path2.cubicTo(18.656855f, 15.0f, 20.0f, 16.343145f, 20.0f, 18.0f);
        path2.cubicTo(20.0f, 19.656855f, 18.656855f, 21.0f, 17.0f, 21.0f);
        path2.cubicTo(15.343145f, 21.0f, 14.0f, 19.656855f, 14.0f, 18.0f);
        path2.cubicTo(14.0f, 16.343145f, 15.343145f, 15.0f, 17.0f, 15.0f);
        instancePath3.close();
        ...
        path3.cubicTo(32.656853f, 15.0f, 34.0f, 16.343145f, 34.0f, 18.0f);
        path3.cubicTo(34.0f, 19.656855f, 32.656853f, 21.0f, 31.0f, 21.0f);
        path3.cubicTo(29.343145f, 21.0f, 28.0f, 19.656855f, 28.0f, 18.0f);
        path3.cubicTo(28.0f, 16.343145f, 29.343145f, 15.0f, 31.0f, 15.0f);
        instancePath4.close();
        ...
        path4.cubicTo(29.98352f, 23.2004f, 35.95872f, 23.6292f, 41.93432f, 24.4868f);
        path4.cubicTo(43.11712f, 24.6564f, 44.00312f, 25.654f, 44.01112f, 26.8484f);
        ...
        path5.cubicTo(43.48849f, 36.05823f, 42.639736f, 39.004368f, 40.49992f, 40.9f);
        path5.cubicTo(38.511284f, 42.661884f, 35.274467f, 43.424084f, 31.932251f, 43.752934f);
        ...
        path6.cubicTo(12.741291f, 43.424084f, 9.504373f, 42.661884f, 7.51552f, 40.9f);
        path6.cubicTo(5.175366f, 38.826653f, 4.3795094f, 35.496597f, 4.1195f, 31.980602f);
        ...
        path7.cubicTo(3.9998696f, 27.639965f, 4.001735f, 27.242f, 4.00432f, 26.8484f);
        path7.cubicTo(4.01232f, 25.654f, 4.89872f, 24.6564f, 6.08112f, 24.4868f);
        path7.cubicTo(12.05672f, 23.6292f, 18.03232f, 23.2004f, 24.00792f, 23.2f);
        instancePath5.close();
        ...
        path8.cubicTo(7.007239f, 36.051502f, 7.7657247f, 37.915207f, 9.106972f, 39.103535f);
        path8.cubicTo(9.777364f, 39.697422f, 10.660672f, 40.165997f, 11.784282f, 40.52894f);
        ...
        path9.cubicTo(37.354897f, 40.166f, 38.238148f, 39.697426f, 38.908463f, 39.103542f);
        path9.cubicTo(39.751118f, 38.357048f, 40.35506f, 37.3984f, 40.775383f, 36.08785f);
