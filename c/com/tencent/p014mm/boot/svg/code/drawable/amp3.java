...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.amp3 */
public class amp3 extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        float[] matrixFloatArray = C24542c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -166.0f, 0.0f, 1.0f, -50.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        instanceMatrix.setValues(matrixFloatArray);
        canvas.concat(instanceMatrix);
        canvas.save();
        float[] matrixFloatArray2 = C24542c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 166.66667f, 0.0f, 1.0f, 50.25f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
