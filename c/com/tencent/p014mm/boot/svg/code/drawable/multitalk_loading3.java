...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.multitalk_loading3 */
public class multitalk_loading3 extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        path3.cubicTo(114.62742f, 0.0f, 120.0f, 5.3725824f, 120.0f, 12.0f);
        path3.cubicTo(120.0f, 18.627419f, 114.62742f, 24.0f, 108.0f, 24.0f);
        path3.cubicTo(101.37258f, 24.0f, 96.0f, 18.627419f, 96.0f, 12.0f);
        path3.cubicTo(96.0f, 5.3725824f, 101.37258f, 0.0f, 108.0f, 0.0f);
        instancePath2.close();
        ...
        path4.cubicTo(66.62742f, 0.0f, 72.0f, 5.3725824f, 72.0f, 12.0f);
        path4.cubicTo(72.0f, 18.627419f, 66.62742f, 24.0f, 60.0f, 24.0f);
        path4.cubicTo(53.37258f, 24.0f, 48.0f, 18.627419f, 48.0f, 12.0f);
        path4.cubicTo(48.0f, 5.3725824f, 53.37258f, 0.0f, 60.0f, 0.0f);
        instancePath3.close();
        canvas.saveLayerAlpha((RectF) null, 76, 31);
        canvas.drawPath(instancePath3, C24542c.instancePaint(instancePaint7, looper));
        canvas.restore();
        C24542c.done(looper);
        return 0;
    }
