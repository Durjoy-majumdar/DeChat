...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.bottomsheet_icon_other_mode */
public class bottomsheet_icon_other_mode extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        canvas.save();
        float[] matrixFloatArray = C24542c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -108.0f, 0.0f, 1.0f, -698.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        instanceMatrix.setValues(matrixFloatArray);
        canvas.concat(instanceMatrix);
        canvas.save();
        float[] matrixFloatArray2 = C24542c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 96.0f, 0.0f, 1.0f, 686.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
