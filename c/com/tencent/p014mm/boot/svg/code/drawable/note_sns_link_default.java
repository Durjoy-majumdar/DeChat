...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.note_sns_link_default */
public class note_sns_link_default extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        path.cubicTo(88.20914f, 0.0f, 90.0f, 1.7908609f, 90.0f, 4.0f);
        instancePath.lineTo(90.0f, 86.0f);
        path.cubicTo(90.0f, 88.20914f, 88.20914f, 90.0f, 86.0f, 90.0f);
        instancePath.lineTo(4.0f, 90.0f);
        path.cubicTo(1.7908609f, 90.0f, 0.0f, 88.20914f, 0.0f, 86.0f);
        instancePath.lineTo(0.0f, 4.0f);
        instancePath.close();
        canvas.drawPath(instancePath, instancePaint4);
        canvas.restore();
        canvas.save();
        float[] matrixFloatArray = C24542c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, 25.0f, 0.0f, 1.0f, 23.0f, 0.0f, 0.0f, 1.0f);
