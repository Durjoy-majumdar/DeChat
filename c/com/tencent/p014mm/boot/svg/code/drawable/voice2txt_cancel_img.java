...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.voice2txt_cancel_img */
public class voice2txt_cancel_img extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        canvas.save();
        float[] matrixFloatArray = C24542c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, 13.333333f, 0.0f, 1.0f, 10.0f, 0.0f, 0.0f, 1.0f);
        ...
        path.cubicTo(47.71236f, 13.333333f, 56.666668f, 22.287638f, 56.666668f, 33.333332f);
        path.cubicTo(56.666668f, 44.37903f, 47.71236f, 53.333332f, 36.666668f, 53.333332f);
        instancePath.lineTo(0.0f, 53.333332f);
        instancePath.lineTo(0.0f, 46.666668f);
        instancePath.lineTo(36.666668f, 46.666668f);
        Path path2 = instancePath;
        path2.cubicTo(44.030464f, 46.666668f, 50.0f, 40.69713f, 50.0f, 33.333332f);
        path2.cubicTo(50.0f, 25.969536f, 44.030464f, 20.0f, 36.666668f, 20.0f);
