...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.icons_outlined_mv_making */
public class icons_outlined_mv_making extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        path.cubicTo(8.55228f, 15.717897f, 8.574191f, 15.800406f, 8.615849f, 15.873306f);
        path.cubicTo(8.739236f, 16.089235f, 9.004194f, 16.173649f, 9.227072f, 16.07646f);
        instancePath.lineTo(9.274119f, 16.052835f);
        instancePath.lineTo(14.573762f, 13.024468f);
        Path path2 = instancePath;
        path2.cubicTo(14.64856f, 12.981727f, 14.710548f, 12.919737f, 14.75329f, 12.844939f);
        path2.cubicTo(14.8766775f, 12.629011f, 14.814886f, 12.357883f, 14.618001f, 12.215209f);
        instancePath.lineTo(14.573762f, 12.186668f);
        instancePath.lineTo(9.274119f, 9.158301f);
        Path path3 = instancePath;
        path3.cubicTo(9.20122f, 9.116645f, 9.1187105f, 9.094733f, 9.034748f, 9.094733f);
        instancePath.close();
        instancePath.moveTo(18.947279f, 0.5f);
        path3.cubicTo(19.16529f, 0.5f, 19.342026f, 0.67673415f, 19.342026f, 0.8947468f);
        ...
        path4.cubicTo(14.078735f, 3.8347085f, 14.255469f, 3.6579742f, 14.473482f, 3.6579742f);
        instancePath.lineTo(17.236315f, 3.6579742f);
        instancePath.lineTo(17.23671f, 0.8947468f);
        path4.cubicTo(17.23671f, 0.67673415f, 17.413445f, 0.5f, 17.631456f, 0.5f);
