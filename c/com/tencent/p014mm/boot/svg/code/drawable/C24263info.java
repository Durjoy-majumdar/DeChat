...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.info */
public class C24263info extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        if (!(i2 == 0 || i2 == 1)) {
            ...
            if (i2 == 2) {
                ...
                canvas.saveLayerAlpha((RectF) null, 140, 31);
                canvas.save();
                Paint instancePaint3 = C24542c.instancePaint(instancePaint, looper);
                instancePaint3.setColor(-436207616);
                float[] matrixFloatArray = C24542c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, 1.333333f, 0.0f, 1.0f, 1.333333f, 0.0f, 0.0f, 1.0f);
