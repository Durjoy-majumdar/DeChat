...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.lucky_money_group_icon_new */
public class lucky_money_group_icon_new extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        canvas.save();
        float[] matrixFloatArray = C24542c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -301.0f, 0.0f, 1.0f, -363.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        instanceMatrix.setValues(matrixFloatArray);
        canvas.concat(instanceMatrix);
        canvas.save();
        float[] matrixFloatArray2 = C24542c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 301.0f, 0.0f, 1.0f, 363.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        ...
        path2.cubicTo(23.281897f, 36.21675f, 24.80723f, 34.54475f, 25.745895f, 32.374084f);
        path2.cubicTo(26.332563f, 30.907415f, 26.772562f, 29.147415f, 27.036562f, 27.064749f);
        ...
        path3.cubicTo(24.161896f, 28.355415f, 23.897896f, 29.499416f, 23.545897f, 30.526083f);
        path3.cubicTo(22.841896f, 32.315414f, 21.55123f, 33.811417f, 19.644562f, 34.98475f);
        ...
        path4.cubicTo(14.833896f, 34.134083f, 14.481895f, 34.486084f, 13.807229f, 34.486084f);
        path4.cubicTo(13.161896f, 34.486084f, 12.457896f, 34.427418f, 11.724563f, 34.339417f);
