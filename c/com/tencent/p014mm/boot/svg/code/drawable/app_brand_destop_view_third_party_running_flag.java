...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.app_brand_destop_view_third_party_running_flag */
public class app_brand_destop_view_third_party_running_flag extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        if (i2 == 2) {
            ...
            path2.cubicTo(2.4464633f, 0.055895973f, 2.0786471f, 0.092503406f, 1.6605703f, 0.22468384f);
            path2.cubicTo(0.98632014f, 0.4696597f, 0.4696597f, 0.98632014f, 0.23089007f, 1.6423111f);
            path2.cubicTo(0.09250536f, 2.0786412f, 0.055896156f, 2.4464912f, 0.05092412f, 3.1838257f);
            instancePath2.lineTo(0.05092412f, 6.8131676f);
            path2.cubicTo(0.05589582f, 7.5534883f, 0.09250185f, 7.9212832f, 0.22467782f, 8.339411f);
            path2.cubicTo(0.46967f, 9.013708f, 0.9863586f, 9.530372f, 1.6423639f, 9.769054f);
            ...
            path3.cubicTo(8.279243f, 9.793855f, 8.279243f, 9.793855f, 8.339471f, 9.7752285f);
            path3.cubicTo(9.013641f, 9.530372f, 9.53033f, 9.013708f, 9.76911f, 8.357689f);
            ...
            path4.cubicTo(1.544123f, 8.77559f, 1.2243915f, 8.4558735f, 1.07661f, 8.049861f);
            path4.cubicTo(0.9844553f, 7.756964f, 0.95531523f, 7.464182f, 0.9509139f, 6.810139f);
            instancePath2.lineTo(0.9509139f, 3.186854f);
            instancePath2.lineTo(0.9580066f, 2.8017626f);
            Path path5 = instancePath2;
            path5.cubicTo(0.9716862f, 2.4047616f, 1.0063163f, 2.1738431f, 1.0828161f, 1.9318798f);
            path5.cubicTo(1.2243903f, 1.5441298f, 1.5441298f, 1.2243903f, 1.9501388f, 1.07661f);
            path5.cubicTo(2.2429836f, 0.9844567f, 2.5357845f, 0.9553153f, 3.1898544f, 0.9509139f);
            instancePath2.close();
