...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.fix_tools_recover */
public class fix_tools_recover extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        path2.cubicTo(1.790861f, 120.0f, 2.705415E-16f, 118.20914f, 0.0f, 116.0f);
        path2.lineTo(0.0f, 4.0f);
        path2.cubicTo(-2.705415E-16f, 1.790861f, 1.790861f, 4.0581224E-16f, 4.0f, 0.0f);
        path2.lineTo(60.0f, 0.0f);
        path2.close();
        WeChatSVGRenderC2Java.setFillType(path2, 2);
        canvas.drawPath(path2, instancePaint7);
        canvas.restore();
        ...
        float[] matrixFloatArray2 = C24542c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 22.0f, 0.0f, 1.0f, 44.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        ...
        float[] matrixFloatArray3 = C24542c.setMatrixFloatArray(matrixFloatArray2, 0.70710677f, -0.70710677f, 22.135817f, 0.70710677f, 0.70710677f, -9.168955f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        ...
        float[] matrixFloatArray4 = C24542c.setMatrixFloatArray(matrixFloatArray3, 0.70710677f, -0.70710677f, 22.135817f, 0.70710677f, 0.70710677f, -9.168955f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        ...
        canvas.restore();
        canvas.save();
        Paint instancePaint13 = C24542c.instancePaint(instancePaint10, looper);
        ...
        path3.cubicTo(22.047419f, 39.172733f, 22.447042f, 39.172733f, 22.823547f, 38.93592f);
        path3.cubicTo(23.200052f, 38.69911f, 29.506357f, 35.127247f, 41.742462f, 28.220339f);
        canvas.drawPath(instancePath6, instancePaint13);
        canvas.restore();
        canvas.save();
        Paint instancePaint14 = C24542c.instancePaint(instancePaint10, looper);
        ...
        path4.cubicTo(22.521996f, 44.952393f, 22.921618f, 44.952393f, 23.298124f, 44.71558f);
        path4.cubicTo(23.67463f, 44.478767f, 29.980934f, 40.906906f, 42.217037f, 34.0f);
