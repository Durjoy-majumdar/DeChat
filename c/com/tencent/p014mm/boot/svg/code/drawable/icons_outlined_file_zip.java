...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.icons_outlined_file_zip */
public class icons_outlined_file_zip extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        if (i2 == 2) {
            ...
            instancePath.lineTo(39.6f, 9.599f);
            instancePath.lineTo(39.6f, 15.0f);
            instancePath.lineTo(36.0f, 15.0f);
            instancePath.lineTo(36.0f, 9.599f);
            ...
            instancePath.close();
            instancePath.moveTo(39.6f, 33.0f);
            instancePath.lineTo(39.6f, 46.2f);
            instancePath.lineTo(32.4f, 46.2f);
            instancePath.lineTo(32.4f, 39.0f);
            instancePath.lineTo(36.0f, 39.0f);
            instancePath.lineTo(36.0f, 33.0f);
            instancePath.lineTo(39.6f, 33.0f);
            instancePath.close();
            instancePath.moveTo(36.0f, 27.0f);
            instancePath.lineTo(36.0f, 33.0f);
            instancePath.lineTo(32.4f, 33.0f);
            instancePath.lineTo(32.4f, 27.0f);
            instancePath.lineTo(36.0f, 27.0f);
            instancePath.close();
            instancePath.moveTo(39.6f, 21.0f);
            instancePath.lineTo(39.6f, 27.0f);
            instancePath.lineTo(36.0f, 27.0f);
            instancePath.lineTo(36.0f, 21.0f);
            instancePath.lineTo(39.6f, 21.0f);
            instancePath.close();
            instancePath.moveTo(36.0f, 15.0f);
            instancePath.lineTo(36.0f, 21.0f);
            instancePath.lineTo(32.4f, 21.0f);
            instancePath.lineTo(32.4f, 15.0f);
            instancePath.lineTo(36.0f, 15.0f);
            instancePath.close();
