...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.fangda */
public class fangda extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        float[] matrixFloatArray = C24542c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, 17.0f, 0.0f, 1.0f, 15.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        instanceMatrix.setValues(matrixFloatArray);
        canvas.concat(instanceMatrix);
        canvas.save();
        Paint instancePaint4 = C24542c.instancePaint(paint, looper);
        float[] matrixFloatArray2 = C24542c.setMatrixFloatArray(matrixFloatArray, -6.123234E-17f, 1.0f, -23.840988f, 1.0f, 6.123234E-17f, 23.840988f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        ...
        float[] matrixFloatArray3 = C24542c.setMatrixFloatArray(matrixFloatArray2, 6.123234E-17f, -1.0f, 64.0f, 1.0f, 6.123234E-17f, -0.15901184f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        ...
        float[] matrixFloatArray4 = C24542c.setMatrixFloatArray(matrixFloatArray3, -6.123234E-17f, 1.0f, 0.15900993f, -1.0f, -6.123234E-17f, 16.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        ...
        float[] matrixFloatArray5 = C24542c.setMatrixFloatArray(matrixFloatArray4, 6.123234E-17f, -1.0f, 40.0f, -1.0f, -6.123234E-17f, 40.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
