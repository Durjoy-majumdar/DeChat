...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.lucky_money_mute_icon */
public class lucky_money_mute_icon extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        canvas.save();
        float[] matrixFloatArray = C24542c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -189.0f, 0.0f, 1.0f, -177.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        instanceMatrix.setValues(matrixFloatArray);
        canvas.concat(instanceMatrix);
        canvas.save();
        float[] matrixFloatArray2 = C24542c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 189.0f, 0.0f, 1.0f, 177.0f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        ...
        path2.cubicTo(20.475f, 7.525f, 21.525f, 7.525f, 22.225f, 8.225f);
        path2.cubicTo(22.536112f, 8.536111f, 22.70895f, 8.847222f, 22.743519f, 9.281241f);
        instancePath2.lineTo(22.75f, 9.45f);
        instancePath2.lineTo(22.749f, 19.037f);
        instancePath2.lineTo(27.7877f, 24.074669f);
        Path path3 = instancePath2;
        path3.cubicTo(28.266113f, 23.128498f, 28.525f, 22.064249f, 28.525f, 21.0f);
        path3.cubicTo(28.525f, 19.25f, 27.825f, 17.5f, 26.6f, 16.275f);
        instancePath2.lineTo(26.425f, 16.1f);
        instancePath2.lineTo(28.35f, 14.175f);
        instancePath2.lineTo(28.525f, 14.35f);
        Path path4 = instancePath2;
        path4.cubicTo(30.275f, 16.1f, 31.325f, 18.55f, 31.325f, 21.0f);
        path4.cubicTo(31.325f, 22.783064f, 30.76885f, 24.566128f, 29.791471f, 26.079357f);
        instancePath2.lineTo(31.39971f, 27.685888f);
        Path path5 = instancePath2;
        path5.cubicTo(32.77811f, 25.729305f, 33.425f, 23.472467f, 33.425f, 21.0f);
        path5.cubicTo(33.425f, 17.85f, 32.2f, 15.05f, 30.1f, 12.775f);
        ...
        path6.cubicTo(34.65f, 13.475f, 36.225f, 17.15f, 36.225f, 21.0f);
        path6.cubicTo(36.225f, 24.184946f, 35.2669f, 27.130367f, 33.3507f, 29.638115f);
        ...
        path7.cubicTo(22.75f, 33.6f, 22.05f, 34.3f, 21.0f, 34.3f);
        path7.cubicTo(20.533333f, 34.3f, 20.204939f, 34.161728f, 19.891907f, 33.885185f);
