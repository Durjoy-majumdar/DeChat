...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.icons_filled_invite_group */
public class icons_filled_invite_group extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        float[] matrixFloatArray = C24542c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, 0.75f, 0.0f, 1.0f, 6.0f, 0.0f, 0.0f, 1.0f);
        ...
        path.cubicTo(46.590694f, 28.90068f, 46.701355f, 30.679476f, 47.96614f, 31.816988f);
        path.cubicTo(46.732338f, 32.450726f, 45.588238f, 33.236454f, 44.559002f, 34.14886f);
        ...
        path2.cubicTo(39.934147f, 40.23719f, 39.0f, 43.259502f, 39.0f, 46.5f);
        path2.cubicTo(39.0f, 49.201084f, 39.649036f, 51.75058f, 40.79966f, 54.001038f);
        ...
        canvas.restore();
        canvas.save();
        float[] matrixFloatArray2 = C24542c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 40.5f, 0.0f, 1.0f, 31.5f, 0.0f, 0.0f, 1.0f);
        instanceMatrix.reset();
        ...
        path3.cubicTo(21.903559f, 2.5f, 27.5f, 8.09644f, 27.5f, 15.0f);
        path3.cubicTo(27.5f, 21.903559f, 21.903559f, 27.5f, 15.0f, 27.5f);
        path3.cubicTo(8.09644f, 27.5f, 2.5f, 21.903559f, 2.5f, 15.0f);
        path3.cubicTo(2.5f, 8.09644f, 8.09644f, 2.5f, 15.0f, 2.5f);
        instancePath4.close();
