...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.scan_no_network_error */
public class scan_no_network_error extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        if (i2 == 2) {
            ...
            canvas.save();
            float[] matrixFloatArray = C24542c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -279.0f, 0.0f, 1.0f, -275.0f, 0.0f, 0.0f, 1.0f);
            instanceMatrix.reset();
            instanceMatrix.setValues(matrixFloatArray);
            canvas.concat(instanceMatrix);
            canvas.save();
            float[] matrixFloatArray2 = C24542c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 279.0f, 0.0f, 1.0f, 275.0f, 0.0f, 0.0f, 1.0f);
            instanceMatrix.reset();
