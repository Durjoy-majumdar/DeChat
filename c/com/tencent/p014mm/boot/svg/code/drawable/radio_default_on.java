...
/* renamed from: com.tencent.mm.boot.svg.code.drawable.radio_default_on */
public class radio_default_on extends C24542c {
    ...
    public int doCommand(int i, Object... objArr) {
        ...
        if (!(i2 == 0 || i2 == 1)) {
            ...
            if (i2 == 2) {
                ...
                canvas.save();
                float[] matrixFloatArray = C24542c.setMatrixFloatArray(instanceMatrixArray, 1.0f, 0.0f, -392.0f, 0.0f, 1.0f, -141.0f, 0.0f, 0.0f, 1.0f);
                instanceMatrix.reset();
                instanceMatrix.setValues(matrixFloatArray);
                canvas.concat(instanceMatrix);
                canvas.save();
                float[] matrixFloatArray2 = C24542c.setMatrixFloatArray(matrixFloatArray, 1.0f, 0.0f, 392.0f, 0.0f, 1.0f, 141.0f, 0.0f, 0.0f, 1.0f);
                instanceMatrix.reset();
