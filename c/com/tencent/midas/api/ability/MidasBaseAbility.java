...
public abstract class MidasBaseAbility extends APMidasBaseRequest implements IMidasAbility {
    ...
    public void fromBundle(Bundle bundle) {
        ...
        this.f343434pf = bundle.getString("__midas_ability_baseReq__pf");
    ...
    public Bundle toBundle() {
        ...
        bundle.putString("__midas_ability_baseReq__pf", this.f343434pf);
    ...
    public String toString() {
        return "offerId=" + this.offerId + "|openKey=******|openKey=" + this.openKey + "|sessionId=" + this.sessionId + "|sessionType=" + this.sessionType + "|pf=" + this.f343434pf + "|pfKey=" + this.pfKey + "|configs=" + this.configs + "|postBack=" + this.postBack + "|others=" + this.others;
    }
}
