...
/* renamed from: com.tencent.liteav.videobase.videobase.i */
public enum C17271i {
    STATUS_VIDEO_NONE(0),
    ...
    STATUS_VIDEO_DECODER_HEIGHT(WearableStatusCodes.DATA_ITEM_TOO_LARGE),
    STATUS_VIDEO_DECODER_COST(WearableStatusCodes.INVALID_TARGET_NODE),
    STATUS_VIDEO_DECODER_CACHE(WearableStatusCodes.ASSET_UNAVAILABLE),
    STATUS_VIDEO_DECODER_CODEC(WearableStatusCodes.DUPLICATE_CAPABILITY),
    ...
    STATUS_VIDEO_DROP_FRAME(TXLiteAVCode.WARNING_IGNORE_UPSTREAM_FOR_AUDIENCE);
    

    /* renamed from: Y */
    private static final C17271i[] f46757Y = null;
    public int value;
