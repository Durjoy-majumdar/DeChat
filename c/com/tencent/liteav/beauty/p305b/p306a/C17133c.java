...
public final class C17133c extends C17203c {
    ...
    /* renamed from: a */
    public final void mo19417a(float f) {
        setFloatOnDraw(this.f46212d, f);
        setFloatOnDraw(this.f46209a, 0.3f * f * f);
    }

    /* renamed from: b */
    public final void mo19418b(float f) {
        setFloatOnDraw(this.f46214f, f);
    }

    /* renamed from: c */
    public final void mo19419c(float f) {
        setFloatOnDraw(this.f46213e, f);
    }

    public final void onInit(C17223e eVar) {
        super.onInit(eVar);
        this.f46210b = GLES20.glGetUniformLocation(getProgramId(), "texelWidthOffset");
        this.f46211c = GLES20.glGetUniformLocation(getProgramId(), "texelHeightOffset");
        this.f46212d = GLES20.glGetUniformLocation(getProgramId(), "blurStrength");
        this.f46209a = GLES20.glGetUniformLocation(getProgramId(), "sharpenStrength");
        this.f46213e = GLES20.glGetUniformLocation(getProgramId(), "ruddyStrength");
        this.f46214f = GLES20.glGetUniformLocation(getProgramId(), "whitenStrength");
    }

    public final void onOutputSizeChanged(int i, int i2) {
        super.onOutputSizeChanged(i, i2);
        setFloatOnDraw(this.f46210b, 1.0f / ((float) i));
        setFloatOnDraw(this.f46211c, 1.0f / ((float) i2));
    }
}
