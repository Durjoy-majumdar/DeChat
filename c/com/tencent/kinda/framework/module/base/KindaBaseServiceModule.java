...
import com.tencent.kinda.framework.app.KHKOfflinePayServiceImpl;
...
import com.tencent.kinda.framework.app.KindaPayMenuRedDotHelper;
...
import com.tencent.kinda.framework.module.impl.KindaHoneyPayService;
...
import com.tencent.p014mm.plugin.luckymoney.p073ui.C42537b;

public class KindaBaseServiceModule extends KindaModule {
    public void configModule() {
        Class<PlatformUIRouterImpl> cls = PlatformUIRouterImpl.class;
        ...
        registerNativeModule("KPlatformUIRouter", cls);
        ...
        registerNativeModule("KUserService", C42537b.class);
        registerNativeModule("kPayMenuRedDotHelper", KindaPayMenuRedDotHelper.class);
        ...
        registerNativeModule("KHKOfflinePayService", KHKOfflinePayServiceImpl.class);
        ...
        registerNativeModule("KHoneyPayService", KindaHoneyPayService.class);
        registerNativeModule("KHKFingerPrintService", KindaHKFingerprintImpl.class);
    }
