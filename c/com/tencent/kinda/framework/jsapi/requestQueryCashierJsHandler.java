    ...
    public void handle(final KindaJSInvokeEvent kindaJSInvokeEvent) {
        ...
        kindaJSEvent.setDelegate(new KindaJSEvent.KindaJsEventDelegate() {
            ...
            public void kindaEndWithResult(String str, HashMap<String, String> hashMap) {
                Log.m105925i(requestQueryCashierJsHandler.TAG, "callback: %s", str);
                KindaJSInvokeEvent.C24258b bVar = kindaJSInvokeEvent.f69427e;
                if (bVar.f69432a == null) {
                    bVar.f69432a = new Bundle();
                }
            ...
            public KindaJSEventType kindaGetType() {
                return kindaJSInvokeEvent.f69426d.f69428a == 1 ? KindaJSEventType.TINYAPP : KindaJSEventType.WEB;
            }
        });
        ITransmitKvData create = ITransmitKvData.create();
        create.putJSEvent("jsEvent", kindaJSEvent);
        create.putString("notifyType", kindaJSInvokeEvent.f69426d.f69429b.getString("notifyType"));
        create.putString("appId", kindaJSInvokeEvent.f69426d.f69429b.getString("appId"));
        create.putString("nonceStr", kindaJSInvokeEvent.f69426d.f69429b.getString("nonceStr"));
        ...
        Log.m105925i(TAG, "data: %s", kindaJSInvokeEvent.f69426d.f69429b.toString());
        KindaApp.appKinda().notifyAllUseCases(create);
        KindaJSInvokeEvent.C24258b bVar = kindaJSInvokeEvent.f69427e;
        if (bVar.f69432a == null) {
            bVar.f69432a = new Bundle();
        }
        kindaJSInvokeEvent.f69427e.f69432a.putString("ret", "fail");
        kindaJSInvokeEvent.f69426d.f69431d.run();
    }
