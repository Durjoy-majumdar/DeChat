...
public enum OfflinePayTsmServicesProvider implements C38174i<OfflinePayTsmServices> {
    INSTANCE;
    ...
    private OfflinePayTsmServices create() {
        return new OfflinePayTsmServices();
    }
    ...
    public String toString() {
        return "provider " + OfflinePayTsmServices.class.getName();
    }

    public OfflinePayTsmServices get() {
        Object obj = this.mInstance;
        Object obj2 = C38174i.f100844M0;
        if (obj == obj2) {
            synchronized (this) {
        ...
        return (OfflinePayTsmServices) obj;
    }
}
