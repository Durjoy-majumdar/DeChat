...
public enum WxCrossServicesProvider implements C38174i<WxCrossServices> {
    INSTANCE;
    ...
    private WxCrossServices create() {
        return new WxCrossServices();
    }
    ...
    public String toString() {
        return "provider " + WxCrossServices.class.getName();
    }

    public WxCrossServices get() {
        Object obj = this.mInstance;
        Object obj2 = C38174i.f100844M0;
        if (obj == obj2) {
            synchronized (this) {
