...
public final class CameraUpdateFactory {
    ...
    public static CameraUpdate newLatLngBounds(LatLngBounds latLngBounds, int i, int i2, int i3, int i4) {
        ...
        cameraParameter.newLatLngBounds_dimension_bounds = latLngBounds;
        cameraParameter.newLatLngBoundsRects_padLeft = i;
        cameraParameter.newLatLngBoundsRects_padRight = i2;
        cameraParameter.newLatLngBoundsRects_padTop = i3;
        cameraParameter.newLatLngBoundsRects_padBom = i4;
        return new CameraUpdate(cameraParameter);
    }
}
