...
import com.tencent.mapsdk.internal.C114331t;
...
public class MapView extends BaseMapView {
    ...
    static {
        System.loadLibrary(C114207sl.f341929a);
    }
    ...
    private <T extends TencentMap> void getMapSync(TencentMapOptions tencentMapOptions, final Callback<T> callback) {
        tencentMapOptions.setGetMapAsync(new Callback<TencentMap>() {
            /* renamed from: a */
            private void m164004a(final TencentMap tencentMap) {
                tencentMap.addOnMapLoadedCallback(new TencentMap.OnMapLoadedCallback() {
                    public final void onMapLoaded() {
                        ...
                        r2.removeOnMapLoadedCallback(this);
                    }
                });
            }

            public final /* synthetic */ void callback(Object obj) {
                final TencentMap tencentMap = (TencentMap) obj;
                tencentMap.addOnMapLoadedCallback(new TencentMap.OnMapLoadedCallback() {
                    public final void onMapLoaded() {
                        Callback callback = callback;
                        if (callback != null) {
    ...
    private void initMap(TencentMapOptions tencentMapOptions) {
        ...
        if (this.mMap == null || ((tencentMapOptions2 = this.mMapOptions) != tencentMapOptions && !tencentMapOptions2.equals(tencentMapOptions))) {
            ...
            if (this.mMapDelegate == null) {
                C114331t tVar = new C114331t(getContext().getApplicationContext());
                if (mapAsyncCallback != null) {
                    C1163621 r2 = new Callback<BaseMapView.MapViewProxy>() {
                        /* renamed from: a */
                        private void m164003a(BaseMapView.MapViewProxy mapViewProxy) {
                    ...
                    new Thread(new Runnable(tVar.f342625a, tVar.mo172992a(tencentMapOptions), new Handler(Looper.getMainLooper()), new Callback<Void>(this, tencentMapOptions, r2) {
                        /* renamed from: a */
                        private void m160295a(
/*
Method generation error in method: com.tencent.mapsdk.internal.t.1.a():void, dex: classes9.dex
                        jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.tencent.mapsdk.internal.t.1.a():void, class status: UNLOADED
...
/*
Method generation error in method: com.tencent.mapsdk.internal.t.1.callback(java.lang.Object):void, dex: classes9.dex
                        jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.tencent.mapsdk.internal.t.1.callback(java.lang.Object):void, class status: UNLOADED
                        	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                        	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                        	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                        	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
/*
Method generation error in method: com.tencent.mapsdk.internal.u.4.run():void, dex: classes9.dex
                        jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.tencent.mapsdk.internal.u.4.run():void, class status: UNLOADED
                        	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                        	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                        	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
                        	at jadx.core.codegen.ClassGen.addMethod(ClassGen.java:271)
...
*/
                    ...
                    this.mMapDelegate = tVar.mo172990a(this, tencentMapOptions);
                }
            }
