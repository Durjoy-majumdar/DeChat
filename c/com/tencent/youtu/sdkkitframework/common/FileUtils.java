...
public class FileUtils {
    ...
    public static void copyFileOrDir(AssetManager assetManager, String str, String str2) {
        ...
        try {
            ...
            YtLogger.m106579e("tag", "I/O Exception" + e);
        }
    }
    ...
    public static void loadLibrary(String str) {
        if (mLoadedLibrary.get(str) == null) {
            String str2 = TAG;
            YtLogger.m106580i(str2, "[YTUtils.loadLibrary] " + System.getProperty("java.library.path"));
            try {
                System.loadLibrary(str);
            } catch (Exception e) {
                String str3 = TAG;
                YtLogger.m106579e(str3, "Load " + str + " failed:" + e.getLocalizedMessage());
            }
