...
/* renamed from: com.tencent.mapsdk.internal.mx */
public class C113976mx extends AggregationOverlayInfo implements C113973mu {

    /* renamed from: a */
    public AggregationOverlayProvider f340969a;

    public C113976mx(VectorHeatOverlayOptions vectorHeatOverlayOptions) {
    ...
    /* renamed from: a */
    private AggregationOverlayProvider m158257a() {
        return this.f340969a;
    }

    public C113976mx(AggregationOverlayProvider aggregationOverlayProvider) {
        this.f340969a = aggregationOverlayProvider;
