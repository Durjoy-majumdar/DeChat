...
public class JNI {
    ...
    public void initCallback(C114007oa oaVar, C114371w wVar, C114013og ogVar, C114012of ofVar, C114018oo ooVar, C114014ok okVar, C114017on onVar, C113569br brVar, C114019op opVar, C114016om omVar, C114010od odVar) {
        JNICallback jNICallback = new JNICallback(oaVar, wVar, ogVar, ofVar, ooVar, okVar, onVar, brVar, opVar, omVar, odVar);
    ...
    public int nativeCreateOrUpdateLine(long j, int i, int[] iArr, int[] iArr2, GeoPoint[] geoPointArr, String str, float f, int i2, boolean z, boolean z2, boolean z3, boolean z4, float f2, boolean z5, int[] iArr3, int[] iArr4, float f3, int[] iArr5, float f4, int i3, boolean z6) {
        C113889km.m157545b(C0949kl.f2236f, "create or update line = " + i + " p:" + geoPointArr.length + " w:" + f + " v:" + z6 + " a:" + f4 + " bw:" + f3);
    ...
    public void nativeDeletePolygon(long j, int i, int i2, int[] iArr) {
        this.mJNIInterface.nativeDeletePolygon(j, i, i2, iArr);
    }
    ...
    public void nativeFromMapSight(long j, double[] dArr) {
        this.mJNIInterface.nativeFromMapSight(j, dArr);
    }
    ...
    public int nativeGetCurrentMaterialVariant(long j, long j2) {
        return this.mJNIInterface.nativeGetCurrentMaterialVariant(j, j2);
    }
    ...
    public String[] nativeGetVariantNames(long j, long j2) {
        return this.mJNIInterface.nativeGetVariantNames(j, j2);
    }
    ...
    public void nativeRemovePolygon(long j, int i, int i2, int[] iArr) {
        this.mJNIInterface.nativeDeletePolygon(j, i, i2, iArr);
    }
    ...
    public void nativeResetMonoColor(long j, long j2) {
        this.mJNIInterface.nativeResetMonoColor(j, j2);
    }
    ...
    public void nativeSetIndoorBuildingStyle(long j, int i) {
        C113889km.m157545b(C0949kl.f2236f, "nativeSetIndoorBuildingStyle:".concat(String.valueOf(i)));
    ...
    public void nativeSetMaterialVariant(long j, long j2, int i) {
        this.mJNIInterface.nativeSetMaterialVariant(j, j2, i);
    }
    ...
    public void nativeSetMonoColor(long j, long j2, float f, float f2, float f3) {
        this.mJNIInterface.nativeSetMonoColor(j, j2, f, f2, f3);
    }
    ...
    public void nativeSetPolygonHidden(long j, int i, int i2, boolean z, int[] iArr) {
        ...
        nativeSetIconsHidden(j, iArr2, iArr.length + 2, z);
    }
    ...
    public void nativeSetTrafficMode(long j, int i, int i2) {
        this.mJNIInterface.nativeSetTrafficMode(j, i, i2);
    }
    ...
    public void setMapCallbackGetGLContext(C114015ol olVar) {
        ...
        if (jNICallback != null) {
            jNICallback.setMapCallbackGetGLContext(olVar);
        }
    }
