...
public class v2helper {
    ...
    public static final int WXCONF_ERR_REMOTE_NOT_SUPPORT = 5;
    ...
    public static final int WXCONF_EVENT_AUTHKEY_EXPIRED = 27;
    public static final int WXCONF_EVENT_AVMEMBER_CHANGE = 21;
    public static final int WXCONF_EVENT_CALL_BROKEN = 24;
    public static final int WXCONF_EVENT_CALL_END = 26;
    public static final int WXCONF_EVENT_CALL_WORDING = 25;
    ...
    public static final int WXCONF_EVENT_NETWORK_POOR = 33;
    public static final int WXCONF_EVENT_RECV_CMDMSG = 29;
    ...
    public static final int WXCONF_EVENT_SEND_REQUEST = 34;
    public static final int WXCONF_EVENT_SOCKET_BINDTO_NETWORK = 28;
    public static final int WXCONF_EVENT_START_PUBLISH_RET = 30;
    public static final int WXCONF_EVENT_STOP_PUBLISH_RET = 31;
    public static final int WXCONF_EVENT_SWITCHAV_FAIL = 32;
    ...
    public static BufferedOutputStream mOutputStream = null;

    static {
        int i = true & true ? 16000 : 8000;
        VOICE_SAMPLERATE = i;
    ...
    public static void Logd(String str, String str2) {
        ...
        writeLogToFile(str + XVFSFile.PATH_SEPARATOR + str2 + " \n");
    }
    ...
    public static void closeLogFile() {
        BufferedOutputStream bufferedOutputStream = mOutputStream;
