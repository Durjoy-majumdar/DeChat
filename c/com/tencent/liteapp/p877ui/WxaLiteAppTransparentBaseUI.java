...
public class WxaLiteAppTransparentBaseUI extends AppCompatActivity implements C116506a.C116510d, C118708b {

    /* renamed from: d */
    public String f339353d;

    /* renamed from: e */
    public C116506a f339354e;

    /* renamed from: f */
    public WxaLiteAppInfo f339355f;

    /* renamed from: g */
    public boolean f339356g = false;

    /* renamed from: h */
    public boolean f339357h = false;

    /* renamed from: i */
    public View f339358i;

    /* renamed from: j */
    public LiteAppCenter.PageInfo f339359j;

    /* renamed from: n */
    public ProgressBar f339360n;

    /* renamed from: o */
    public int f339361o;

    /* renamed from: com.tencent.liteapp.ui.WxaLiteAppTransparentBaseUI$a */
    public class C113408a implements Runnable {
        public C113408a() {
        }

        public void run() {
            WxaLiteAppTransparentBaseUI wxaLiteAppTransparentBaseUI = WxaLiteAppTransparentBaseUI.this;
            if (!wxaLiteAppTransparentBaseUI.f339356g) {
                wxaLiteAppTransparentBaseUI.f339360n.setVisibility(0);
            }
        }
    }
    ...
    public View mo169865G7() {
        ...
        frameLayout.addView(this.f339354e.mo180442f((LayoutInflater) null, (ViewGroup) null, (Bundle) null), new FrameLayout.LayoutParams(-1, -1));
        this.f339360n = new ProgressBar(this);
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(32, 32);
        layoutParams.gravity = 17;
        frameLayout.addView(this.f339360n, layoutParams);
        this.f339360n.setIndeterminate(true);
        this.f339360n.setLayoutParams(new FrameLayout.LayoutParams(-1, -2, 17));
        this.f339360n.setVisibility(4);
        new Handler(getMainLooper()).postDelayed(new C113408a(), 200);
        return frameLayout;
    }

    /* renamed from: H7 */
    public void mo169866H7() {
    ...
    public String getFlutterViewId() {
        ...
        if (TextUtils.isEmpty(this.f339353d)) {
            this.f339353d = String.format("%d-%d", new Object[]{Long.valueOf(System.currentTimeMillis()), Integer.valueOf(hashCode())});
        }
        return this.f339353d;
    }
    ...
    public void onActivityResult(int i, int i2, Intent intent) {
        this.f339354e.mo180439c(i, i2, intent);
    }

    public void onBackPressed() {
        this.f339354e.mo180441e(true);
    }
    ...
    public void onDestroy() {
        super.onDestroy();
        C116506a aVar = this.f339354e;
        if (aVar != null) {
            aVar.mo180443g();
            this.f339354e.mo180444h();
    ...
    public p172io.flutter.embedding.android.SplashScreen provideSplashScreen() {
        ...
        L_0x0053:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.liteapp.p877ui.WxaLiteAppTransparentBaseUI.provideSplashScreen():io.flutter.embedding.android.SplashScreen");
    }
