...
public class ShareIntentUtil {
    ...
    public static boolean getBooleanExtra(Intent intent, String str, boolean z) {
        ...
        try {
            ...
            ShareTinkerLog.m106531e(TAG, "getBooleanExtra exception:" + e.getMessage(), new Object[0]);
            return z;
        }
    }
    ...
    public static int getIntExtra(Intent intent, String str, int i) {
        ...
        try {
            ...
            ShareTinkerLog.m106531e(TAG, "getIntExtra exception:" + e.getMessage(), new Object[0]);
            return i;
        }
    }
    ...
    public static Serializable getSerializableExtra(Intent intent, String str) {
        ...
        try {
            ...
            ShareTinkerLog.m106531e(TAG, "getSerializableExtra exception:" + e.getMessage(), new Object[0]);
            return null;
        }
    }
    ...
    public static ArrayList<String> getStringArrayListExtra(Intent intent, String str) {
        ...
        try {
            ...
            ShareTinkerLog.m106531e(TAG, "getStringExtra exception:" + e.getMessage(), new Object[0]);
            return null;
        }
    }
