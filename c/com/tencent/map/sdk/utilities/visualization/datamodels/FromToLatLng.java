...
public class FromToLatLng implements Parcelable {
    public static final Parcelable.Creator<FromToLatLng> CREATOR = new Parcelable.Creator<FromToLatLng>() {
        /* renamed from: a */
        private static FromToLatLng m155374a(Parcel parcel) {
        ...
        /* renamed from: a */
        private static FromToLatLng[] m155375a(int i) {
            return new FromToLatLng[i];
        }
    };
