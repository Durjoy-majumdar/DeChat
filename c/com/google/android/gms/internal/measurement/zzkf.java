...
public final class zzkf extends zzaby<zzkf> {
    ...
    public final boolean equals(Object obj) {
        ...
        if (zzaca != null && !zzaca.isEmpty()) {
            return this.zzbww.equals(zzkf.zzbww);
        }
        zzaca zzaca2 = zzkf.zzbww;
    ...
    public final int hashCode() {
        zzki zzki = this.zzarv;
        int i = 0;
        int hashCode = -1033080261 + (zzki == null ? 0 : zzki.hashCode());
        zzkg zzkg = this.zzarw;
    ...
    public final int zza() {
        ...
        zzki zzki = this.zzarv;
        if (zzki != null) {
            zza += zzabw.zzb(1, (zzace) zzki);
        }
        zzkg zzkg = this.zzarw;
        if (zzkg != null) {
            zza += zzabw.zzb(2, (zzace) zzkg);
        }
        Boolean bool = this.zzarx;
        if (bool != null) {
            bool.booleanValue();
    ...
    public final void zza(zzabw zzabw) {
        zzki zzki = this.zzarv;
        if (zzki != null) {
            zzabw.zza(1, (zzace) zzki);
        }
        zzkg zzkg = this.zzarw;
        if (zzkg != null) {
            zzabw.zza(2, (zzace) zzkg);
        }
        Boolean bool = this.zzarx;
        if (bool != null) {
