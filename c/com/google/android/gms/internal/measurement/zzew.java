...
public final class zzew {
    ...
    public static zzex<String> zzagm = zzex.zzd("measurement.config.url_scheme", C113600ck.f339986i, C113600ck.f339986i);
    ...
    public static zzex<Long> zzahh = zzex.zzb("measurement.upload.refresh_blacklisted_config_interval", (long) FrequentLimiter.WEEK_MILLS, (long) FrequentLimiter.WEEK_MILLS);
    ...
    public static zzex<Long> zzaho = zzex.zzb("measurement.service_client.idle_disconnect_millis", (long) FocusMeteringAction.DEFAULT_AUTOCANCEL_DURATION, (long) FocusMeteringAction.DEFAULT_AUTOCANCEL_DURATION);
