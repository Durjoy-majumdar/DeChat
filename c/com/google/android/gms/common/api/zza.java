...
final class zza implements PendingResult.StatusListener {
    ...
    public final void onComplete(com.google.android.gms.common.api.Status r5) {
        /*
            ...
            monitor-enter(r0)
            com.google.android.gms.common.api.Batch r1 = r4.zzch     // Catch:{ all -> 0x0066 }
        ...
        L_0x0011:
            ...
            com.google.android.gms.common.api.Batch r5 = r4.zzch     // Catch:{ all -> 0x0066 }
            boolean unused = r5.zzcf = true     // Catch:{ all -> 0x0066 }
            goto L_0x0029
        L_0x001e:
            boolean r5 = r5.isSuccess()     // Catch:{ all -> 0x0066 }
            if (r5 != 0) goto L_0x0029
            com.google.android.gms.common.api.Batch r5 = r4.zzch     // Catch:{ all -> 0x0066 }
            boolean unused = r5.zzce = true     // Catch:{ all -> 0x0066 }
        L_0x0029:
            com.google.android.gms.common.api.Batch r5 = r4.zzch     // Catch:{ all -> 0x0066 }
            com.google.android.gms.common.api.Batch.zzb(r5)     // Catch:{ all -> 0x0066 }
            com.google.android.gms.common.api.Batch r5 = r4.zzch     // Catch:{ all -> 0x0066 }
            int r5 = r5.zzcd     // Catch:{ all -> 0x0066 }
            if (r5 != 0) goto L_0x0064
            com.google.android.gms.common.api.Batch r5 = r4.zzch     // Catch:{ all -> 0x0066 }
            boolean r5 = r5.zzcf     // Catch:{ all -> 0x0066 }
        ...
        L_0x0044:
            com.google.android.gms.common.api.Batch r5 = r4.zzch     // Catch:{ all -> 0x0066 }
            boolean r5 = r5.zzce     // Catch:{ all -> 0x0066 }
        ...
        L_0x0056:
            ...
            com.google.android.gms.common.api.PendingResult[] r3 = r1.zzcg     // Catch:{ all -> 0x0066 }
