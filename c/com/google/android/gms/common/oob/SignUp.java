...
public class SignUp {
    ...
    public static boolean isSignedUpBlocking(Context context, String str, String[] strArr) {
        return checkSignUpState(context, str, strArr, (AccountManagerCallback<Boolean>) null, (Handler) null).getResult().booleanValue();
    }

    public static Intent newSignUpIntent(String str) {
        return newSignUpIntent(str, (String) null);
    }
