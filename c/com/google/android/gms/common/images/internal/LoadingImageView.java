...
public final class LoadingImageView extends ImageView {
    ...
    public LoadingImageView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.zzqs = 0;
        this.zzqt = 1.0f;
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C104392R.styleable.LoadingImageView);
        this.zzqs = obtainStyledAttributes.getInt(C104392R.styleable.LoadingImageView_imageAspectRatioAdjust, 0);
        this.zzqt = obtainStyledAttributes.getFloat(C104392R.styleable.LoadingImageView_imageAspectRatio, 1.0f);
        setCircleCropEnabled(obtainStyledAttributes.getBoolean(C104392R.styleable.LoadingImageView_circleCrop, false));
    ...
    private final void zzc(boolean z) {
        ...
        if (onImageLoadedListener != null) {
            onImageLoadedListener.onImageLoaded(this.zzqn, (Drawable) null, z);
        }
    }
    ...
    public final void setTintColor(int i) {
        this.zzqq = i;
        setColorFilter(i != 0 ? ColorFilters.COLOR_FILTER_BW : null);
        invalidate();
    }
