...
public class Task implements ReflectedParcelable {
    ...
    public static abstract class Builder {
        ...
        public Set<Uri> zzau = Collections.emptySet();
        public zzl zzaw = zzl.zzao;
        ...
        public void checkConditions() {
            ...
            if (zzl != null) {
                ...
                if (zzh == 1 || zzh == 0) {
                    ...
                    sb5.append("Must provide a valid RetryPolicy: ");
                    sb5.append(zzh);
    ...
    public Task(Builder builder) {
        ...
        zzl zzl = builder.zzaw;
        this.zzaw = zzl == null ? zzl.zzao : zzl;
    }
