...
public class GoogleCloudMessaging {
    ...
    private final Map<String, Handler> zzae = Collections.synchronizedMap(new C111055b());
    ...
    private final synchronized String zzd(boolean z, String... strArr) {
        ...
        if (zzl == null) {
            ...
            if (zzl.contains(".gsf")) {
                bundle.putString("legacy.sender", sb4);
                return InstanceID.getInstance(this.zzk).getToken(sb4, "GCM", bundle);
            }
            bundle.putString("sender", sb4);
    ...
    public static void zze(Context context) {
        new StringBuilder(String.valueOf(context.getPackageName()).length() + 48);
    }
    ...
    private final synchronized void zzg() {
        PendingIntent pendingIntent = this.zzad;
