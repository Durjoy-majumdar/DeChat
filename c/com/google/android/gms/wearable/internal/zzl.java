...
public final class zzl extends AbstractSafeParcelable {
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj != null && zzl.class == obj.getClass()) {
            zzl zzl = (zzl) obj;
            if (this.f339186id != zzl.f339186id || this.zzbl != zzl.zzbl || this.zzbm != zzl.zzbm || this.zzbn != zzl.zzbn || this.zzbo != zzl.zzbo || !this.zzbf.equals(zzl.zzbf)) {
                return false;
            }
    ...
    public final int hashCode() {
        int hashCode = (((this.f339186id + 31) * 31) + this.zzbf.hashCode()) * 31;
        String str = this.zzbg;
        int i = 0;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        SafeParcelWriter.writeInt(parcel, 2, this.f339186id);
