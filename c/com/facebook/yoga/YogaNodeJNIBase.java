...
public abstract class YogaNodeJNIBase extends YogaNode implements Cloneable {
    ...
    public static /* synthetic */ class C169421 {
        ...
        static {
            ...
            L_0x0049:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.yoga.YogaNodeJNIBase.C169421.<clinit>():void");
        }
    }
    ...
    public float getLayoutBorder(YogaEdge yogaEdge) {
        ...
        int i3 = i2 - i;
        switch (C169421.$SwitchMap$com$facebook$yoga$YogaEdge[yogaEdge.ordinal()]) {
            case 1:
                return this.arr[i3];
            case 2:
