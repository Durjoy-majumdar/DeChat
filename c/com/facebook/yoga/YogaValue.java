...
public class YogaValue {
    ...
    public static /* synthetic */ class C169431 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.yoga.YogaValue.C169431.<clinit>():void");
        }
    }
    ...
    public String toString() {
        int i = C169431.$SwitchMap$com$facebook$yoga$YogaUnit[this.unit.ordinal()];
        if (i == 1) {
            return "undefined";
        }
        if (i == 2) {
