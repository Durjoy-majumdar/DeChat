...
/* renamed from: pp3.q */
public final class C77227q extends C87413o implements C32226l<C75057b1, C13598b0> {

    /* renamed from: d */
    public final /* synthetic */ MultiProcessMMKV f225337d;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C77227q(MultiProcessMMKV multiProcessMMKV) {
        super(1);
        this.f225337d = multiProcessMMKV;
    }
    ...
    public Object invoke(Object obj) {
        ...
        MultiProcessMMKV multiProcessMMKV = this.f225337d;
        try {
            Result.Companion companion = Result.Companion;
            String string = multiProcessMMKV.getString("finder_vfs_storage_config", str);
            if (string != null) {
                str = string;
            }
        ...
        Long valueOf2 = Long.valueOf(C75061i.C75062a.m90020a(b1Var, 3));
        ...
        b1Var.mo104650f(longValue, new C77221p(longValue2, longValue3));
