...
/* renamed from: pp3.u */
public final class C77252u extends C87413o implements C32226l<C75057b1, C13598b0> {

    /* renamed from: d */
    public final /* synthetic */ MultiProcessMMKV f225363d;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C77252u(MultiProcessMMKV multiProcessMMKV) {
        super(1);
        this.f225363d = multiProcessMMKV;
    }
    ...
    public Object invoke(Object obj) {
        ...
        MultiProcessMMKV multiProcessMMKV = this.f225363d;
        try {
            Result.Companion companion = Result.Companion;
            String string = multiProcessMMKV.getString("finder_live_vfs_storage_config", str);
            if (string != null) {
                str = string;
            }
        ...
        Long valueOf = Long.valueOf(C75061i.C75062a.m90021b(b1Var, 256));
        ...
        Long valueOf2 = Long.valueOf(C75061i.C75062a.m90020a(b1Var, 100000));
        ...
        b1Var.mo104649d(longValue, new C77246t(longValue3, longValue2));
