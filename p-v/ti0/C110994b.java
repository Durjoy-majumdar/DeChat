...
import com.tencent.p014mm.plugin.appbrand.canvas.action.arg.path.PathArcActionArg;
import js0.C88020k;
import org.json.JSONArray;

/* renamed from: ti0.b */
public class C110994b implements C110993a {
    /* renamed from: a */
    public boolean mo162678a(Path path, BasePathActionArg basePathActionArg) {
        ...
        mo162681c(path, pathArcActionArg.f311149e, pathArcActionArg.f311150f, pathArcActionArg.f311151g, pathArcActionArg.f311152h, pathArcActionArg.f311153i, pathArcActionArg.f311154j);
        return true;
    }
    ...
    public boolean mo162679b(Path path, JSONArray jSONArray) {
        ...
        mo162681c(path, C88020k.m109557h(jSONArray, 0), C88020k.m109557h(jSONArray, 1), C88020k.m109557h(jSONArray, 2), (float) jSONArray.optDouble(3), (float) jSONArray.optDouble(4), jSONArray.optBoolean(5));
        return true;
    }
    ...
    public final boolean mo162681c(android.graphics.Path r7, float r8, float r9, float r10, float r11, float r12, boolean r13) {
        /*
            r6 = this;
            float r0 = r8 - r10
            float r1 = r9 - r10
        ...
        L_0x0085:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: ti0.C110994b.mo162681c(android.graphics.Path, float, float, float, float, float, boolean):boolean");
    }
