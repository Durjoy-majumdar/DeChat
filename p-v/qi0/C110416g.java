...
/* renamed from: qi0.g */
public class C110416g implements C110408d {
    /* renamed from: a */
    public boolean mo161914a(C110229d dVar, Canvas canvas, DrawActionArg drawActionArg) {
        canvas.drawPath(C110997e.C110998a.f332436a.mo162684b((PathActionArgWrapper) drawActionArg), dVar.f329744a);
        return true;
    }

    /* renamed from: b */
    public boolean mo161915b(C110229d dVar, Canvas canvas, JSONArray jSONArray) {
        canvas.drawPath(C110997e.C110998a.f332436a.mo162685c(jSONArray), dVar.f329744a);
        return true;
    }
