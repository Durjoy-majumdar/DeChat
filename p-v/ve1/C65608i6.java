...
/* renamed from: ve1.i6 */
public final class C65608i6 extends C65600h5<C55026p1> {

    /* renamed from: g */
    public final String f188790g = "Finder.FinderMsgMentionedConvert";

    public C65608i6(int i) {
        super(C0966R.C0971layout.amg, i);
    }
    ...
    public void mo89664j(C60905o oVar, C55011a aVar, int i) {
        ...
        String str2 = p1Var.f154465d.field_content;
        C87412m.m108593f(str2, "item.finderMention.field_content");
        ((TextView) oVar.mo85812D(C0966R.C0970id.h1d)).setText(((C76979h) C86312j.m106911c(cls)).mo107057T1(context, C112551y.m153814n(str2, "@", "", false)));
