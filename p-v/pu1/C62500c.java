...
/* renamed from: pu1.c */
public final class C62500c extends C87413o implements C32226l<C60695a, C13598b0> {

    /* renamed from: d */
    public final /* synthetic */ C110251b f177542d;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C62500c(C110251b bVar) {
        super(1);
        this.f177542d = bVar;
    }
    ...
    public Object invoke(Object obj) {
        ...
        String str = this.f177542d.f329787f;
        Log.m105924i(str, "setInputContentInfo, size:[" + videoWidth + ", " + i + "], rotate:" + propertyLong);
        this.f177542d.f329790i.mo163264l(videoWidth, i, (int) propertyLong);
