...
/* renamed from: td2.b */
public class C77893b implements C101592a0 {

    /* renamed from: b */
    public static final String f226944b = C79147d.m95779a();

    /* renamed from: a */
    public String f226945a;

    public C77893b(String str) {
        this.f226945a = str;
    }

    /* renamed from: a */
    public String mo94817a() {
        return this.f226945a;
    }
    ...
    public android.graphics.Bitmap mo94819c(android.graphics.Bitmap r7, sf0.C101592a0.C77686a r8, java.lang.String r9) {
        /*
            ...
            goto L_0x0083
        L_0x0013:
            java.lang.String r2 = f226944b     // Catch:{ IOException -> 0x0075 }
        ...
        L_0x0083:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: td2.C77893b.mo94819c(android.graphics.Bitmap, sf0.a0$a, java.lang.String):android.graphics.Bitmap");
    }
    ...
    public String mo94827k() {
        String str = this.f226945a;
        if (Util.isNullOrNil(str)) {
            Log.m105928w("MicroMsg.WalletGetPicStrategy", "getStoragePath: but url is null");
            return null;
        }
        return String.format("%s/%s", new Object[]{f226944b, C90193h.m112878f(str.getBytes())});
    }
