...
public class C118563c {
    ...
    static {
        ...
        f354835c = strArr2;
        C118563c cVar = new C118563c();
        cVar.mo183327a(strArr);
        cVar.mo183327a(new String[][]{new String[]{"apos", "39"}});
        f354837e = cVar;
        C118563c cVar2 = new C118563c();
        cVar2.mo183327a(strArr);
        cVar2.mo183327a(strArr2);
        m167231c(new C118563c());
    }

    /* renamed from: c */
    public static void m167231c(C118563c cVar) {
        cVar.mo183327a(f354834b);
        cVar.mo183327a(f354835c);
        cVar.mo183327a(f354836d);
    }

    /* renamed from: a */
    public void mo183327a(String[][] strArr) {
        ...
        while (i < strArr2.length) {
            ...
            C118565c cVar = (C118565c) this.f354838a;
            ((HashMap) cVar.f354839a).put(str, new Integer(parseInt));
            C118566d dVar = cVar.f354840b;
            C118566d.C118567a[] aVarArr = dVar.f354841a;
            int i2 = Integer.MAX_VALUE;
            int i3 = parseInt & Integer.MAX_VALUE;
            int length = i3 % aVarArr.length;
            C118566d.C118567a aVar = aVarArr[length];
            while (true) {
                if (aVar == null) {
                    if (dVar.f354842b >= dVar.f354843c) {
                        C118566d.C118567a[] aVarArr2 = dVar.f354841a;
                        int length2 = aVarArr2.length;
                        int i4 = (length2 * 2) + 1;
                        C118566d.C118567a[] aVarArr3 = new C118566d.C118567a[i4];
                        dVar.f354843c = (int) (((float) i4) * 0.75f);
                        dVar.f354841a = aVarArr3;
                        while (true) {
                            int i5 = length2 - 1;
                            if (length2 <= 0) {
                                break;
                            }
                            C118566d.C118567a aVar2 = aVarArr2[i5];
                            while (aVar2 != null) {
                                C118566d.C118567a aVar3 = aVar2.f354846c;
                                int i6 = (aVar2.f354844a & i2) % i4;
                                aVar2.f354846c = aVarArr3[i6];
                                aVarArr3[i6] = aVar2;
                                aVar2 = aVar3;
                        ...
                        aVarArr = dVar.f354841a;
                        length = i3 % aVarArr.length;
                    }
                    aVarArr[length] = new C118566d.C118567a(parseInt, parseInt, str, aVarArr[length]);
                    dVar.f354842b++;
                } else if (aVar.f354844a == parseInt) {
                    aVar.f354845b = str;
                    break;
                } else {
                    aVar = aVar.f354846c;
    ...
    public final void mo183328b(java.io.Writer r11, java.lang.String r12, int r13) {
        /*
            r10 = this;
            r0 = 0
        ...
        L_0x006c:
            goto L_0x0084
        L_0x006e:
            u24.c$a r2 = r10.f354838a
            u24.c$c r2 = (u24.C118563c.C118565c) r2
            java.util.Map r2 = r2.f354839a
        ...
        L_0x009c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: u24.C118563c.mo183328b(java.io.Writer, java.lang.String, int):void");
    }
}
