...
/* renamed from: ig.k */
public final class C98677k extends C101653b {
    /* renamed from: a */
    ...
    public void mo53856b(C64054c cVar, Map<String, String> map, String str, String str2) {
        ...
        if (cVar instanceof C98676j) {
            C98676j jVar = (C98676j) cVar;
            String f = jVar.mo141101f(str, str2);
            if (map.containsKey('.' + f + ".appmsg")) {
                C98671a aVar = new C98671a();
                jVar.mo141105m(aVar, map, "appmsg", f);
                jVar.mo138090B(aVar);
            }
        }
    }
    ...
    public C101650a mo53858d(C101650a aVar, String str, String str2, String str3) {
        ...
        return new C98678l(new C101656f(str), aVar.mo141101f(str2, str3));
    }
    ...
    public JSONObject mo53859e(C64054c cVar, boolean z) {
        ...
        C98676j jVar = (C98676j) cVar;
        jVar.mo141106n(jSONObject, "appmsg", jVar.mo138089A(), z);
        return jSONObject;
    }

    /* renamed from: f */
    public boolean mo53860f(C64054c cVar, C64054c cVar2) {
        if (!(cVar instanceof C98676j) || !(cVar2 instanceof C98676j)) {
            return false;
        }
        C98676j jVar = (C98676j) cVar;
        return jVar.mo141098c(jVar.mo138089A(), ((C98676j) cVar2).mo138089A());
    }
    ...
    public String mo53863i(C64054c cVar, boolean z, String str, String str2) {
        ...
        sb.append(">");
        C98676j jVar = (C98676j) cVar;
        jVar.mo141109q(sb, "appmsg", "", jVar.mo138089A(), z);
        sb.append("</" + str + '>');
