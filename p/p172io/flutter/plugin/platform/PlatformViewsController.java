...
public class PlatformViewsController implements PlatformViewsAccessibilityDelegate {
    ...
    private final PlatformViewsChannel.PlatformViewsHandler channelHandler = new PlatformViewsChannel.PlatformViewsHandler() {
        ...
        public void clearFocus(int i) {
            ...
            if (platformView == null) {
                Log.m165286e(PlatformViewsController.TAG, "Clearing focus on an unknown view with id: " + i);
                return;
            }
        ...
        public long createForTextureLayer(PlatformViewsChannel.PlatformViewCreationRequest platformViewCreationRequest) {
            ...
            if (PlatformViewsController.this.viewWrappers.get(i) != null) {
                ...
                if (factory != null) {
                    ...
                    int access$800 = PlatformViewsController.this.toPhysicalPixels(platformViewCreationRequest.logicalWidth);
                    int access$8002 = PlatformViewsController.this.toPhysicalPixels(platformViewCreationRequest.logicalHeight);
                    platformViewWrapper.setBufferSize(access$800, access$8002);
                    FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(access$800, access$8002);
                    int access$8003 = PlatformViewsController.this.toPhysicalPixels(platformViewCreationRequest.logicalTop);
                    int access$8004 = PlatformViewsController.this.toPhysicalPixels(platformViewCreationRequest.logicalLeft);
                    layoutParams.topMargin = access$8003;
                    layoutParams.leftMargin = access$8004;
                    ...
                    platformViewWrapper.setOnDescendantFocusChangeListener(new PlatformViewsController$1$$a(this, i));
        ...
        public void offset(int i, double d, double d2) {
            PlatformViewWrapper platformViewWrapper = (PlatformViewWrapper) PlatformViewsController.this.viewWrappers.get(i);
            if (platformViewWrapper == null) {
                Log.m165286e(PlatformViewsController.TAG, "Setting offset for unknown platform view with id: " + i);
                return;
            }
            int access$800 = PlatformViewsController.this.toPhysicalPixels(d);
            int access$8002 = PlatformViewsController.this.toPhysicalPixels(d2);
            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) platformViewWrapper.getLayoutParams();
            layoutParams.topMargin = access$800;
            layoutParams.leftMargin = access$8002;
            platformViewWrapper.setLayoutParams(layoutParams);
        }
        ...
        public void onTouch(PlatformViewsChannel.PlatformViewTouch platformViewTouch) {
            ...
            PlatformView platformView = (PlatformView) PlatformViewsController.this.platformViews.get(i);
            if (platformView == null) {
                Log.m165286e(PlatformViewsController.TAG, "Sending touch to an unknown view with id: " + i);
                return;
            }
        ...
        public PlatformViewsChannel.PlatformViewBufferSize resize(PlatformViewsChannel.PlatformViewResizeRequest platformViewResizeRequest) {
            ...
            PlatformViewWrapper platformViewWrapper = (PlatformViewWrapper) PlatformViewsController.this.viewWrappers.get(i);
            if (platformViewWrapper == null) {
                Log.m165286e(PlatformViewsController.TAG, "Resizing unknown platform view with id: " + i);
                return null;
            }
            int access$800 = PlatformViewsController.this.toPhysicalPixels(platformViewResizeRequest.newLogicalWidth);
            int access$8002 = PlatformViewsController.this.toPhysicalPixels(platformViewResizeRequest.newLogicalHeight);
            if (access$800 > platformViewWrapper.getBufferWidth() || access$8002 > platformViewWrapper.getBufferHeight()) {
                platformViewWrapper.setBufferSize(access$800, access$8002);
            }
            FrameLayout.LayoutParams layoutParams = (FrameLayout.LayoutParams) platformViewWrapper.getLayoutParams();
            layoutParams.width = access$800;
            layoutParams.height = access$8002;
            platformViewWrapper.setLayoutParams(layoutParams);
        ...
        public void setDirection(int i, int i2) {
            if (!PlatformViewsController.validateDirection(i2)) {
                ...
                Log.m165286e(PlatformViewsController.TAG, "Setting direction to an unknown view with id: " + i);
            } else {
                ensureValidAndroidVersion(20);
    ...
    private void finishFrame(boolean z) {
        ...
        for (int i2 = 0; i2 < this.platformViewParent.size(); i2++) {
            ...
            if (!this.currentFrameUsedPlatformViewIds.contains(Integer.valueOf(keyAt2)) || (!z && this.synchronizeToNativeViewHierarchy)) {
                ...
                aVar.mo10233c(8);
                View view2 = view;
                C117292a.m165358d(view2, aVar.mo10232b(), "io/flutter/plugin/platform/PlatformViewsController", "finishFrame", "(Z)V", "android/view/View_EXEC_", "setVisibility", "(I)V");
                view.setVisibility(((Integer) aVar.mo10231a(0)).intValue());
                C117292a.m165359e(view2, "io/flutter/plugin/platform/PlatformViewsController", "finishFrame", "(Z)V", "android/view/View_EXEC_", "setVisibility", "(I)V");
            } else {
                C9556a aVar2 = new C9556a();
                ThreadLocal<C9556a> threadLocal2 = C60958c.f173611a;
                aVar2.mo10233c(0);
                View view3 = view;
                C117292a.m165358d(view3, aVar2.mo10232b(), "io/flutter/plugin/platform/PlatformViewsController", "finishFrame", "(Z)V", "android/view/View_EXEC_", "setVisibility", "(I)V");
                view.setVisibility(((Integer) aVar2.mo10231a(0)).intValue());
                C117292a.m165359e(view3, "io/flutter/plugin/platform/PlatformViewsController", "finishFrame", "(Z)V", "android/view/View_EXEC_", "setVisibility", "(I)V");
            }
        }
    }
    ...
    public void initializePlatformViewIfNeeded(int i) {
        ...
        if (platformView == null) {
            ...
            if (platformView.getView() == null) {
                ...
                flutterMutatorView.setOnDescendantFocusChangeListener(new PlatformViewsController$$a(this, i));
    ...
    public void onEndFrame() {
        ...
        this.flutterViewConvertedToImageView = false;
        this.flutterView.revertImageView(new PlatformViewsController$$b(this));
    }
