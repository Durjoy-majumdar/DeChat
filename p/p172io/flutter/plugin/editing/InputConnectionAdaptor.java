...
class InputConnectionAdaptor extends BaseInputConnection implements ListenableEditingState.EditingStateWatcher {
    ...
    private static int clampIndexToEditable(int i, Editable editable) {
        ...
        if (max != i) {
            Log.m165284d("flutter", "Text selection index was clamped (" + i + "->" + max + ") to remain in bounds. This may not be your fault, as some keyboards may select outside of bounds.");
        }
        return max;
    }
    ...
    public boolean performEditorAction(int i) {
        if (i == 0) {
            ...
            this.textInputChannel.mo159190go(this.mClient);
        } else if (i == 3) {
