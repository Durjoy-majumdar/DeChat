...
/* renamed from: a0.e1 */
public final class C103140e1 extends C54172f1 implements C109852m0 {

    /* renamed from: e */
    public final C111294a.C37634c f304273e;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C103140e1(C111294a.C37634c cVar, C32226l<? super C103618e1, C13598b0> lVar) {
        super(lVar);
    ...
    public boolean equals(Object obj) {
        ...
        C103140e1 e1Var = obj instanceof C103140e1 ? (C103140e1) obj : null;
        if (e1Var == null) {
            return false;
        }
        return C87412m.m108589b(this.f304273e, e1Var.f304273e);
    }

    public int hashCode() {
        return this.f304273e.hashCode();
    }
    ...
    public Object mo142900j0(C108322d dVar, Object obj) {
        ...
        C111294a.C37634c cVar = this.f304273e;
        C87412m.m108594g(cVar, "vertical");
        r0Var.f304372c = new C103167m.C103173f(cVar);
        return r0Var;
    }

    public String toString() {
        return "VerticalAlignModifier(vertical=" + this.f304273e + ')';
    }
}
