...
/* renamed from: t0.t */
public final class C110870t<K, V> extends C110869s<K, V, V> {
    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C110870t(C110876x<K, V> xVar) {
        super(xVar);
    ...
    public boolean contains(Object obj) {
        return this.f331659d.containsValue(obj);
    }
    ...
    public boolean containsAll(Collection<? extends Object> collection) {
        ...
        while (it.hasNext()) {
            if (!this.f331659d.containsValue(it.next())) {
                return false;
            }
        }
        return true;
    ...
    public Iterator iterator() {
        ...
        return new C110848g0(xVar, ((C61177b) xVar.mo162570a().f331669c.entrySet()).iterator());
    }
    ...
    public boolean remove(Object obj) {
        ...
        while (true) {
            ...
            obj2 = it.next();
            if (C87412m.m108589b(((Map.Entry) obj2).getValue(), obj)) {
                break;
            }
        }
