...
/* renamed from: co.b */
public final class C80111b extends C80112c {
    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C80111b(C86764b bVar) {
        super(bVar);
    ...
    public void mo110351F(String str, MagicSclBrandReporter.PreloadScene preloadScene) {
        ...
        magicSclBrandReporter.mo112793d(str, MagicBrushConstants$BizNames.BIZ_NAME_MAGIC_BRAND_SERVICE, preloadScene, jVar != null ? jVar.f251539s : false);
    }
    ...
    public void mo110352G(String str, MagicSclBrandReporter.PreloadScene preloadScene) {
        ...
        MagicSclBrandReporter magicSclBrandReporter = MagicSclBrandReporter.f237836a;
        C86596j jVar = this.f234604j;
        magicSclBrandReporter.mo112794e(str, MagicBrushConstants$BizNames.BIZ_NAME_MAGIC_BRAND_SERVICE, preloadScene, jVar != null ? jVar.f251539s : false);
    }

    public void onDetachedFromEngine(FlutterPlugin.FlutterPluginBinding flutterPluginBinding) {
        C87412m.m108594g(flutterPluginBinding, "binding");
        super.onDetachedFromEngine(flutterPluginBinding);
        ((C86382i) C86312j.m106911c(C86382i.class)).mo120804O4(1);
        this.f234604j = null;
    }
}
