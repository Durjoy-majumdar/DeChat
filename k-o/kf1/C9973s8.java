...
/* renamed from: kf1.s8 */
public final class C9973s8 extends FinderLoaderFeedUIContract$Presenter {

    /* renamed from: t */
    public final int f30652t;

    /* renamed from: u */
    public final C55776r f30653u;

    /* renamed from: v */
    public final C8819z2 f30654v;

    /* renamed from: kf1.s8$a */
    public static final class C9974a extends C87413o implements C32226l<Integer, C0740i2> {

        /* renamed from: d */
        public final /* synthetic */ C9973s8 f30655d;

        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public C9974a(C9973s8 s8Var) {
            super(1);
            this.f30655d = s8Var;
        }
        ...
        public java.lang.Object invoke(java.lang.Object r3) {
            ...
            L_0x0032:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: kf1.C9973s8.C9974a.invoke(java.lang.Object):java.lang.Object");
        }
    }

    /* renamed from: kf1.s8$b */
    public static final class C9975b extends C87413o implements C32227p<Integer, Integer, LinkedList<C0740i2>> {

        /* renamed from: d */
        public final /* synthetic */ C9973s8 f30656d;

        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public C9975b(C9973s8 s8Var) {
            super(2);
            this.f30656d = s8Var;
        }

        public Object invoke(Object obj, Object obj2) {
            return ((C13887q1) C86312j.m106911c(C13887q1.class)).mo13316LA(this.f30656d.f13124s, ((Number) obj).intValue(), ((Number) obj2).intValue());
        }
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C9973s8(MMActivity mMActivity, int i) {
        super(mMActivity);
        C87412m.m108594g(mMActivity, "context");
        this.f30652t = i;
        C39818r rVar = C39818r.f106831a;
        this.f30653u = ((C13133c1) rVar.mo62444c(mMActivity).mo75002a(C13133c1.class)).f37371d;
        this.f30654v = ((C8817y2) rVar.mo62444c(mMActivity).mo62447c(C8817y2.class)).mo9643v2();
    }
    ...
    public void mo2547t1(BaseFinderFeedLoader baseFinderFeedLoader, C9854m5 m5Var) {
        ...
        this.f30653u.mo77389H1(this.f30652t, this.f29962e, new C9974a(this));
        C13442s8.C13443a aVar = C13442s8.f38060Q0;
        C13442s8 f = aVar.mo12873f(this.f29961d);
        if (!(f == null || (a2 = C60172g4.C60173a.m70189a(f, 0, 1, (Object) null)) == null)) {
            a2.mo83450a(this.f30653u);
        }
        C8819z2 z2Var = this.f30654v;
        C9975b bVar = new C9975b(this);
        C9707f fVar = this.f29964g;
        z2Var.mo9646T0(bVar, fVar != null ? fVar.getRecyclerView() : null);
        C13442s8 f2 = aVar.mo12873f(this.f29961d);
        if (f2 != null && (a = C60172g4.C60173a.m70189a(f2, 0, 1, (Object) null)) != null) {
            a.mo83450a(this.f30654v.mo9650n());
        }
    }
}
