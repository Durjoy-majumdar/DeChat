...
/* renamed from: kf1.z0 */
public final class C61078z0<_Ret, _Var> implements C87581a {

    /* renamed from: a */
    public final /* synthetic */ FinderCommentDrawerPresenter f173942a;

    /* renamed from: b */
    public final /* synthetic */ boolean f173943b;

    /* renamed from: c */
    public final /* synthetic */ long f173944c;

    /* renamed from: d */
    public final /* synthetic */ C14121l f173945d;

    public C61078z0(FinderCommentDrawerPresenter finderCommentDrawerPresenter, boolean z, long j, C14121l lVar) {
        this.f173942a = finderCommentDrawerPresenter;
        this.f173943b = z;
        this.f173944c = j;
        this.f173945d = lVar;
    }
    ...
    public Object call(Object obj) {
        ...
        C65468g gVar2 = this.f173942a.f158622n;
        if (gVar2 != null) {
            gVar2.mo89592q();
        }
        ...
        boolean z = true;
        if (!this.f173943b) {
            C65468g gVar3 = this.f173942a.f158622n;
            if (gVar3 != null) {
                gVar3.mo89591p().mo82442H(list != null ? list.size() : 0);
            }
        } else {
            FinderCommentDrawerPresenter finderCommentDrawerPresenter = this.f173942a;
        ...
        if (this.f173943b) {
            FinderCommentDrawerPresenter.m63415t(this.f173942a);
        }
        if (list == null || list.size() <= 0) {
            Log.m105924i("Finder.DrawerPresenter", "refresh header title...");
            this.f173942a.mo77321N0();
            if (this.f173943b) {
                C55772k kVar = this.f173942a.f158618g;
                kVar.f158793d.clear();
                ...
                C65468g gVar4 = this.f173942a.f158622n;
                if (!(gVar4 == null || (recyclerView = gVar4.mo89591p().getRecyclerView()) == null || (adapter = recyclerView.getAdapter()) == null)) {
                    adapter.notifyDataSetChanged();
                }
                if (booleanValue) {
                    C65468g gVar5 = this.f173942a.f158622n;
                    if (gVar5 != null) {
                        gVar5.mo89594s();
                    }
                } else {
                    FinderCommentDrawerPresenter finderCommentDrawerPresenter2 = this.f173942a;
                    C65468g gVar6 = finderCommentDrawerPresenter2.f158622n;
                    if (gVar6 != null) {
                        gVar6.mo89595t(new C61071y0(finderCommentDrawerPresenter2));
                    }
                }
            }
        } else {
            FinderCommentDrawerPresenter finderCommentDrawerPresenter3 = this.f173942a;
            if (finderCommentDrawerPresenter3.f158632x == 0) {
                ...
                C55772k kVar3 = this.f173942a.f158618g;
                kVar3.getClass();
                for (C55033u a : list) {
                    kVar3.mo77381a(a);
                }
                C65468g gVar7 = this.f173942a.f158622n;
                ...
                this.f173942a.f158618g.mo77382b(list, true, false);
                C65468g gVar8 = this.f173942a.f158622n;
                if (!(gVar8 == null || (recyclerView3 = gVar8.mo89591p().getRecyclerView()) == null || (adapter2 = recyclerView3.getAdapter()) == null)) {
                    adapter2.notifyItemRangeInserted(0, this.f173942a.f158618g.mo77387g() - g);
                }
                if (this.f173943b) {
                    FinderCommentDrawerPresenter finderCommentDrawerPresenter4 = this.f173942a;
                    ...
                    if (i >= 0) {
                        C55033u uVar = this.f173942a.f158618g.f158793d.get(i);
                        FinderCommentDrawerPresenter finderCommentDrawerPresenter5 = this.f173942a;
                        C55033u uVar2 = uVar;
                        ...
                        C65468g gVar10 = this.f173942a.f158622n;
                        ...
                        if (linearLayoutManager != null) {
                            ...
                            C117292a.m165358d(linearLayoutManager2, aVar.mo10232b(), "com/tencent/mm/plugin/finder/feed/FinderCommentDrawerPresenter$refreshFromGetFinderFeedComment$2", "call", "(Lkotlin/Pair;)V", "Undefined", "scrollToPositionWithOffset", "(II)V");
                            linearLayoutManager.mo16973V(((Integer) aVar.mo10231a(0)).intValue(), ((Integer) aVar.mo10231a(1)).intValue());
                            C117292a.m165359e(linearLayoutManager2, "com/tencent/mm/plugin/finder/feed/FinderCommentDrawerPresenter$refreshFromGetFinderFeedComment$2", "call", "(Lkotlin/Pair;)V", "Undefined", "scrollToPositionWithOffset", "(II)V");
                        }
                    }
                }
            }
        ...
        sb.append(System.currentTimeMillis() - this.f173944c);
        sb.append("ms, succ:");
        if (list == null) {
            z = false;
        }
        ...
        this.f173945d.mo11853b(C65234n.OK);
