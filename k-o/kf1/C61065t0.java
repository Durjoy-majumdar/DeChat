...
/* renamed from: kf1.t0 */
public final class C61065t0 extends C87413o implements C32226l<C14121l, C13598b0> {

    /* renamed from: d */
    public final /* synthetic */ FinderCommentDrawerPresenter f173905d;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C61065t0(FinderCommentDrawerPresenter finderCommentDrawerPresenter) {
        super(1);
        this.f173905d = finderCommentDrawerPresenter;
    }
    ...
    public Object invoke(Object obj) {
        ...
        sb.append("preloadNextPage before lastBuffer ");
        C49712hj1 hj12 = null;
        if (this.f173905d.f158626r == null) {
            str = "null";
        } else {
            C89349b bVar = this.f173905d.f158626r;
            str = MD5Util.getMD5String(bVar != null ? bVar.mo123703f() : null);
        }
        sb.append(str);
        Log.m105924i("Finder.DrawerPresenter", sb.toString());
        C13442s8.C13443a aVar = C13442s8.f38060Q0;
        C13442s8 f = aVar.mo12873f(this.f173905d.f158615d);
        int i = f != null ? f.f38096i : 0;
        if (C66785b.f191882e.mo90681z1()) {
            FinderCommentDrawerPresenter finderCommentDrawerPresenter = this.f173905d;
            ...
            if (finderItem != null) {
                ...
                if (finderItem2 != null) {
                    ...
                    if (finderItem3 != null) {
                        ...
                        C89059e B = new C60795a2(id, objectNonceId, i, i2, userName, bVar2, (C65426w0) null, 0, false, hj12, 1, FileUtils.S_IRWXU, (C8480h) null).mo9225i().mo123064p(new C61058r0(finderCommentDrawerPresenter)).mo123062e(new C61062s0(finderCommentDrawerPresenter, lVar));
            ...
            FinderCommentDrawerPresenter finderCommentDrawerPresenter2 = this.f173905d;
            ...
            if (finderItem4 != null) {
                ...
                if (finderItem5 != null) {
                    ...
                    if (finderItem6 != null) {
                        ...
                        C89059e B2 = new C46547x1(id4, objectNonceId2, i, i3, userName2, false, bVar3, (C65426w0) null, 0, (String) null, false, false, (String) null, hj12, 1, (C49946j51) null, false, 106400, (C8480h) null).mo9225i().mo123064p(new C61051p0(finderCommentDrawerPresenter3)).mo123062e(new C61055q0(finderCommentDrawerPresenter3, lVar));
