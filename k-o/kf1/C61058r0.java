...
/* renamed from: kf1.r0 */
public final class C61058r0<_Ret, _Var> implements C87581a {

    /* renamed from: a */
    public final /* synthetic */ FinderCommentDrawerPresenter f173892a;

    public C61058r0(FinderCommentDrawerPresenter finderCommentDrawerPresenter) {
        this.f173892a = finderCommentDrawerPresenter;
    }
    ...
    public Object call(Object obj) {
        ...
        if (cVar == null) {
            ...
            this.f173892a.mo77322S0(((C50284lm0) t).f137516h == 1);
            this.f173892a.f158626r = ((C50284lm0) cVar.f256796d).f137514f;
            StringBuilder sb = new StringBuilder();
            sb.append("preloadNextPage after lastBuffer ");
            if (this.f173892a.f158626r == null) {
                str = "null";
            } else {
                C89349b bVar = this.f173892a.f158626r;
                str = MD5Util.getMD5String(bVar != null ? bVar.mo123703f() : null);
            }
            sb.append(str);
            Log.m105924i("Finder.DrawerPresenter", sb.toString());
            ArrayList arrayList = new ArrayList();
            FinderCommentDrawerPresenter finderCommentDrawerPresenter = this.f173892a;
            ...
            return this.f173892a.mo77330f0(arrayList, true);
        }
    }
}
