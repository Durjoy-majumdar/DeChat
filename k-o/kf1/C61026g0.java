...
/* renamed from: kf1.g0 */
public final class C61026g0<_Ret, _Var> implements C87581a {

    /* renamed from: a */
    public final /* synthetic */ FinderCommentDrawerPresenter f173795a;

    public C61026g0(FinderCommentDrawerPresenter finderCommentDrawerPresenter) {
        this.f173795a = finderCommentDrawerPresenter;
    }
    ...
    public Object call(Object obj) {
        ...
        if (cVar == null) {
            ...
            this.f173795a.mo77322S0(((C50008jm0) t).f136188i == 1);
            this.f173795a.f158626r = ((C50008jm0) cVar.f256796d).f136185f;
            StringBuilder sb = new StringBuilder();
            sb.append("loadMoreData after lastBuffer ");
            if (this.f173795a.f158626r == null) {
                str = "null";
            } else {
                C89349b bVar = this.f173795a.f158626r;
                str = MD5Util.getMD5String(bVar != null ? bVar.mo123703f() : null);
            }
            sb.append(str);
            Log.m105924i("Finder.DrawerPresenter", sb.toString());
            ArrayList arrayList = new ArrayList();
            FinderCommentDrawerPresenter finderCommentDrawerPresenter = this.f173795a;
            ...
            return this.f173795a.mo77330f0(arrayList, true);
        }
    }
}
