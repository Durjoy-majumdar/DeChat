...
/* renamed from: kj1.s */
public final class C10219s extends C10538e {
    ...
    /* renamed from: j */
    public List<C10536d> f31208j;

    /* renamed from: kj1.s$a */
    public static final class C10220a implements View.OnClickListener {

        /* renamed from: d */
        public final /* synthetic */ C4191v0 f31209d;

        public C10220a(C4191v0 v0Var) {
            this.f31209d = v0Var;
        }
        ...
        public final void onClick(View view) {
            ...
            arrayList.clear();
            C117292a.m165356b("com/tencent/mm/plugin/finder/live/moreaction/AnchorMoreFunctionOption$onItemClicked$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V", this, array);
            this.f31209d.mo5072g();
            C117292a.m165361g(this, "com/tencent/mm/plugin/finder/live/moreaction/AnchorMoreFunctionOption$onItemClicked$1", "android/view/View$OnClickListener", "onClick", "(Landroid/view/View;)V");
        }
    }

    /* renamed from: kj1.s$b */
    public static final class C10221b implements C4191v0.C4192a {

        /* renamed from: a */
        public final /* synthetic */ C10219s f31210a;

        public C10221b(C10219s sVar) {
            this.f31210a = sVar;
        }

        public final void onDismiss() {
            this.f31210a.mo10802d();
        }
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C10219s(C10125e1 e1Var, int i) {
        super(e1Var, i);
        C87412m.m108594g(e1Var, "helper");
        this.f31206h = e1Var.f30961H;
        this.f31207i = mo10805j() ? "anchorlive.more.morefunction" : "startlive.more.morefunction";
        this.f31208j = C64197v.m75539h(new C10189m(e1Var, i), new C10176k(e1Var, i), new C10267y(e1Var, i), new C10169j(e1Var, i), new C10121e(e1Var, i), new C10094a(e1Var, i), new C10259x(e1Var, i));
        if (C62042e.f176370a.mo87088j()) {
            C10538e.m10469r(this, 24010, 0, "live_more_more_function", 2, (Object) null);
        }
    }
    ...
    public void mo10525t(C10125e1 e1Var) {
        ...
        View inflate = LayoutInflater.from(e1Var.f30985d).inflate(C0966R.C0971layout.bwm, (ViewGroup) null);
        ...
        view.findViewById(C0966R.C0970id.o1s).setOnClickListener(new C10220a(v0Var));
        v0Var.mo5067b(true);
        v0Var.mo5066a();
        if (!(!mo10805j() || (bVar = e1Var.f30988g) == null || (aVar = bVar.f31008a) == null)) {
            aVar.mo10547g();
        }
        if (mo10805j()) {
            JSONObject jSONObject = new JSONObject();
        ...
        for (C10536d dVar : this.f31208j) {
            C10535c cVar = dVar instanceof C10535c ? (C10535c) dVar : null;
            if (cVar != null) {
                cVar.mo10798m(v0Var);
            }
        }
        v0Var.f18472r = new C10221b(this);
        v0Var.mo5073h();
    }
}
