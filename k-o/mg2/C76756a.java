...
/* renamed from: mg2.a */
public class C76756a implements C101592a0 {

    /* renamed from: b */
    public static final String f224531b = C79147d.m95779a();

    /* renamed from: a */
    public String f224532a;

    public C76756a(String str) {
        this.f224532a = str;
    }

    /* renamed from: a */
    public String mo94817a() {
        return this.f224532a;
    }
    ...
    public android.graphics.Bitmap mo94819c(android.graphics.Bitmap r7, sf0.C101592a0.C77686a r8, java.lang.String r9) {
        /*
            ...
            goto L_0x0083
        L_0x0013:
            java.lang.String r2 = f224531b     // Catch:{ IOException -> 0x0075 }
        ...
        L_0x0083:
            ...
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: mg2.C76756a.mo94819c(android.graphics.Bitmap, sf0.a0$a, java.lang.String):android.graphics.Bitmap");
    }
    ...
    public String mo94827k() {
        String str = this.f224532a;
        if (Util.isNullOrNil(str)) {
            Log.m105928w("MicroMsg.WalletGetPicStrategy", "getStoragePath: but url is null");
            return null;
        }
        return String.format("%s/%s", new Object[]{f224531b, C90193h.m112878f(str.getBytes())});
    }
