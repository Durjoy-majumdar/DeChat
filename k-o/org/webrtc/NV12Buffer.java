...
public class NV12Buffer implements VideoFrame.Buffer {
    ...
    private static native void nativeCropAndScale(int i, int i2, int i3, int i4, int i5, int i6, ByteBuffer byteBuffer, int i7, int i8, int i9, int i15, ByteBuffer byteBuffer2, int i16, ByteBuffer byteBuffer3, int i17, ByteBuffer byteBuffer4, int i18);
