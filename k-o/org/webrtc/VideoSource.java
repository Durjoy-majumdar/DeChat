...
public class VideoSource extends MediaSource {
    private final CapturerObserver capturerObserver = new CapturerObserver() {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:9:0x0025, code lost:
            r4 = org.webrtc.C21878j.m25075b(r4, r0);
         */
        ...
        public void onFrameCaptured(org.webrtc.VideoFrame r4) {
            ...
            L_0x0024:
                monitor-exit(r1)     // Catch:{ all -> 0x0038 }
                org.webrtc.VideoFrame r4 = org.webrtc.C21878j.m25075b(r4, r0)
            ...
            L_0x0038:
                ...
                throw r4
            */
            throw new UnsupportedOperationException("Method not decompiled: org.webrtc.VideoSource.C218661.onFrameCaptured(org.webrtc.VideoFrame):void");
        }
    };
    ...
    public /* synthetic */ void lambda$setVideoProcessor$1(VideoFrame videoFrame) {
        runWithReference(new VideoSource$$a(this, videoFrame));
    }
    ...
    public void setVideoProcessor(VideoProcessor videoProcessor2) {
        synchronized (this.videoProcessorLock) {
            ...
            if (videoProcessor2 != null) {
                videoProcessor2.setSink(new VideoSource$$b(this));
                if (this.isCapturerRunning) {
