...
public class TextureBufferImpl implements VideoFrame.TextureBuffer {
    ...
    public VideoFrame.I420Buffer toI420() {
        return (VideoFrame.I420Buffer) ThreadUtils.invokeAtFrontUninterruptibly(this.toI420Handler, new TextureBufferImpl$$a(this));
    }
    ...
    private TextureBufferImpl applyTransformMatrix(Matrix matrix, int i, int i2, int i3, int i4) {
        ...
        retain();
        return new TextureBufferImpl(i, i2, i3, i4, this.type, this.f61853id, matrix2, this.toI420Handler, this.yuvConverter, new RefCountMonitor() {
    ...
    private TextureBufferImpl(int i, int i2, int i3, int i4, VideoFrame.TextureBuffer.Type type2, int i5, Matrix matrix, Handler handler, YuvConverter yuvConverter2, RefCountMonitor refCountMonitor2) {
        ...
        this.refCountDelegate = new RefCountDelegate(new TextureBufferImpl$$b(this, refCountMonitor2));
