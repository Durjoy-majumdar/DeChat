...
public class RendererCommon {
    ...
    public static /* synthetic */ class C218511 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.webrtc.RendererCommon.C218511.<clinit>():void");
        }
    }
    ...
    public interface RendererEvents {
        ...
        void onRenderStats(PerformanceStatistics performanceStatistics);
    }
    ...
    public static float convertScalingTypeToVisibleFraction(ScalingType scalingType) {
        int i = C218511.$SwitchMap$org$webrtc$RendererCommon$ScalingType[scalingType.ordinal()];
        if (i == 1) {
            return 1.0f;
        }
        if (i == 2) {
