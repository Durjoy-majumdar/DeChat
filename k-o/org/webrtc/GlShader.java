...
public class GlShader {
    ...
    public GlShader(String str, String str2) {
        ...
        if (glCreateProgram != 0) {
            ...
            Logging.m25023e(TAG, "Could not link program: " + GLES20.glGetProgramInfoLog(this.program));
    ...
    private static int compileShader(int i, String str) {
        ...
        if (glCreateShader != 0) {
            ...
            Logging.m25023e(TAG, "Compile error " + GLES20.glGetShaderInfoLog(glCreateShader) + " in shader:\n" + str);
    ...
    public void release() {
        Logging.m25022d(TAG, "Deleting shader.");
        int i = this.program;
        if (i != -1) {
