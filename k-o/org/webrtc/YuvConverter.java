...
public final class YuvConverter {
    ...
    private VideoFrame.I420Buffer convertInternal(VideoFrame.TextureBuffer textureBuffer) {
        ...
        int i9 = i7;
        int i15 = i2;
        VideoFrameDrawer.drawTexture(this.drawer, textureBuffer3, matrix2, i5, i6, 0, i8, i9, i15);
        this.shaderCallbacks.setPlaneV();
        VideoFrameDrawer.drawTexture(this.drawer, textureBuffer3, matrix2, i5, i6, i7, i8, i9, i15);
        GLES20.glReadPixels(0, 0, this.i420TextureFrameBuffer.getWidth(), this.i420TextureFrameBuffer.getHeight(), NativeBitmapStruct.GLFormat.GL_RGBA, NativeBitmapStruct.GLType.GL_UNSIGNED_BYTE, nativeAllocateByteBuffer);
        ...
        return JavaI420Buffer.wrap(width, height, slice, i, slice2, i, slice3, i, new YuvConverter$$a(nativeAllocateByteBuffer));
    }
    ...
    public VideoFrame.I420Buffer convert(VideoFrame.TextureBuffer textureBuffer) {
        try {
            ...
            Logging.m25027w(TAG, "Failed to convert TextureBuffer", e);
            return null;
        }
    }
    ...
    public YuvConverter(VideoFrameDrawer videoFrameDrawer2) {
        ...
        this.i420TextureFrameBuffer = new GlTextureFrameBuffer(NativeBitmapStruct.GLFormat.GL_RGBA);
