...
public final class WebRtcAudioUtils {
    ...
    private static void logAudioStateBasic(String str, AudioManager audioManager) {
        Logging.m25022d(str, "Audio State: audio mode: " + modeToString(audioManager.getMode()) + ", has mic: " + hasMicrophone() + ", mic muted: " + audioManager.isMicrophoneMute() + ", music active: " + audioManager.isMusicActive() + ", speakerphone: " + audioManager.isSpeakerphoneOn() + ", BT SCO: " + audioManager.isBluetoothScoOn());
    }
    ...
    public static synchronized void setWebRtcBasedAutomaticGainControl(boolean z) {
        synchronized (WebRtcAudioUtils.class) {
            Logging.m25026w(TAG, "setWebRtcBasedAutomaticGainControl() is deprecated");
        }
    }
    ...
    public static synchronized boolean useWebRtcBasedAcousticEchoCanceler() {
        ...
        synchronized (WebRtcAudioUtils.class) {
            if (useWebRtcBasedAcousticEchoCanceler) {
                Logging.m25026w(TAG, "Overriding default behavior; now using WebRTC AEC!");
            }
    ...
    public static synchronized boolean useWebRtcBasedNoiseSuppressor() {
        ...
        synchronized (WebRtcAudioUtils.class) {
            if (useWebRtcBasedNoiseSuppressor) {
                Logging.m25026w(TAG, "Overriding default behavior; now using WebRTC NS!");
            }
