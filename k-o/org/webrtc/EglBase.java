...
public interface EglBase {
    public static final int[] CONFIG_PIXEL_BUFFER = EglBaseStatic.configBuilder().setSupportsPixelBuffer(true).createConfigAttributes();
    public static final int[] CONFIG_PIXEL_RGBA_BUFFER = EglBaseStatic.configBuilder().setHasAlphaChannel(true).setSupportsPixelBuffer(true).createConfigAttributes();
    public static final int[] CONFIG_PLAIN = EglBaseStatic.configBuilder().createConfigAttributes();
    public static final int[] CONFIG_RECORDABLE = EglBaseStatic.configBuilder().setIsRecordable(true).createConfigAttributes();
    public static final int[] CONFIG_RGBA = EglBaseStatic.configBuilder().setHasAlphaChannel(true).createConfigAttributes();
