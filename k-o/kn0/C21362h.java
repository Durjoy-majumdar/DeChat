...
/* renamed from: kn0.h */
public final class C21362h implements C16744h {

    /* renamed from: a */
    public static final Constructor<? extends C16741e> f60433a;
    ...
    public synchronized C16741e[] mo17740a() {
        C16741e[] eVarArr;
        Constructor<? extends C16741e> constructor = f60433a;
        eVarArr = new C16741e[(constructor == null ? 11 : 12)];
        eVarArr[0] = new C20672f(0);
        eVarArr[1] = new C20920u(1, 0);
        eVarArr[2] = new C20668d(0, (C20549u) null);
        eVarArr[3] = new C20522b(0);
        eVarArr[4] = new C20440d(0);
        eVarArr[5] = new C20896c();
        eVarArr[6] = new C20894a();
