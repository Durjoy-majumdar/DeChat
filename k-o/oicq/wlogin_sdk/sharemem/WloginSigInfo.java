...
public class WloginSigInfo implements Serializable, Parcelable {
    public static final Parcelable.Creator<WloginSigInfo> CREATOR = new C25351a();
    ...
    /* renamed from: oicq.wlogin_sdk.sharemem.WloginSigInfo$a */
    public class C25351a implements Parcelable.Creator<WloginSigInfo> {
    ...
    public WloginSigInfo(long j, long j2, long j3, long j4, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5, byte[] bArr6, byte[] bArr7, byte[] bArr8, byte[] bArr9, byte[] bArr10, byte[] bArr11, byte[] bArr12, byte[][] bArr13) {
        ...
        if (bArr14 == null || bArr14.length != 7) {
        ...
        this._vkey = (byte[]) bArr14[0].clone();
        this._en_A1 = (byte[]) bArr14[1].clone();
        this._access_token = (byte[]) bArr14[2].clone();
        this._D2 = (byte[]) bArr14[3].clone();
        this._D2Key = (byte[]) bArr14[4].clone();
        this._sid = (byte[]) bArr14[5].clone();
        this._noPicSig = (byte[]) bArr14[6].clone();
    }
    ...
    public WloginSigInfo Set(long j, long j2, long j3, long j4, byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5, byte[] bArr6, byte[] bArr7, byte[] bArr8, byte[] bArr9, byte[] bArr10, byte[] bArr11, byte[] bArr12, byte[][] bArr13) {
        ...
        if (bArr14 == null || bArr14.length != 7) {
            ...
            this._vkey = (byte[]) bArr14[0].clone();
            bArr14[1].clone();
            if (((byte[]) bArr14[1].clone()).length > 0) {
                this._en_A1 = (byte[]) bArr14[1].clone();
                byte[] bArr15 = bArr14[6];
                if (bArr15 == null || bArr15.length <= 0) {
                    this._noPicSig = new byte[0];
                } else {
                    this._noPicSig = (byte[]) bArr15.clone();
                }
            }
            this._access_token = (byte[]) bArr14[2].clone();
            this._D2 = (byte[]) bArr14[3].clone();
    ...
    public /* synthetic */ WloginSigInfo(Parcel parcel, WloginSigInfo wloginSigInfo) {
        this(parcel);
    }
}
