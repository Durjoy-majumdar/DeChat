...
/* renamed from: m03.g */
public class C88688g extends SurfaceTexture {

    /* renamed from: a */
    public SurfaceTexture f256041a = null;

    public C88688g(int i) {
        super(i);
    }

    /* renamed from: a */
    public static String m110606a() {
        String str;
    ...
    public void attachToGLContext(int i) {
        ...
        this.f256041a.attachToGLContext(i);
    }
    ...
    public void detachFromGLContext() {
        ...
        try {
            this.f256041a.detachFromGLContext();
            z = false;
        } catch (Exception e) {
        ...
        if (z) {
            try {
                ...
                int intValue = ((Integer) declaredMethod.invoke(this.f256041a, new Object[0])).intValue();
                String str = m110606a() + " detect texture problem error code = " + intValue + ", detach = " + true + ", and error = " + z;
                ...
                String str2 = m110606a() + " detect texture problem error code = " + 0 + ", detach = " + false + ", and error = " + z;
                ...
                String str3 = m110606a() + " detect texture problem error code = " + 0 + ", detach = " + false + ", and error = " + z;
                ...
                String str4 = m110606a() + " detect texture problem error code = " + 0 + ", detach = " + false + ", and error = " + z;
                ...
                String str5 = m110606a() + " detect texture problem error code = " + 0 + ", detach = " + false + ", and error = " + z;
                ...
                String str6 = m110606a() + " detect texture problem error code = " + 0 + ", detach = " + false + ", and error = " + z;
                ...
                String str7 = m110606a() + " detect texture problem error code = " + 0 + ", detach = " + false + ", and error = " + z;
