...
/* renamed from: j50.g */
public final class C60757g implements Runnable {

    /* renamed from: d */
    public final /* synthetic */ C60735a f173071d;

    /* renamed from: e */
    public final /* synthetic */ SurfaceTexture f173072e;

    /* renamed from: j50.g$a */
    public static final class C60758a extends C87413o implements C32226l<C110194c, C13598b0> {

        /* renamed from: d */
        public final /* synthetic */ C60735a f173073d;

        /* JADX INFO: super call moved to the top of the method (can break code semantics) */
        public C60758a(C60735a aVar) {
            super(1);
            this.f173073d = aVar;
        }
        ...
        public Object invoke(Object obj) {
            ...
            C60735a aVar = this.f173073d;
            if (!aVar.f172990B) {
                Log.m105924i("MicroMsg.LiveCore", "skip sendCustomVideoData by isPushing:" + this.f173073d.f172990B);
            } else if (aVar.f172989A.f166264k) {
                Log.m105924i("MicroMsg.LiveCore", "skip sendCustomVideoData by isDocMode:" + this.f173073d.f172989A.f166264k);
                C60735a.m71076L(this.f173073d);
            } else if (cVar != null) {
    ...
    public C60757g(C60735a aVar, SurfaceTexture surfaceTexture) {
        this.f173071d = aVar;
        this.f173072e = surfaceTexture;
    }
    ...
    public final void run() {
        /*
            r5 = this;
            j50.a r0 = r5.f173071d
            int r0 = j50.C60735a.m71075K(r0)
            j50.a r1 = r5.f173071d
            y80.g r2 = r1.f173034t
            r3 = 0
            if (r2 == 0) goto L_0x001e
            android.graphics.SurfaceTexture r4 = r5.f173072e
        ...
        L_0x0093:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: j50.C60757g.run():void");
    }
}
