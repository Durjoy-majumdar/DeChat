...
/* renamed from: e73.j */
public class C107251j implements C76956i.C76958b {

    /* renamed from: a */
    public final /* synthetic */ C106556c f320895a;

    public C107251j(C107252k kVar, C106556c cVar) {
        this.f320895a = cVar;
    }
    ...
    public void mo107280a(C22550a aVar) {
        ...
        ((FingerprintWalletLockUI.C106535j) this.f320895a).mo153205b(aVar.f61886a, aVar.f61887b);
    }

    /* renamed from: b */
    public void mo107281b() {
        FingerprintWalletLockUI.C106535j jVar = (FingerprintWalletLockUI.C106535j) this.f320895a;
    ...
    public void mo107282c(int i, C22550a aVar) {
        ...
        if (i != 1) {
            ...
            if (i2 == 1021 || i2 == 1022) {
                ...
                C106556c cVar = this.f320895a;
                if (cVar != null) {
                    ((FingerprintWalletLockUI.C106535j) cVar).mo153205b(3, "too many trial");
                }
            } else if (i2 == 1020 || i2 == 1029) {
                Log.m105924i("MicroMsg.SoterFingerprintAuthManager", "alvinluo user cancelled");
                C106556c cVar2 = this.f320895a;
                if (cVar2 != null) {
                    ((FingerprintWalletLockUI.C106535j) cVar2).mo153205b(4, "user cancelled");
                }
            } else if (i2 == 1012) {
                C106556c cVar3 = this.f320895a;
                if (cVar3 != null) {
                    ((FingerprintWalletLockUI.C106535j) cVar3).mo153205b(8, "no fingerprint enrolled in system");
                }
            } else {
                C106556c cVar4 = this.f320895a;
                if (cVar4 != null) {
                    ((FingerprintWalletLockUI.C106535j) cVar4).mo153205b(2, aVar.f61887b);
                }
            }
        }
    }
