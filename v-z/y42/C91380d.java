...
/* renamed from: y42.d */
public final class C91380d extends C86430i<C7597n> {

    /* renamed from: d */
    public final String f262075d = "MBJsApiOperateDownloadTask";
    ...
    public void mo18q(C7596h hVar) {
        ...
        if (C87412m.m108589b(optString2, "abort")) {
            C86184l xf = ((C85256f0) C86312j.m106911c(C85256f0.class)).mo118378xf(g0, IMBNetworkService.Key.Download);
            if (xf == null) {
                Log.m105924i(this.f262075d, "get download task error");
                mo120840p().invoke(mo120842g(300004, "get download task error"));
                return;
            }
            C86185m a = xf.mo120589a(optString);
            if (a == null) {
                Log.m105925i(this.f262075d, "downloadWorker is null %s", optString);
            ...
            if (nVar != null) {
                nVar.mo8722f0(mBJsEventOnDownloadTaskStateChange);
            }
            Log.m105919d(this.f262075d, "abortTask finish %s", optString);
            return;
        }
        Log.m105924i(this.f262075d, "unknown operationType");
