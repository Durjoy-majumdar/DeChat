...
/* renamed from: zx0.b */
public final class C53834b extends C53839f {
    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C53834b(C53613a aVar) {
        super(aVar);
    ...
    public C47350c mo74453c(TransferRequestInfo transferRequestInfo) {
        ...
        ne22.f138557n = transferRequestInfo.f109032o;
        C47350c.C47352b bVar = new C47350c.C47352b();
        bVar.f127066a = ne22;
        bVar.f127067b = new C50669oe2();
        bVar.f127068c = "/cgi-bin/micromsg-bin/mawebtransfer";
        bVar.f127069d = 7094;
        bVar.f127070e = 7094;
        bVar.f127071f = 0;
