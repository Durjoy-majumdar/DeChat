...
/* renamed from: as3.i0 */
public final class C103880i0 extends C108421e {

    /* renamed from: b */
    public int f307028b = 0;

    /* renamed from: c */
    public long f307029c = 0;
    ...
    public C108421e mo145538b(C108417a aVar) {
        while (true) {
            ...
            if (k == 0) {
                ...
                this.f307028b = aVar.mo158946h();
            } else if (k == 16) {
                this.f307029c = aVar.mo158947i();
