...
public class FileProvider extends ContentProvider {
    ...
    private static HashMap<String, C112864a> sCache = new HashMap<>();
    private C112864a mStrategy;

    /* renamed from: androidx.core.content.FileProvider$a */
    public interface C112864a {
        /* renamed from: a */
        Uri mo164786a(File file);

        /* renamed from: b */
        File mo164787b(Uri uri);
    }

    /* renamed from: androidx.core.content.FileProvider$b */
    public static class C112865b implements C112864a {

        /* renamed from: a */
        public final String f337887a;

        /* renamed from: b */
        public final HashMap<String, File> f337888b = new HashMap<>();

        public C112865b(String str) {
            this.f337887a = str;
        }

        /* renamed from: a */
        public Uri mo164786a(File file) {
            try {
                String canonicalPath = file.getCanonicalPath();
                Map.Entry entry = null;
                for (Map.Entry next : this.f337888b.entrySet()) {
                ...
                if (entry != null) {
                    ...
                    return new Uri.Builder().scheme("content").authority(this.f337887a).encodedPath(Uri.encode((String) entry.getKey()) + XVFSFile.SEPARATOR_CHAR + Uri.encode(substring, "/")).build();
                }
        ...
        /* renamed from: b */
        public File mo164787b(Uri uri) {
            String encodedPath = uri.getEncodedPath();
            int indexOf = encodedPath.indexOf(47, 1);
            String decode = Uri.decode(encodedPath.substring(1, indexOf));
            String decode2 = Uri.decode(encodedPath.substring(indexOf + 1));
            File file = this.f337888b.get(decode);
            if (file != null) {
    ...
    private static C112864a getPathStrategy(Context context, String str) {
        C112864a aVar;
        synchronized (sCache) {
            aVar = sCache.get(str);
            if (aVar == null) {
    ...
    public static Uri getUriForFile(Context context, String str, File file) {
        return getPathStrategy(context, str).mo164786a(file);
    }
    ...
    private static C112864a parsePathStrategy(Context context, String str) {
        C112865b bVar = new C112865b(str);
                ...
                while (true) {
                    ...
                    if (next == 2) {
                        ...
                        if (TAG_ROOT_PATH.equals(name)) {
                            ...
                            File[] b = C111105a.C111109b.m151508b(context, (String) null);
                            if (b.length > 0) {
                                file = b[0];
                            }
                        } else if (TAG_EXTERNAL_CACHE.equals(name)) {
                            Object obj2 = C111105a.f332697a;
                            File[] a = C111105a.C111109b.m151507a(context);
                            if (a.length > 0) {
                                file = a[0];
                            }
                        ...
                        if (file != null) {
                            ...
                            if (!TextUtils.isEmpty(attributeValue)) {
                                try {
                                    bVar.f337888b.put(attributeValue, buildPath.getCanonicalFile());
                                } catch (IOException e) {
    ...
    public int delete(Uri uri, String str, String[] strArr) {
        return this.mStrategy.mo164787b(uri).delete() ? 1 : 0;
    }
    ...
    public java.lang.String getType(android.net.Uri r3) {
        /*
            ...
            java.io.File r3 = r0.mo164787b(r3)
    ...
    public ParcelFileDescriptor openFile(Uri uri, String str) {
        return ParcelFileDescriptor.open(this.mStrategy.mo164787b(uri), modeToMode(str));
    }

    public Cursor query(Uri uri, String[] strArr, String str, String[] strArr2, String str2) {
        int i;
        File b = this.mStrategy.mo164787b(uri);
