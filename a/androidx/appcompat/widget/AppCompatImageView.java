...
public class AppCompatImageView extends ImageView {
    ...
    /* renamed from: d */
    public final C103523d f305452d;

    /* renamed from: e */
    public final C103536h f305453e;
    ...
    public void drawableStateChanged() {
        ...
        C103523d dVar = this.f305452d;
        if (dVar != null) {
            dVar.mo144312a();
        }
        C103536h hVar = this.f305453e;
        if (hVar != null) {
            hVar.mo144345a();
        }
    }
    ...
    public boolean hasOverlappingRendering() {
        return ((this.f305453e.f305739a.getBackground() instanceof RippleDrawable) ^ true) && super.hasOverlappingRendering();
    }
