...
public class ImageCaptureConfigProvider implements ConfigProvider<ImageCaptureConfig> {
    ...
    public static class ImageCaptureEventAdapter extends CameraEventCallback implements UseCase.EventCallback, CaptureBundle {
        ...
        public ImageCaptureEventAdapter(ImageCaptureExtenderImpl imageCaptureExtenderImpl, Context context) {
        ...
        public CaptureConfig onPresetSession() {
            ...
            Logger.m15477w(ImageCaptureConfigProvider.TAG, "The CaptureRequest parameters returned from onPresetSession() will be passed to the camera device as part of the capture session via SessionConfiguration#setSessionParameters(CaptureRequest) which only supported from API level 28!");
            return null;
        }
    }
    ...
    public void updateBuilderConfig(ImageCapture.Builder builder, int i, VendorExtender vendorExtender, Context context) {
        if (vendorExtender instanceof BasicVendorExtender) {
            ...
            if (imageCaptureExtenderImpl != null) {
                ...
                Logger.m15473e(TAG, "ImageCaptureExtenderImpl is null!");
            }
        } else {
