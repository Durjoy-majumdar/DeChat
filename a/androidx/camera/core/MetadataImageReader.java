...
class MetadataImageReader implements ImageReaderProxy, ForwardingImageProxy.OnImageCloseListener {
    ...
    private void enqueueImageProxy(SettableImageProxy settableImageProxy) {
        ...
        synchronized (this.mLock) {
            ...
            if (this.mMatchedImageProxies.size() < getMaxImages()) {
                ...
                Logger.m15471d("TAG", "Maximum image number reached.");
        ...
        if (executor != null) {
            executor.execute(new MetadataImageReader$$a(this, onImageAvailableListener));
        } else {
    ...
    private void removeStaleData() {
        ...
        L_0x0015:
            ...
            r2 = 1
        L_0x0032:
            p329d3.C20434g.m22017a(r2)     // Catch:{ all -> 0x008e }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void lambda$new$0(androidx.camera.core.impl.ImageReaderProxy r7) {
        /*
            r6 = this;
        ...
        L_0x0026:
            ...
            androidx.camera.core.Logger.m15472d(r4, r5, r3)     // Catch:{ all -> 0x0024 }
        L_0x002e:
    ...
    public MetadataImageReader(ImageReaderProxy imageReaderProxy) {
        ...
        this.mTransformedListener = new MetadataImageReader$$b(this);
        this.mClosed = false;
