...
public final class PreviewConfig implements UseCaseConfig<Preview>, ImageOutputConfig, ThreadConfig {
    ...
    public CaptureProcessor getCaptureProcessor(CaptureProcessor captureProcessor) {
        return (CaptureProcessor) C16539j.m15576g(this, OPTION_PREVIEW_CAPTURE_PROCESSOR, captureProcessor);
    }
    ...
    public ImageInfoProcessor getImageInfoProcessor(ImageInfoProcessor imageInfoProcessor) {
        return (ImageInfoProcessor) C16539j.m15576g(this, IMAGE_INFO_PROCESSOR, imageInfoProcessor);
    }
    ...
    public boolean isRgba8888SurfaceRequired(boolean z) {
        return ((Boolean) C16539j.m15576g(this, OPTION_RGBA8888_SURFACE_REQUIRED, Boolean.valueOf(z))).booleanValue();
    }
    ...
    public CaptureProcessor getCaptureProcessor() {
        return (CaptureProcessor) C16539j.m15575f(this, OPTION_PREVIEW_CAPTURE_PROCESSOR);
    }

    public ImageInfoProcessor getImageInfoProcessor() {
        return (ImageInfoProcessor) C16539j.m15575f(this, IMAGE_INFO_PROCESSOR);
    }
}
