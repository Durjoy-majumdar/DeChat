...
public final class ExifOutputStream extends FilterOutputStream {
    ...
    private void writeExifSegment(ByteOrderedDataOutputStream byteOrderedDataOutputStream) {
        ...
        byteOrderedDataOutputStream.writeShort(this.mExifData.getByteOrder() == ByteOrder.BIG_ENDIAN ? (short) 19789 : 18761);
        ...
        for (int i7 = 0; i7 < ExifData.EXIF_TAGS.length; i7++) {
            if (!this.mExifData.getAttributes(i7).isEmpty()) {
                ...
                for (Map.Entry next : this.mExifData.getAttributes(i7).entrySet()) {
                    ...
                    C20434g.m22020d(exifTag2, "Tag not supported: " + ((String) next.getKey()) + ". Tag needs to be ported from ExifInterface to ExifData.");
