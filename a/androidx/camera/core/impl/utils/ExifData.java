...
public class ExifData {
    ...
    public static final HashSet<String> sTagSetForCompatibility = new HashSet<>(Arrays.asList(new String[]{ExifInterface.TAG_F_NUMBER, ExifInterface.TAG_EXPOSURE_TIME, ExifInterface.TAG_GPS_TIMESTAMP}));
    private final List<Map<String, ExifAttribute>> mAttributes;
    private final ByteOrder mByteOrder;

    /* renamed from: androidx.camera.core.impl.utils.ExifData$1 */
    public static /* synthetic */ class C165441 {

        /* renamed from: $SwitchMap$androidx$camera$core$impl$CameraCaptureMetaData$FlashState */
        public static final /* synthetic */ int[] f44363x649fcb98;

        /* renamed from: $SwitchMap$androidx$camera$core$impl$utils$ExifData$WhiteBalanceMode */
        public static final /* synthetic */ int[] f44364x2b240c2a;
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f44364x2b240c2a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x002e:
                int[] r1 = f44363x649fcb98     // Catch:{ NoSuchFieldError -> 0x0038 }
            ...
            L_0x0038:
                int[] r0 = f44363x649fcb98     // Catch:{ NoSuchFieldError -> 0x0043 }
            ...
            L_0x0043:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.camera.core.impl.utils.ExifData.C165441.<clinit>():void");
        }
    }
    ...
    public static final class Builder {
        ...
        private void setAttributeInternal(java.lang.String r18, java.lang.String r19, java.util.List<java.util.Map<java.lang.String, androidx.camera.core.impl.utils.ExifAttribute>> r20) {
            ...
            L_0x0054:
                ...
                androidx.camera.core.Logger.m15477w(r7, r0)
                return
            L_0x006d:
            ...
            L_0x00b1:
                ...
                goto L_0x011b
            L_0x00f3:
                double r9 = java.lang.Double.parseDouble(r2)     // Catch:{ NumberFormatException -> 0x0101 }
                androidx.camera.core.impl.utils.LongRational r11 = new androidx.camera.core.impl.utils.LongRational     // Catch:{ NumberFormatException -> 0x0101 }
                r11.<init>(r9)     // Catch:{ NumberFormatException -> 0x0101 }
                java.lang.String r2 = r11.toString()     // Catch:{ NumberFormatException -> 0x0101 }
                goto L_0x011b
            L_0x0101:
                r0 = move-exception
                java.lang.StringBuilder r3 = new java.lang.StringBuilder
                ...
                androidx.camera.core.Logger.m15478w(r7, r2, r0)
                return
            L_0x011b:
                r5 = 0
                r6 = 0
        ...
        public Builder setFlashState(CameraCaptureMetaData.FlashState flashState) {
            ...
            int i2 = C165441.f44363x649fcb98[flashState.ordinal()];
            if (i2 == 1) {
                i = 0;
            } else if (i2 == 2) {
                i = 32;
            } else if (i2 != 3) {
                Logger.m15477w(ExifData.TAG, "Unknown flash state: " + flashState);
                return this;
            } else {
                i = 1;
            }
        ...
        public Builder setOrientationDegrees(int i) {
            ...
            if (i == 0) {
                ...
                Logger.m15477w(ExifData.TAG, "Unexpected orientation value: " + i + ". Must be one of 0, 90, 180, 270.");
                i2 = 0;
            } else {
                i2 = 8;
            }
        ...
        public Builder setWhiteBalanceMode(WhiteBalanceMode whiteBalanceMode) {
            int i = C165441.f44364x2b240c2a[whiteBalanceMode.ordinal()];
            return setAttribute(ExifInterface.TAG_WHITE_BALANCE, i != 1 ? i != 2 ? null : String.valueOf(1) : String.valueOf(0));
        }
    }
    ...
    static {
        ExifTag[] exifTagArr = {new ExifTag(ExifInterface.TAG_IMAGE_WIDTH, 256, 3, 4), new ExifTag(ExifInterface.TAG_IMAGE_LENGTH, 257, 3, 4), new ExifTag(ExifInterface.TAG_MAKE, C90509a.C90511b.CTRL_INDEX, 2), new ExifTag(ExifInterface.TAG_MODEL, 272, 2), new ExifTag(ExifInterface.TAG_ORIENTATION, 274, 3), new ExifTag(ExifInterface.TAG_X_RESOLUTION, 282, 5), new ExifTag(ExifInterface.TAG_Y_RESOLUTION, C82872p6.CTRL_INDEX, 5), new ExifTag(ExifInterface.TAG_RESOLUTION_UNIT, 296, 3), new ExifTag(ExifInterface.TAG_SOFTWARE, ITPEventID.RICH_MEDIA_SYNCHRONIZER_DESELECT_DONE, 2), new ExifTag(ExifInterface.TAG_DATETIME, ITPEventID.RICH_MEDIA_SYNCHRONIZER_RESET, 2), new ExifTag(ExifInterface.TAG_Y_CB_CR_POSITIONING, 531, 3), new ExifTag(TAG_SUB_IFD_POINTER, 330, 4), new ExifTag(TAG_EXIF_IFD_POINTER, 34665, 4), new ExifTag(TAG_GPS_INFO_IFD_POINTER, 34853, 4)};
    ...
    public ExifData(ByteOrder byteOrder, List<Map<String, ExifAttribute>> list) {
        C20434g.m22021e(list.size() == EXIF_TAGS.length, "Malformed attributes list. Number of IFDs mismatch.");
        this.mByteOrder = byteOrder;
            ...
            if (str.equals(ExifInterface.TAG_GPS_TIMESTAMP)) {
                ...
                if (i == 5 || i == 10) {
                    ...
                    if (longRationalArr == null || longRationalArr.length != 3) {
                        Logger.m15477w(TAG, "Invalid GPS Timestamp array. array=" + Arrays.toString(longRationalArr));
                        return null;
                    }
                ...
                Logger.m15477w(TAG, "GPS Timestamp format is not rational. format=" + exifAttribute.format);
                return null;
            }
            try {
    ...
    public Map<String, ExifAttribute> getAttributes(int i) {
        ...
        C20434g.m22019c(i, 0, length, "Invalid IFD index: " + i + ". Index should be between [0, EXIF_TAGS.length] ");
