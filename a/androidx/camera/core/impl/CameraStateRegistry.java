...
public final class CameraStateRegistry {
    ...
    public static class CameraRegistration {
        ...
        public void notifyListener() {
            try {
                ...
                executor.execute(new CameraStateRegistry$CameraRegistration$$a(onOpenAvailableListener));
            } catch (RejectedExecutionException e) {
                Logger.m15474e(CameraStateRegistry.TAG, "Unable to notify camera.", e);
            }
        }
    ...
    private void recalculateAvailableCameras() {
        ...
        if (Logger.isDebugEnabled(TAG)) {
            ...
            Logger.m15471d(TAG, this.mDebugString.toString());
        }
    ...
    private CameraInternal.State updateAndVerifyState(Camera camera, CameraInternal.State state) {
        ...
        C20434g.m22020d(cameraRegistration, "Cannot update state of camera which has not yet been registered. Register with CameraStateRegistry.registerCamera()");
        CameraInternal.State state2 = cameraRegistration.setState(state);
        CameraInternal.State state3 = CameraInternal.State.OPENING;
        if (state == state3) {
            C20434g.m22021e(isOpen(state) || state2 == state3, "Cannot mark camera as opening until camera was successful at calling CameraStateRegistry.tryOpenCamera()");
        }
        if (state2 != state) {
            recalculateAvailableCameras();
        }
    ...
    public void registerCamera(Camera camera, Executor executor, OnOpenAvailableListener onOpenAvailableListener) {
        synchronized (this.mLock) {
            ...
            C20434g.m22021e(z, "Camera is already registered: " + camera);
    ...
    public boolean tryOpenCamera(androidx.camera.core.Camera r10) {
        /*
            ...
            monitor-enter(r0)
            java.util.Map<androidx.camera.core.Camera, androidx.camera.core.impl.CameraStateRegistry$CameraRegistration> r1 = r9.mCameraStates     // Catch:{ all -> 0x0099 }
            java.lang.Object r1 = r1.get(r10)     // Catch:{ all -> 0x0099 }
            androidx.camera.core.impl.CameraStateRegistry$CameraRegistration r1 = (androidx.camera.core.impl.CameraStateRegistry.CameraRegistration) r1     // Catch:{ all -> 0x0099 }
            java.lang.String r2 = "Camera must first be registered with registerCamera()"
            p329d3.C20434g.m22020d(r1, r2)     // Catch:{ all -> 0x0099 }
            java.lang.String r2 = "CameraStateRegistry"
            boolean r2 = androidx.camera.core.Logger.isDebugEnabled(r2)     // Catch:{ all -> 0x0099 }
            r3 = 1
            r4 = 0
            if (r2 == 0) goto L_0x0050
            java.lang.StringBuilder r2 = r9.mDebugString     // Catch:{ all -> 0x0099 }
            r2.setLength(r4)     // Catch:{ all -> 0x0099 }
            java.lang.StringBuilder r2 = r9.mDebugString     // Catch:{ all -> 0x0099 }
            java.util.Locale r5 = java.util.Locale.US     // Catch:{ all -> 0x0099 }
            java.lang.String r6 = "tryOpenCamera(%s) [Available Cameras: %d, Already Open: %b (Previous state: %s)]"
            r7 = 4
            java.lang.Object[] r7 = new java.lang.Object[r7]     // Catch:{ all -> 0x0099 }
            r7[r4] = r10     // Catch:{ all -> 0x0099 }
            int r10 = r9.mAvailableCameras     // Catch:{ all -> 0x0099 }
            java.lang.Integer r10 = java.lang.Integer.valueOf(r10)     // Catch:{ all -> 0x0099 }
            r7[r3] = r10     // Catch:{ all -> 0x0099 }
            r10 = 2
            androidx.camera.core.impl.CameraInternal$State r8 = r1.getState()     // Catch:{ all -> 0x0099 }
            boolean r8 = isOpen(r8)     // Catch:{ all -> 0x0099 }
            java.lang.Boolean r8 = java.lang.Boolean.valueOf(r8)     // Catch:{ all -> 0x0099 }
            r7[r10] = r8     // Catch:{ all -> 0x0099 }
            r10 = 3
            androidx.camera.core.impl.CameraInternal$State r8 = r1.getState()     // Catch:{ all -> 0x0099 }
            r7[r10] = r8     // Catch:{ all -> 0x0099 }
            java.lang.String r10 = java.lang.String.format(r5, r6, r7)     // Catch:{ all -> 0x0099 }
            r2.append(r10)     // Catch:{ all -> 0x0099 }
        L_0x0050:
            int r10 = r9.mAvailableCameras     // Catch:{ all -> 0x0099 }
            if (r10 > 0) goto L_0x0061
            androidx.camera.core.impl.CameraInternal$State r10 = r1.getState()     // Catch:{ all -> 0x0099 }
            boolean r10 = isOpen(r10)     // Catch:{ all -> 0x0099 }
        ...
        L_0x005f:
            ...
            goto L_0x0067
        L_0x0061:
            androidx.camera.core.impl.CameraInternal$State r10 = androidx.camera.core.impl.CameraInternal.State.OPENING     // Catch:{ all -> 0x0099 }
            r1.setState(r10)     // Catch:{ all -> 0x0099 }
            r10 = 1
        L_0x0067:
            java.lang.String r1 = "CameraStateRegistry"
            boolean r1 = androidx.camera.core.Logger.isDebugEnabled(r1)     // Catch:{ all -> 0x0099 }
            if (r1 == 0) goto L_0x0092
            java.lang.StringBuilder r1 = r9.mDebugString     // Catch:{ all -> 0x0099 }
            java.util.Locale r2 = java.util.Locale.US     // Catch:{ all -> 0x0099 }
            java.lang.String r5 = " --> %s"
            java.lang.Object[] r3 = new java.lang.Object[r3]     // Catch:{ all -> 0x0099 }
        ...
        L_0x007e:
            r3[r4] = r6     // Catch:{ all -> 0x0099 }
            java.lang.String r2 = java.lang.String.format(r2, r5, r3)     // Catch:{ all -> 0x0099 }
            r1.append(r2)     // Catch:{ all -> 0x0099 }
            java.lang.String r1 = "CameraStateRegistry"
            java.lang.StringBuilder r2 = r9.mDebugString     // Catch:{ all -> 0x0099 }
            java.lang.String r2 = r2.toString()     // Catch:{ all -> 0x0099 }
            androidx.camera.core.Logger.m15471d(r1, r2)     // Catch:{ all -> 0x0099 }
        L_0x0092:
            if (r10 == 0) goto L_0x0097
            r9.recalculateAvailableCameras()     // Catch:{ all -> 0x0099 }
        L_0x0097:
