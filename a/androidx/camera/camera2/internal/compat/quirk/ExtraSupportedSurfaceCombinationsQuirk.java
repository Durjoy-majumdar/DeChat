...
public class ExtraSupportedSurfaceCombinationsQuirk implements Quirk {
    ...
    public List<SurfaceCombination> getExtraSupportedSurfaceCombinations(String str, int i) {
        return isSamsungS7() ? getSamsungS7ExtraCombinations(str) : supportExtraFullConfigurationsSamsungDevice() ? getLimitedDeviceExtraSupportedFullConfigurations(i) : Collections.emptyList();
    }
}
