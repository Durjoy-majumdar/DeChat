...
/* renamed from: h73.e */
public class C108153e implements l0$$e {

    /* renamed from: d */
    public final /* synthetic */ l0$$e f323875d;

    /* renamed from: e */
    public final /* synthetic */ GestureGuardLogicUI f323876e;

    public C108153e(GestureGuardLogicUI gestureGuardLogicUI, l0$$e l0__e) {
        this.f323876e = gestureGuardLogicUI;
        this.f323875d = l0__e;
    }

    /* renamed from: a */
    public int mo1488a(int i, int i2, String str, C47350c cVar, C117747y yVar) {
        Log.m105924i("MicroMsg.GestureGuardLogicUI", String.format("Scene doModify, errType:%d, errCode:%d, errMsg:%s", new Object[]{Integer.valueOf(i), Integer.valueOf(i2), str}));
        GestureGuardLogicUI gestureGuardLogicUI = this.f323876e;
        ...
        if (i == 0 && i2 == 0) {
            ...
            GestureGuardLogicUI.m143838H7(this.f323876e);
            GestureGuardLogicUI gestureGuardLogicUI2 = this.f323876e;
